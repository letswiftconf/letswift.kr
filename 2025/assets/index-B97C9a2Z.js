...
TRANSP:OPAQUE
END:VEVENT
END:VCALENDAR`},s=(o,a)=>{const l=new Blob([o],{type:"text/calendar;charset=utf-8"}),c=document.createElement("a");c.href=window.URL.createObjectURL(l),c.download=a,document.body.appendChild(c),c.click(),document.body.removeChild(c),window.URL.revokeObjectURL(c.href)};return(o,a)=>(le(),ue("div",uA,[N("div",fA,[Ie(Zs,{title:"행사장"})]),N("div",dA,[N("div",hA,[e.value===2?(le(),ue("div",pA,a[0]||(a[0]=[N("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3163.2102424479963!2d127.06830008511824!3d37.55011015299899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca4daa73c863f%3A0xd6bd626e0463b230!2z7IS47KKF64yA7ZWZ6rWQIOq0keqwnO2GoOq0gA!5e0!3m2!1sko!2skr!4v1728434846925!5m2!1sko!2skr",width:"1280",height:"720",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade",class:"hidden md:block h-[720px]"},null,-1),N("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3163.2102424479963!2d127.06830008511824!3d37.55011015299899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca4daa73c863f%3A0xd6bd626e0463b230!2z7IS47KKF64yA7ZWZ6rWQIOq0keqwnO2GoOq0gA!5e0!3m2!1sko!2skr!4v1728434846925!5m2!1sko!2skr",width:"720",height:"480",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade",class:"block md:hidden h-[480px]"},null,-1)]))):Je("",!0)])]),N("div",{class:"flex justify-center"},[N("div",{class:"w-full px-8 xl:px-0 max-w-[1280px] space-y-16"},[a[1]||(a[1]=Is('<div class="flex-col md:flex md:flex-row md:justify-between px-4 space-y-4"><div class="flex flex-col space-y-2 text-white font-bold text-justify"><div class="text-zinc-300 text-xl">세종대학교 컨벤션홀</div><div class="text-zinc-400 text-base font-bold">서울 광진구 능동로 209</div></div><div class="text-xl text-zinc-300 font-bold flex md:block"><span class="text-zinc-200">2025년 </span><span>11월 24일</span><span class="text-zinc-200"> 월요일</span></div></div>',1)),N("button",{onClick:i,class:"px-6 py-3 rounded-full cursor-pointer bg-red-500/40 border border-red-400/60 text-white text-lg font-bold hover:bg-red-500/50 hover:border-red-400/80 transition-all duration-200 active:bg-red-500/60 select-none","aria-label":"Let'Swift 2025 행사를 캘린더에 추가"}," 캘린더에 추가 ")])])]))}},gA={class:"flex flex-col text-base h-full justify-center overflow-hidden text-left text-ellipsis"},_A={key:0,class:"flex flex-col space-y-0 items-baseline px-2 sm:px-4 py-1 md:py-2"},vA={class:"font-bold text-sm text-zinc-300"},xA={key:0},SA={key:1,class:"flex gap-x-4 text-justify px-2 sm:px-4 py-2 md:py-1 drop-shadow-[0_23px_23px_rgba(0,0,0,0.75)] h-full"},yA={class:"flex flex-col items-baseline text-justify py-1 gap-y-0.5"},EA={class:"font-black text-xs sm:text-lg md:text-lg text-zinc-300 line-clamp-3 break-normal w-full text-left"},MA={class:"flex gap-x-2 items-baseline"},bA={class:"font-bold font-mono text-xs sm:text-sm md:text-sm text-zinc-200/80 text-left"},TA={class:"font-bold font-mono text-xs sm:text-xs text-zinc-300/60 text-left"},wA={key:0,class:"flex space-x-2"},AA={class:"font-black text-sm sm:text-sm md:text-base text-zinc-300/70"},RA={key:0,class:"font-semibold mr-2"},CA={key:1},PA={class:"text-xs sm:text-xs opacity-60"},DA={key:2},LA={key:0},IA={key:1},Dd={__name:"TimelineItem",props:["session"],setup(t){const e=t,n=ct(()=>{const s=e.session;return s.type==="recess"||s.type==="lunch"}),i=s=>`${Math.floor(s/60)}분`,r=s=>{const o=new Date(s),a=o.getHours(),l=o.getMinutes(),c=a.toString().padStart(2,"0"),u=l.toString().padStart(2,"0");return`${c}:${u}`};return(s,o)=>(le(),ue("div",gA,[n.value===!0?(le(),ue("div",_A,[N("div",vA,rt(t.session.name),1),t.session.type==="lunch"?(le(),ue("div",xA,o[0]||(o[0]=[N("div",{class:"flex flex-col text-xs text-zinc-500 py-4"},[N("div",null,"식사시 주의 사항"),N("div",null,"내부 음식물 섭취 안내: 컨퍼런스 내부에서 물 이외의 음식은 취식 불가입니다.")],-1)]))):Je("",!0)])):(le(),ue("div",SA,[o[1]||(o[1]=N("div",{class:"bg-themeMain h-full w-1 rounded-full"},null,-1)),N("div",yA,[N("div",EA,rt(t.session.name),1),N("div",MA,[N("div",bA,rt(r(t.session.start_time))+" ~ "+rt(r(t.session.end_time)),1),N("div",TA,rt(i(t.session.duration)),1)]),t.session.speakers?(le(),ue("div",wA,[(le(!0),ue(ht,null,Ft(t.session.speakers,(a,l)=>(le(),ue("div",AA,[l>0?(le(),ue("span",RA,"&")):Je("",!0),a.nickname!==""&&a.name!==""?(le(),ue("span",CA,[gn(rt(a.nickname)+" ",1),N("span",PA,rt(a.name),1)])):(le(),ue("span",DA,[a.nickname!==""?(le(),ue("span",LA,rt(a.nickname),1)):(le(),ue("span",IA,rt(a.name),1))]))]))),256))])):Je("",!0)])]))]))}},UA={class:"flex flex-col gap-y-8 md:scroll-mt-28"},NA={class:"space-y-12"},OA={class:"flex justify-center"},FA={class:"w-full px-2 sm:px-8 py-2 xl:px-0 max-w-[1280px] space-y-12 xl:rounded-3xl"},BA={class:"text-white"},kA={class:"min-h-[250vh] sm:min-h-[300vh] md:min-h-[200vh] grid grid-rows-[repeat(56,1fr)] grid-cols-13 gap-1"},zA={class:"md:hidden"},HA={class:"hidden md:inline"},VA={__name:"Schedule",setup(t){const e=["09:00","10:00","11:00","12:00","13:00","14:00","15:00","16:00","17:00"],n=It([]),i=ct(()=>n.value.filter(c=>c.track_en==="")),r=ct(()=>n.value.filter(c=>c.track_en==="Track A").concat(i.value)),s=ct(()=>n.value.filter(c=>c.track_en==="Track B").concat(i.value));kn(()=>{o()});const o=async()=>{try{const u=await Mt.get("/2025/assets/json/schedule.json");n.value=u.data}catch(c){console.error(c)}},a=(c,u)=>{let f=" ";return u===0?f+=" col-start-2 col-span-6":f+=" col-start-8 col-span-6",c.type==="entry"?f+=" bg-white/5 rounded-md":c.type==="recess"||c.type==="lunch"?f+=" ":(c.type==="opening"||c.type==="closing"||c.type==="networking"||c.track_en==="Track A"||c.track_en==="Track B")&&(f+=" bg-white/10 rounded-md"),f},l=c=>{let u="";const f=new Date(c.start_time),d=f.getHours(),p=f.getMinutes(),g=(d-9)*6+Math.ceil(p/10)+1+1,_=Math.ceil(c.duration/600),m=g+_;return u+=` grid-row-start: ${g}; grid-row-end: ${m};`,u};return(c,u)=>(le(),ue("div",UA,[N("div",NA,[Ie(Zs,{title:"시간표"})]),u[1]||(u[1]=N("div",{class:"text-zinc-500 text-xs"},"상황에 따라 일정 및 세션 내용은 변경될 수 있습니다.",-1)),N("div",OA,[N("div",FA,[N("div",BA,[N("div",kA,[u[0]||(u[0]=Is('<div class="contents text-center font-bold text-lg md:text-xl"><div class="relative flex flex-col space-y-0 items-center justify-center col-start-2 col-span-6 row-start-0 row-span-1 bg-zinc-700/50 rounded-2xl"><div class="flex flex-col md:flex-row place-items-center md:place-items-baseline gap-x-2"><div class="text-sm md:text-xl">Track A</div><div class="text-xl md:text-3xl text-rainbow">EMBER</div></div><div class="text-xs text-zinc-500">홀 B</div></div><div class="flex flex-col space-y-0 items-center justify-center col-start-8 col-span-6 row-start-0 row-span-1 bg-zinc-700/50 rounded-2xl"><div class="flex flex-col md:flex-row place-items-center md:place-items-baseline gap-x-2"><div class="text-sm md:text-xl">Track B</div><div class="text-xl md:text-3xl text-rainbow">STAR</div></div><div class="text-xs text-zinc-500">홀 C</div></div></div>',1)),(le(),ue(ht,null,Ft(e,(f,d)=>N("div",{class:"px-1 flex items-center justify-center bg-zinc-700/50 rounded-2xl col-start-1 col-span-1 row-span-6 font-mono font-semibold text-xs sm:text-sm md:text-lg",style:Fi(`grid-row-start: ${d*0}`)},[N("span",zA,rt(f.split(":")[0].replace(/^0/,"")),1),N("span",HA,rt(f),1)],4)),64)),(le(!0),ue(ht,null,Ft(r.value,f=>(le(),ue("div",{key:f.id,class:On(a(f,0)),style:Fi(l(f))},[Ie(Dd,{session:f},null,8,["session"])],6))),128)),(le(!0),ue(ht,null,Ft(s.value,f=>(le(),ue("div",{key:f.id,class:On(a(f,1)),style:Fi(l(f))},[Ie(Dd,{session:f},null,8,["session"])],6))),128))])])])])]))}},GA={class:"flex flex-col gap-y-8 items-end text-white"},WA={class:"flex flex-col gap-y-8 items-end"},XA=["src"],$A={class:"flex flex-col gap-y-4 items-end text-end"},qA={key:0},jA={class:"font-bold text-lg md:text-xl"},YA={class:"font-bold text-sm md:text-base opacity-60"},KA={key:1},ZA={key:0,class:"font-bold text-lg md:text-xl"},JA={key:1,class:"font-bold text-lg md:text-xl"},QA={class:"font-bold text-xs md:text-sm"},e2={class:"korean-text text-xs md:text-sm text-right text-pretty font-semibold text-zinc-300 opacity-90 max-w-80"},t2={class:"flex pt-2 gap-x-4 gap-y-4 justify-end pointer-cursor"},n2=["href"],i2=["href"],r2=["href"],s2=["href"],o2=["href"],a2=["href"],l2=["href"],c2=["href"],u2=["href"],f2=["href"],d2=["href"],h2={__name:"Speaker",props:["person"],setup(t){const e=n=>`/2025/assets/speakers/${n}`;return(n,i)=>(le(),ue("div",GA,[N("div",WA,[N("img",{src:e(t.person.image_name),loading:"lazy",class:"w-36 md:w-44 h-36 md:h-44 bg-white rounded-tl-full object-cover z-10"},null,8,XA),N("div",$A,[t.person.nickname!==""&&t.person.name!==""?(le(),ue("div",qA,[N("div",jA,rt(t.person.nickname),1),N("div",YA,rt(t.person.name),1)])):(le(),ue("div",KA,[t.person.nickname!==""?(le(),ue("div",ZA,rt(t.person.nickname),1)):(le(),ue("div",JA,rt(t.person.name),1))])),N("div",QA,rt(t.person.affiliation),1),N("div",e2,rt(t.person.description),1),N("div",t2,[t.person.social.email?(le(),ue("a",{key:0,href:`mailto:${t.person.social.email}`,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,n2)):Je("",!0),t.person.social.web?(le(),ue("a",{key:1,href:t.person.social.web,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,i2)):Je("",!0),t.person.social.linkedin?(le(),ue("a",{key:2,href:t.person.social.linkedin,target:"_blank"},[Ie($e(Ea),{fill:"gray",width:"16",height:"16"})],8,r2)):Je("",!0),t.person.social.instagram?(le(),ue("a",{key:3,href:t.person.social.instagram,target:"_blank"},[Ie($e(ya),{fill:"gray",width:"16",height:"16"})],8,s2)):Je("",!0),t.person.social.facebook?(le(),ue("a",{key:4,href:t.person.social.facebook,target:"_blank"},[Ie($e(ou),{fill:"gray",width:"16",height:"16"})],8,o2)):Je("",!0),t.person.social.github?(le(),ue("a",{key:5,href:t.person.social.github,target:"_blank"},[Ie($e(Sa),{fill:"gray",width:"16",height:"16"})],8,a2)):Je("",!0),t.person.social.youtube?(le(),ue("a",{key:6,href:t.person.social.youtube,target:"_blank"},[Ie($e(ba),{fill:"gray",width:"16",height:"16"})],8,l2)):Je("",!0),t.person.social.x?(le(),ue("a",{key:7,href:t.person.social.x,target:"_blank"},[Ie($e(Ma),{fill:"gray",width:"16",height:"16"})],8,c2)):Je("",!0),t.person.social.mastodon?(le(),ue("a",{key:8,href:t.person.social.mastodon,target:"_blank"},[Ie($e(au),{fill:"gray",width:"16",height:"16"})],8,u2)):Je("",!0),t.person.social.medium?(le(),ue("a",{key:9,href:t.person.social.medium,target:"_blank"},[Ie($e(lu),{fill:"gray",width:"16",height:"16"})],8,f2)):Je("",!0),t.person.social.thread?(le(),ue("a",{key:10,href:t.person.social.thread,target:"_blank"},[Ie($e(cu),{fill:"gray",width:"16",height:"16"})],8,d2)):Je("",!0)])])])]))}},p2=Wi(h2,[["__scopeId","data-v-875a9e5f"]]),m2={class:"flex flex-col space-y-12 md:space-y-36 md:scroll-mt-28"},g2={class:"flex justify-center"},_2={class:"px-8 xl:px-0 max-w-[1280px]"},v2={class:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-x-12 md:gap-x-24 gap-y-28"},x2={__name:"Speakers",setup(t){const e=It([]);kn(()=>{n()});const n=async()=>{try{const r=await Mt.get("/2025/assets/json/speakers.json");e.value=r.data}catch(i){console.error(i)}};return(i,r)=>(le(),ue("div",m2,[Ie(Zs,{title:"연사 소개"}),N("div",g2,[N("div",_2,[N("div",v2,[(le(!0),ue(ht,null,Ft(e.value,s=>(le(),ue("div",{key:s.id},[Ie(p2,{person:s},null,8,["person"])]))),128))])])])]))}},S2={class:"flex flex-col gap-y-8 items-center"},y2={class:"relative w-36 md:w-44 h-36 md:h-44"},E2=["src"],M2={key:1,class:"absolute top-0 left-0 w-36 md:w-44 h-36 md:h-44 bg-zinc-200/50 rounded-full object-cover z-10"},b2={class:"flex flex-col gap-y-4 items-center text-center"},T2={key:0},w2={class:"font-bold text-lg md:text-xl"},A2={class:"font-bold text-sm md:text-base opacity-60"},R2={key:1},C2={key:0,class:"font-bold text-lg md:text-xl"},P2={key:1,class:"font-bold text-lg md:text-xl"},D2={key:2,class:"font-bold text-xs md:text-sm"},L2={class:"korean-text text-xs md:text-sm text-right text-pretty font-semibold text-zinc-300 opacity-90 max-w-80"},I2={class:"flex pt-2 gap-x-4 gap-y-4 justify-center pointer-cursor"},U2=["href"],N2=["href"],O2=["href"],F2=["href"],B2=["href"],k2=["href"],z2=["href"],H2=["href"],V2=["href"],G2=["href"],W2=["href"],X2={__name:"Organizer",props:["person"],setup(t){const e=t,n=It(!1),i=o=>`/2025/assets/organizers/${o}`,r="/2025/assets/organizers/muyaho.jpg",s=()=>{(e.person.nickname==="윌"||e.person.name==="윌")&&(console.log("그만큼 신나시는 거지~"),n.value=!0,setTimeout(()=>{n.value=!1},3e3))};return(o,a)=>(le(),ue("div",{class:"flex flex-col gap-y-8 items-center text-white",onClick:s},[N("div",S2,[N("div",y2,[t.person.image_name?(le(),ue("img",{key:0,src:i(t.person.image_name),loading:"lazy",class:"absolute top-0 left-0 w-36 md:w-44 h-36 md:h-44 bg-gradient-to-b from-zinc-300/10 to-zinc-300/20 rounded-full object-cover z-10"},null,8,E2)):(le(),ue("img",M2)),n.value?(le(),ue("img",{key:2,src:r,class:"absolute top-0 left-0 w-36 md:w-44 h-36 md:h-44 rounded-full object-cover z-20 overlay-animation"})):Je("",!0)]),N("div",b2,[t.person.nickname!==""&&t.person.name!==""?(le(),ue("div",T2,[N("div",w2,rt(t.person.nickname),1),N("div",A2,rt(t.person.name),1)])):(le(),ue("div",R2,[t.person.nickname!==""?(le(),ue("div",C2,rt(t.person.nickname),1)):(le(),ue("div",P2,rt(t.person.name),1))])),t.person.affiliation?(le(),ue("div",D2,rt(t.person.affiliation),1)):Je("",!0),N("div",L2,rt(t.person.description),1),N("div",I2,[t.person.social.email?(le(),ue("a",{key:0,href:`mailto:${t.person.social.email}`,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,U2)):Je("",!0),t.person.social.web?(le(),ue("a",{key:1,href:t.person.social.web,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,N2)):Je("",!0),t.person.social.linkedin?(le(),ue("a",{key:2,href:t.person.social.linkedin,target:"_blank"},[Ie($e(Ea),{fill:"gray",width:"16",height:"16"})],8,O2)):Je("",!0),t.person.social.instagram?(le(),ue("a",{key:3,href:t.person.social.instagram,target:"_blank"},[Ie($e(ya),{fill:"gray",width:"16",height:"16"})],8,F2)):Je("",!0),t.person.social.facebook?(le(),ue("a",{key:4,href:t.person.social.facebook,target:"_blank"},[Ie($e(ou),{fill:"gray",width:"16",height:"16"})],8,B2)):Je("",!0),t.person.social.github?(le(),ue("a",{key:5,href:t.person.social.github,target:"_blank"},[Ie($e(Sa),{fill:"gray",width:"16",height:"16"})],8,k2)):Je("",!0),t.person.social.youtube?(le(),ue("a",{key:6,href:t.person.social.youtube,target:"_blank"},[Ie($e(ba),{fill:"gray",width:"16",height:"16"})],8,z2)):Je("",!0),t.person.social.x?(le(),ue("a",{key:7,href:t.person.social.x,target:"_blank"},[Ie($e(Ma),{fill:"gray",width:"16",height:"16"})],8,H2)):Je("",!0),t.person.social.mastodon?(le(),ue("a",{key:8,href:t.person.social.mastodon,target:"_blank"},[Ie($e(au),{fill:"gray",width:"16",height:"16"})],8,V2)):Je("",!0),t.person.social.medium?(le(),ue("a",{key:9,href:t.person.social.medium,target:"_blank"},[Ie($e(lu),{fill:"gray",width:"16",height:"16"})],8,G2)):Je("",!0),t.person.social.thread?(le(),ue("a",{key:10,href:t.person.social.thread,target:"_blank"},[Ie($e(cu),{fill:"gray",width:"16",height:"16"})],8,W2)):Je("",!0)])])])]))}},$2=Wi(X2,[["__scopeId","data-v-2e060d96"]]),q2={class:"flex flex-col space-y-12 md:space-y-36 md:scroll-mt-28"},j2={class:"flex justify-center"},Y2={class:"px-8 xl:px-0 max-w-[1280px]"},K2={class:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-x-12 md:gap-x-24 gap-y-28"},Z2={__name:"Organizers",setup(t){const e=It([]);kn(()=>{i()});const n=r=>{const s=[...r];for(let o=s.length-1;o>0;o--){const a=Math.floor(Math.random()*(o+1));[s[o],s[a]]=[s[a],s[o]]}return s},i=async()=>{try{const s=await Mt.get("/2025/assets/json/organizers.json");e.value=n(s.data)}catch(r){console.error(r)}};return(r,s)=>(le(),ue("div",q2,[Ie(Zs,{title:"준비위원회"}),N("div",j2,[N("div",Y2,[N("div",K2,[(le(!0),ue(ht,null,Ft(e.value,o=>(le(),ue("div",{key:o.id},[Ie($2,{person:o},null,8,["person"])]))),128))])])])]))}},J2={__name:"Home",setup(t){return(e,n)=>(le(),ue(ht,null,[Ie(I1,{id:"hero"}),Ie(H1,{id:"intro"}),Ie(tA,{id:"sponsors"}),Ie(VA,{id:"schedule"}),Ie(x2,{id:"speakers"}),Ie(Z2,{id:"organizers"}),Ie(mA,{id:"venue"}),Ie(cA,{id:"sponsorsMini"})],64))}},Q2=[{path:"/",component:J2},{path:"/CodeOfConduct",component:()=>b1(()=>import("./CodeOfConduct-C6GclEim.js"),[])}],eR=H0({history:m0("/2025/"),routes:Q2}),om=O_(y1);om.use(eR);om.mount("#app");export{ht as F,Zs as _,Ie as a,N as b,ue as c,le as o,Ft as r,rt as t};
