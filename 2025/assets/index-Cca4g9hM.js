...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function zu(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lc(),fragmentShader:`
		...
		`,blending:mi,depthTest:!1,depthWrite:!1})}function Hu(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lc(),fragmentShader:`
...
`].filter(Yr).join(`
`)),o=wl(o),o=Ju(o,t),o=Qu(o,t),a=wl(a),a=Ju(a,t),a=Qu(a,t),o=ef(o),a=ef(a),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
TRANSP:OPAQUE
END:VEVENT
END:VCALENDAR`},s=(c,u)=>{const f=new Blob([c],{type:"text/calendar;charset=utf-8"}),h=document.createElement("a");h.href=window.URL.createObjectURL(f),h.download=u,document.body.appendChild(h),h.click(),document.body.removeChild(h),window.URL.revokeObjectURL(h.href)},o=()=>{window.open("https://www.ticketa.co/events/35","_blank")},a=()=>{try{const c=r();s(c,"letswift-2025.ics")}catch(c){console.error("Failed to generate calendar file:",c),window.open("https://calendar.google.com/calendar/render?action=TEMPLATE&text=Let%27Swift%202025&dates=20251124T010000Z/20251124T090000Z&details=Let%27Swift%202025%20Conference&location=%EC%84%B8%EC%A2%85%EB%8C%80%ED%95%99%EA%B5%90%20%EA%B4%91%EA%B0%9C%ED%86%A0%EA%B4%80","_blank")}},l=()=>{window.location.href="mailto:letswift.official@gmail.com?subject=Let%27Swift%202025%20%ED%9B%84%EC%9B%90%20%EB%AC%B8%EC%9D%98%20%2F%20Sponsorship%20Inquiry"};return(c,u)=>(_t(),Ut("div",gT,[Ve("div",_T,[Rt(mT,{width:t.value,height:t.value,"container-classes":"rounded-lg select-none touch-manipulation"},null,8,["width","height"]),Ve("div",{class:"text-center px-4"},[u[0]||(u[0]=Ve("h1",{class:"text-[5vw] leading-none font-black tracking-normal"}," Let'Swift 2025 ",-1)),u[1]||(u[1]=Ve("div",{class:"mt-8 text-4xl font-medium space-y-4"},[Ve("p",{class:"text-4xl font-bold text-zinc-200"},"2025.11.24 월요일"),Ve("p",{class:"text-2xl font-semibold text-zinc-300"},"세종대학교 광개토관")],-1)),Ve("div",{class:"mt-8 flex flex-col sm:flex-row gap-4 sm:gap-8 justify-center items-center"},[Ve("button",{onClick:o,class:"text-yellow-400 text-lg font-bold hover:text-yellow-300 transition-colors duration-200 active:text-yellow-500","aria-label":"Let'Swift 2025 티켓 구매하기"}," 티켓 구매 "),Ve("button",{onClick:a,class:"text-red-400 text-lg font-bold hover:text-pink-400 transition-colors duration-200 active:text-pink-500","aria-label":"Let'Swift 2025 행사를 캘린더에 추가"}," 캘린더에 추가 "),Ve("button",{onClick:l,class:"text-themeMain text-lg font-bold hover:text-themeMain/70 transition-colors duration-200 active:text-themeMain/50","aria-label":"Let'Swift 2025 후원 문의하기"}," 후원 문의 ")])])])]))}},xT=Eh(vT,[["__scopeId","data-v-85877474"]]),ET={__name:"Home",setup(n){return(e,t)=>(_t(),yr(xT))}},ST=[{path:"/",component:ET},{path:"/CodeOfConduct",component:()=>Sh(()=>import("./CodeOfConduct-BZDs8VTL.js"),[])}],MT=b_({history:e_("/2025/"),routes:ST}),ud=Im(Sg);ud.use(MT);ud.mount("#app");export{Lt as F,Ve as a,Ut as c,_t as o,bs as r,cr as t};
