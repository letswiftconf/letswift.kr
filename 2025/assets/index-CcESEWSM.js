...
`].filter(Ts).join(`
`)),o=Wc(o),o=gd(o,n),o=_d(o,n),a=Wc(a),a=gd(a,n),a=_d(a,n),o=vd(o),a=vd(a),n.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+p);const x=T+m+o,y=T+p+a,L=hd(r,r.VERTEX_SHADER,x),C=hd(r,r.FRAGMENT_SHADER,y);r.attachShader(_,L),r.attachShader(_,C),n.index0AttributeName!==void 0?r.bindAttribLocation(_,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function P(D){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(_).trim(),H=r.getShaderInfoLog(L).trim(),q=r.getShaderInfoLog(C).trim();let de=!0,J=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(de=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,_,L,C);else{const fe=md(r,L,"vertex"),V=md(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
Program Info Log: `+k+`
`+fe+`
`+V)}else k!==""?console.warn("THREE.WebGLProgram: Program Info Log:",k):(H===""||q==="")&&(J=!1);J&&(D.diagnostics={runnable:de,programLog:k,vertexShader:{log:H,prefix:m},fragmentShader:{log:q,prefix:p}})}r.deleteShader(L),r.deleteShader(C),F=new Jo(r,_),w=Cb(r,_)}let F;this.getUniforms=function(){return F===void 0&&P(this),F};let w;this.getAttributes=function(){return w===void 0&&P(this),w};let E=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return E===!1&&(E=r.getProgramParameter(_,Sb)),E},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(_),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=yb++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=L,this.fragmentShader=C,this}let Hb=0;class Vb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new Gb(e),n.set(e,i)),i}}class Gb{constructor(e){this.id=Hb++,this.code=e,this.usedTimes=0}}function Wb(t,e,n,i,r,s,o){const a=new Tp,l=new Vb,c=new Set,u=[],f=r.logarithmicDepthBuffer,d=r.vertexTextures;let h=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(w){return c.add(w),w===0?"uv":`uv${w}`}function m(w,E,D,k,H){const q=k.fog,de=H.geometry,J=w.isMeshStandardMaterial?k.environment:null,fe=(w.isMeshStandardMaterial?n:e).get(w.envMap||J),V=fe&&fe.mapping===Na?fe.image.height:null,Te=g[w.type];w.precision!==null&&(h=r.getMaxPrecision(w.precision),h!==w.precision&&console.warn("THREE.WebGLProgram.getParameters:",w.precision,"not supported, using",h,"instead."));const De=de.morphAttributes.position||de.morphAttributes.normal||de.morphAttributes.color,Fe=De!==void 0?De.length:0;let We=0;de.morphAttributes.position!==void 0&&(We=1),de.morphAttributes.normal!==void 0&&(We=2),de.morphAttributes.color!==void 0&&(We=3);let Je,ce,Ee,Pe;if(Te){const nt=qn[Te];Je=nt.vertexShader,ce=nt.fragmentShader}else Je=w.vertexShader,ce=w.fragmentShader,l.update(w),Ee=l.getVertexShaderID(w),Pe=l.getFragmentShaderID(w);const O=t.getRenderTarget(),ee=t.state.buffers.depth.getReversed(),ge=H.isInstancedMesh===!0,me=H.isBatchedMesh===!0,Xe=!!w.map,A=!!w.matcap,R=!!fe,S=!!w.aoMap,ae=!!w.lightMap,Q=!!w.bumpMap,K=!!w.normalMap,se=!!w.displacementMap,pe=!!w.emissiveMap,re=!!w.metalnessMap,te=!!w.roughnessMap,Ie=w.anisotropy>0,b=w.clearcoat>0,v=w.dispersion>0,N=w.iridescence>0,W=w.sheen>0,oe=w.transmission>0,G=Ie&&!!w.anisotropyMap,ve=b&&!!w.clearcoatMap,ue=b&&!!w.clearcoatNormalMap,_e=b&&!!w.clearcoatRoughnessMap,ye=N&&!!w.iridescenceMap,le=N&&!!w.iridescenceThicknessMap,Re=W&&!!w.sheenColorMap,Ue=W&&!!w.sheenRoughnessMap,Ne=!!w.specularMap,we=!!w.specularColorMap,Ve=!!w.specularIntensityMap,I=oe&&!!w.transmissionMap,Ce=oe&&!!w.thicknessMap,xe=!!w.gradientMap,Se=!!w.alphaMap,he=w.alphaTest>0,Y=!!w.alphaHash,Me=!!w.extensions;let ke=Vi;w.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(ke=t.toneMapping);const rt={shaderID:Te,shaderType:w.type,shaderName:w.name,vertexShader:Je,fragmentShader:ce,defines:w.defines,customVertexShaderID:Ee,customFragmentShaderID:Pe,isRawShaderMaterial:w.isRawShaderMaterial===!0,glslVersion:w.glslVersion,precision:h,batching:me,batchingColor:me&&H._colorsTexture!==null,instancing:ge,instancingColor:ge&&H.instanceColor!==null,instancingMorph:ge&&H.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:O===null?t.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:ss,alphaToCoverage:!!w.alphaToCoverage,map:Xe,matcap:A,envMap:R,envMapMode:R&&fe.mapping,envMapCubeUVHeight:V,aoMap:S,lightMap:ae,bumpMap:Q,normalMap:K,displacementMap:d&&se,emissiveMap:pe,normalMapObjectSpace:K&&w.normalMapType===zx,normalMapTangentSpace:K&&w.normalMapType===kx,metalnessMap:re,roughnessMap:te,anisotropy:Ie,anisotropyMap:G,clearcoat:b,clearcoatMap:ve,clearcoatNormalMap:ue,clearcoatRoughnessMap:_e,dispersion:v,iridescence:N,iridescenceMap:ye,iridescenceThicknessMap:le,sheen:W,sheenColorMap:Re,sheenRoughnessMap:Ue,specularMap:Ne,specularColorMap:we,specularIntensityMap:Ve,transmission:oe,transmissionMap:I,thicknessMap:Ce,gradientMap:xe,opaque:w.transparent===!1&&w.blending===Zr&&w.alphaToCoverage===!1,alphaMap:Se,alphaTest:he,alphaHash:Y,combine:w.combine,mapUv:Xe&&_(w.map.channel),aoMapUv:S&&_(w.aoMap.channel),lightMapUv:ae&&_(w.lightMap.channel),bumpMapUv:Q&&_(w.bumpMap.channel),normalMapUv:K&&_(w.normalMap.channel),displacementMapUv:se&&_(w.displacementMap.channel),emissiveMapUv:pe&&_(w.emissiveMap.channel),metalnessMapUv:re&&_(w.metalnessMap.channel),roughnessMapUv:te&&_(w.roughnessMap.channel),anisotropyMapUv:G&&_(w.anisotropyMap.channel),clearcoatMapUv:ve&&_(w.clearcoatMap.channel),clearcoatNormalMapUv:ue&&_(w.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:_e&&_(w.clearcoatRoughnessMap.channel),iridescenceMapUv:ye&&_(w.iridescenceMap.channel),iridescenceThicknessMapUv:le&&_(w.iridescenceThicknessMap.channel),sheenColorMapUv:Re&&_(w.sheenColorMap.channel),sheenRoughnessMapUv:Ue&&_(w.sheenRoughnessMap.channel),specularMapUv:Ne&&_(w.specularMap.channel),specularColorMapUv:we&&_(w.specularColorMap.channel),specularIntensityMapUv:Ve&&_(w.specularIntensityMap.channel),transmissionMapUv:I&&_(w.transmissionMap.channel),thicknessMapUv:Ce&&_(w.thicknessMap.channel),alphaMapUv:Se&&_(w.alphaMap.channel),vertexTangents:!!de.attributes.tangent&&(K||Ie),vertexColors:w.vertexColors,vertexAlphas:w.vertexColors===!0&&!!de.attributes.color&&de.attributes.color.itemSize===4,pointsUvs:H.isPoints===!0&&!!de.attributes.uv&&(Xe||Se),fog:!!q,useFog:w.fog===!0,fogExp2:!!q&&q.isFogExp2,flatShading:w.flatShading===!0&&w.wireframe===!1,sizeAttenuation:w.sizeAttenuation===!0,logarithmicDepthBuffer:f,reverseDepthBuffer:ee,skinning:H.isSkinnedMesh===!0,morphTargets:de.morphAttributes.position!==void 0,morphNormals:de.morphAttributes.normal!==void 0,morphColors:de.morphAttributes.color!==void 0,morphTargetsCount:Fe,morphTextureStride:We,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:w.dithering,shadowMapEnabled:t.shadowMap.enabled&&D.length>0,shadowMapType:t.shadowMap.type,toneMapping:ke,decodeVideoTexture:Xe&&w.map.isVideoTexture===!0&&dt.getTransfer(w.map.colorSpace)===xt,decodeVideoTextureEmissive:pe&&w.emissiveMap.isVideoTexture===!0&&dt.getTransfer(w.emissiveMap.colorSpace)===xt,premultipliedAlpha:w.premultipliedAlpha,doubleSided:w.side===ci,flipSided:w.side===ln,useDepthPacking:w.depthPacking>=0,depthPacking:w.depthPacking||0,index0AttributeName:w.index0AttributeName,extensionClipCullDistance:Me&&w.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Me&&w.extensions.multiDraw===!0||me)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:w.customProgramCacheKey()};return rt.vertexUv1s=c.has(1),rt.vertexUv2s=c.has(2),rt.vertexUv3s=c.has(3),c.clear(),rt}function p(w){const E=[];if(w.shaderID?E.push(w.shaderID):(E.push(w.customVertexShaderID),E.push(w.customFragmentShaderID)),w.defines!==void 0)for(const D in w.defines)E.push(D),E.push(w.defines[D]);return w.isRawShaderMaterial===!1&&(T(E,w),x(E,w),E.push(t.outputColorSpace)),E.push(w.customProgramCacheKey),E.join()}function T(w,E){w.push(E.precision),w.push(E.outputColorSpace),w.push(E.envMapMode),w.push(E.envMapCubeUVHeight),w.push(E.mapUv),w.push(E.alphaMapUv),w.push(E.lightMapUv),w.push(E.aoMapUv),w.push(E.bumpMapUv),w.push(E.normalMapUv),w.push(E.displacementMapUv),w.push(E.emissiveMapUv),w.push(E.metalnessMapUv),w.push(E.roughnessMapUv),w.push(E.anisotropyMapUv),w.push(E.clearcoatMapUv),w.push(E.clearcoatNormalMapUv),w.push(E.clearcoatRoughnessMapUv),w.push(E.iridescenceMapUv),w.push(E.iridescenceThicknessMapUv),w.push(E.sheenColorMapUv),w.push(E.sheenRoughnessMapUv),w.push(E.specularMapUv),w.push(E.specularColorMapUv),w.push(E.specularIntensityMapUv),w.push(E.transmissionMapUv),w.push(E.thicknessMapUv),w.push(E.combine),w.push(E.fogExp2),w.push(E.sizeAttenuation),w.push(E.morphTargetsCount),w.push(E.morphAttributeCount),w.push(E.numDirLights),w.push(E.numPointLights),w.push(E.numSpotLights),w.push(E.numSpotLightMaps),w.push(E.numHemiLights),w.push(E.numRectAreaLights),w.push(E.numDirLightShadows),w.push(E.numPointLightShadows),w.push(E.numSpotLightShadows),w.push(E.numSpotLightShadowsWithMaps),w.push(E.numLightProbes),w.push(E.shadowMapType),w.push(E.toneMapping),w.push(E.numClippingPlanes),w.push(E.numClipIntersection),w.push(E.depthPacking)}function x(w,E){a.disableAll(),E.supportsVertexTextures&&a.enable(0),E.instancing&&a.enable(1),E.instancingColor&&a.enable(2),E.instancingMorph&&a.enable(3),E.matcap&&a.enable(4),E.envMap&&a.enable(5),E.normalMapObjectSpace&&a.enable(6),E.normalMapTangentSpace&&a.enable(7),E.clearcoat&&a.enable(8),E.iridescence&&a.enable(9),E.alphaTest&&a.enable(10),E.vertexColors&&a.enable(11),E.vertexAlphas&&a.enable(12),E.vertexUv1s&&a.enable(13),E.vertexUv2s&&a.enable(14),E.vertexUv3s&&a.enable(15),E.vertexTangents&&a.enable(16),E.anisotropy&&a.enable(17),E.alphaHash&&a.enable(18),E.batching&&a.enable(19),E.dispersion&&a.enable(20),E.batchingColor&&a.enable(21),E.gradientMap&&a.enable(22),w.push(a.mask),a.disableAll(),E.fog&&a.enable(0),E.useFog&&a.enable(1),E.flatShading&&a.enable(2),E.logarithmicDepthBuffer&&a.enable(3),E.reverseDepthBuffer&&a.enable(4),E.skinning&&a.enable(5),E.morphTargets&&a.enable(6),E.morphNormals&&a.enable(7),E.morphColors&&a.enable(8),E.premultipliedAlpha&&a.enable(9),E.shadowMapEnabled&&a.enable(10),E.doubleSided&&a.enable(11),E.flipSided&&a.enable(12),E.useDepthPacking&&a.enable(13),E.dithering&&a.enable(14),E.transmission&&a.enable(15),E.sheen&&a.enable(16),E.opaque&&a.enable(17),E.pointsUvs&&a.enable(18),E.decodeVideoTexture&&a.enable(19),E.decodeVideoTextureEmissive&&a.enable(20),E.alphaToCoverage&&a.enable(21),w.push(a.mask)}function y(w){const E=g[w.type];let D;if(E){const k=qn[E];D=_S.clone(k.uniforms)}else D=w.uniforms;return D}function L(w,E){let D;for(let k=0,H=u.length;k<H;k++){const q=u[k];if(q.cacheKey===E){D=q,++D.usedTimes;break}}return D===void 0&&(D=new zb(t,E,w,s),u.push(D)),D}function C(w){if(--w.usedTimes===0){const E=u.indexOf(w);u[E]=u[u.length-1],u.pop(),w.destroy()}}function P(w){l.remove(w)}function F(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:y,acquireProgram:L,releaseProgram:C,releaseShaderCache:P,programs:u,dispose:F}}function Xb(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function $b(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function Sd(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function yd(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(f,d,h,g,_,m){let p=t[e];return p===void 0?(p={id:f.id,object:f,geometry:d,material:h,groupOrder:g,renderOrder:f.renderOrder,z:_,group:m},t[e]=p):(p.id=f.id,p.object=f,p.geometry=d,p.material=h,p.groupOrder=g,p.renderOrder=f.renderOrder,p.z=_,p.group=m),e++,p}function a(f,d,h,g,_,m){const p=o(f,d,h,g,_,m);h.transmission>0?i.push(p):h.transparent===!0?r.push(p):n.push(p)}function l(f,d,h,g,_,m){const p=o(f,d,h,g,_,m);h.transmission>0?i.unshift(p):h.transparent===!0?r.unshift(p):n.unshift(p)}function c(f,d){n.length>1&&n.sort(f||$b),i.length>1&&i.sort(d||Sd),r.length>1&&r.sort(d||Sd)}function u(){for(let f=e,d=t.length;f<d;f++){const h=t[f];if(h.id===null)break;h.id=null,h.object=null,h.geometry=null,h.material=null,h.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:a,unshift:l,finish:u,sort:c}}function qb(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new yd,t.set(i,[o])):r>=s.length?(o=new yd,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function jb(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new Z,color:new _t};break;case"SpotLight":n={position:new Z,direction:new Z,color:new _t,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new Z,color:new _t,distance:0,decay:0};break;case"HemisphereLight":n={direction:new Z,skyColor:new _t,groundColor:new _t};break;case"RectAreaLight":n={color:new _t,position:new Z,halfWidth:new Z,halfHeight:new Z};break}return t[e.id]=n,n}}}function Yb(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pt};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pt};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new pt,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let Kb=0;function Zb(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function Jb(t){const e=new jb,n=Yb(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new Z);const r=new Z,s=new Lt,o=new Lt;function a(c){let u=0,f=0,d=0;for(let w=0;w<9;w++)i.probe[w].set(0,0,0);let h=0,g=0,_=0,m=0,p=0,T=0,x=0,y=0,L=0,C=0,P=0;c.sort(Zb);for(let w=0,E=c.length;w<E;w++){const D=c[w],k=D.color,H=D.intensity,q=D.distance,de=D.shadow&&D.shadow.map?D.shadow.map.texture:null;if(D.isAmbientLight)u+=k.r*H,f+=k.g*H,d+=k.b*H;else if(D.isLightProbe){for(let J=0;J<9;J++)i.probe[J].addScaledVector(D.sh.coefficients[J],H);P++}else if(D.isDirectionalLight){const J=e.get(D);if(J.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const fe=D.shadow,V=n.get(D);V.shadowIntensity=fe.intensity,V.shadowBias=fe.bias,V.shadowNormalBias=fe.normalBias,V.shadowRadius=fe.radius,V.shadowMapSize=fe.mapSize,i.directionalShadow[h]=V,i.directionalShadowMap[h]=de,i.directionalShadowMatrix[h]=D.shadow.matrix,T++}i.directional[h]=J,h++}else if(D.isSpotLight){const J=e.get(D);J.position.setFromMatrixPosition(D.matrixWorld),J.color.copy(k).multiplyScalar(H),J.distance=q,J.coneCos=Math.cos(D.angle),J.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),J.decay=D.decay,i.spot[_]=J;const fe=D.shadow;if(D.map&&(i.spotLightMap[L]=D.map,L++,fe.updateMatrices(D),D.castShadow&&C++),i.spotLightMatrix[_]=fe.matrix,D.castShadow){const V=n.get(D);V.shadowIntensity=fe.intensity,V.shadowBias=fe.bias,V.shadowNormalBias=fe.normalBias,V.shadowRadius=fe.radius,V.shadowMapSize=fe.mapSize,i.spotShadow[_]=V,i.spotShadowMap[_]=de,y++}_++}else if(D.isRectAreaLight){const J=e.get(D);J.color.copy(k).multiplyScalar(H),J.halfWidth.set(D.width*.5,0,0),J.halfHeight.set(0,D.height*.5,0),i.rectArea[m]=J,m++}else if(D.isPointLight){const J=e.get(D);if(J.color.copy(D.color).multiplyScalar(D.intensity),J.distance=D.distance,J.decay=D.decay,D.castShadow){const fe=D.shadow,V=n.get(D);V.shadowIntensity=fe.intensity,V.shadowBias=fe.bias,V.shadowNormalBias=fe.normalBias,V.shadowRadius=fe.radius,V.shadowMapSize=fe.mapSize,V.shadowCameraNear=fe.camera.near,V.shadowCameraFar=fe.camera.far,i.pointShadow[g]=V,i.pointShadowMap[g]=de,i.pointShadowMatrix[g]=D.shadow.matrix,x++}i.point[g]=J,g++}else if(D.isHemisphereLight){const J=e.get(D);J.skyColor.copy(D.color).multiplyScalar(H),J.groundColor.copy(D.groundColor).multiplyScalar(H),i.hemi[p]=J,p++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Le.LTC_FLOAT_1,i.rectAreaLTC2=Le.LTC_FLOAT_2):(i.rectAreaLTC1=Le.LTC_HALF_1,i.rectAreaLTC2=Le.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=f,i.ambient[2]=d;const F=i.hash;(F.directionalLength!==h||F.pointLength!==g||F.spotLength!==_||F.rectAreaLength!==m||F.hemiLength!==p||F.numDirectionalShadows!==T||F.numPointShadows!==x||F.numSpotShadows!==y||F.numSpotMaps!==L||F.numLightProbes!==P)&&(i.directional.length=h,i.spot.length=_,i.rectArea.length=m,i.point.length=g,i.hemi.length=p,i.directionalShadow.length=T,i.directionalShadowMap.length=T,i.pointShadow.length=x,i.pointShadowMap.length=x,i.spotShadow.length=y,i.spotShadowMap.length=y,i.directionalShadowMatrix.length=T,i.pointShadowMatrix.length=x,i.spotLightMatrix.length=y+L-C,i.spotLightMap.length=L,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=P,F.directionalLength=h,F.pointLength=g,F.spotLength=_,F.rectAreaLength=m,F.hemiLength=p,F.numDirectionalShadows=T,F.numPointShadows=x,F.numSpotShadows=y,F.numSpotMaps=L,F.numLightProbes=P,i.version=Kb++)}function l(c,u){let f=0,d=0,h=0,g=0,_=0;const m=u.matrixWorldInverse;for(let p=0,T=c.length;p<T;p++){const x=c[p];if(x.isDirectionalLight){const y=i.directional[f];y.direction.setFromMatrixPosition(x.matrixWorld),r.setFromMatrixPosition(x.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),f++}else if(x.isSpotLight){const y=i.spot[h];y.position.setFromMatrixPosition(x.matrixWorld),y.position.applyMatrix4(m),y.direction.setFromMatrixPosition(x.matrixWorld),r.setFromMatrixPosition(x.target.matrixWorld),y.direction.sub(r),y.direction.transformDirection(m),h++}else if(x.isRectAreaLight){const y=i.rectArea[g];y.position.setFromMatrixPosition(x.matrixWorld),y.position.applyMatrix4(m),o.identity(),s.copy(x.matrixWorld),s.premultiply(m),o.extractRotation(s),y.halfWidth.set(x.width*.5,0,0),y.halfHeight.set(0,x.height*.5,0),y.halfWidth.applyMatrix4(o),y.halfHeight.applyMatrix4(o),g++}else if(x.isPointLight){const y=i.point[d];y.position.setFromMatrixPosition(x.matrixWorld),y.position.applyMatrix4(m),d++}else if(x.isHemisphereLight){const y=i.hemi[_];y.direction.setFromMatrixPosition(x.matrixWorld),y.direction.transformDirection(m),_++}}}return{setup:a,setupView:l,state:i}}function Ed(t){const e=new Jb(t),n=[],i=[];function r(u){c.camera=u,n.length=0,i.length=0}function s(u){n.push(u)}function o(u){i.push(u)}function a(){e.setup(n)}function l(u){e.setupView(n,u)}const c={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function Qb(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new Ed(t),e.set(r,[a])):s>=o.length?(a=new Ed(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const e1=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class c1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new cn,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!==i.depthNear||n.depthFar!==i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new xi({vertexShader:a1,fragmentShader:l1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new hi(new Fa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class u1 extends as{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,d=null,h=null,g=null;const _=new c1,m=n.getContextAttributes();let p=null,T=null;const x=[],y=[],L=new pt;let C=null;const P=new In;P.viewport=new Dt;const F=new In;F.viewport=new Dt;const w=[P,F],E=new DS;let D=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ce){let Ee=x[ce];return Ee===void 0&&(Ee=new Dl,x[ce]=Ee),Ee.getTargetRaySpace()},this.getControllerGrip=function(ce){let Ee=x[ce];return Ee===void 0&&(Ee=new Dl,x[ce]=Ee),Ee.getGripSpace()},this.getHand=function(ce){let Ee=x[ce];return Ee===void 0&&(Ee=new Dl,x[ce]=Ee),Ee.getHandSpace()};function H(ce){const Ee=y.indexOf(ce.inputSource);if(Ee===-1)return;const Pe=x[Ee];Pe!==void 0&&(Pe.update(ce.inputSource,ce.frame,c||o),Pe.dispatchEvent({type:ce.type,data:ce.inputSource}))}function q(){r.removeEventListener("select",H),r.removeEventListener("selectstart",H),r.removeEventListener("selectend",H),r.removeEventListener("squeeze",H),r.removeEventListener("squeezestart",H),r.removeEventListener("squeezeend",H),r.removeEventListener("end",q),r.removeEventListener("inputsourceschange",de);for(let ce=0;ce<x.length;ce++){const Ee=y[ce];Ee!==null&&(y[ce]=null,x[ce].disconnect(Ee))}D=null,k=null,_.reset(),e.setRenderTarget(p),h=null,d=null,f=null,r=null,T=null,Je.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ce){s=ce,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ce){a=ce,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(ce){c=ce},this.getBaseLayer=function(){return d!==null?d:h},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(ce){if(r=ce,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",H),r.addEventListener("selectstart",H),r.addEventListener("selectend",H),r.addEventListener("squeeze",H),r.addEventListener("squeezestart",H),r.addEventListener("squeezeend",H),r.addEventListener("end",q),r.addEventListener("inputsourceschange",de),m.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(L),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Pe=null,O=null,ee=null;m.depth&&(ee=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Pe=m.stencil?Qs:Js,O=m.stencil?Zs:xr);const ge={colorFormat:n.RGBA8,depthFormat:ee,scaleFactor:s};f=new XRWebGLBinding(r,n),d=f.createProjectionLayer(ge),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),T=new Sr(d.textureWidth,d.textureHeight,{format:Nn,type:_i,depthTexture:new Up(d.textureWidth,d.textureHeight,O,void 0,void 0,void 0,void 0,void 0,void 0,Pe),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const Pe={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,n,Pe),r.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),T=new Sr(h.framebufferWidth,h.framebufferHeight,{format:Nn,type:_i,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Je.setContext(r),Je.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function de(ce){for(let Ee=0;Ee<ce.removed.length;Ee++){const Pe=ce.removed[Ee],O=y.indexOf(Pe);O>=0&&(y[O]=null,x[O].disconnect(Pe))}for(let Ee=0;Ee<ce.added.length;Ee++){const Pe=ce.added[Ee];let O=y.indexOf(Pe);if(O===-1){for(let ge=0;ge<x.length;ge++)if(ge>=y.length){y.push(Pe),O=ge;break}else if(y[ge]===null){y[ge]=Pe,O=ge;break}if(O===-1)break}const ee=x[O];ee&&ee.connect(Pe)}}const J=new Z,fe=new Z;function V(ce,Ee,Pe){J.setFromMatrixPosition(Ee.matrixWorld),fe.setFromMatrixPosition(Pe.matrixWorld);const O=J.distanceTo(fe),ee=Ee.projectionMatrix.elements,ge=Pe.projectionMatrix.elements,me=ee[14]/(ee[10]-1),Xe=ee[14]/(ee[10]+1),A=(ee[9]+1)/ee[5],R=(ee[9]-1)/ee[5],S=(ee[8]-1)/ee[0],ae=(ge[8]+1)/ge[0],Q=me*S,K=me*ae,se=O/(-S+ae),pe=se*-S;if(Ee.matrixWorld.decompose(ce.position,ce.quaternion,ce.scale),ce.translateX(pe),ce.translateZ(se),ce.matrixWorld.compose(ce.position,ce.quaternion,ce.scale),ce.matrixWorldInverse.copy(ce.matrixWorld).invert(),ee[10]===-1)ce.projectionMatrix.copy(Ee.projectionMatrix),ce.projectionMatrixInverse.copy(Ee.projectionMatrixInverse);else{const re=me+se,te=Xe+se,Ie=Q-pe,b=K+(O-pe),v=A*Xe/te*re,N=R*Xe/te*re;ce.projectionMatrix.makePerspective(Ie,b,v,N,re,te),ce.projectionMatrixInverse.copy(ce.projectionMatrix).invert()}}function Te(ce,Ee){Ee===null?ce.matrixWorld.copy(ce.matrix):ce.matrixWorld.multiplyMatrices(Ee.matrixWorld,ce.matrix),ce.matrixWorldInverse.copy(ce.matrixWorld).invert()}this.updateCamera=function(ce){if(r===null)return;let Ee=ce.near,Pe=ce.far;_.texture!==null&&(_.depthNear>0&&(Ee=_.depthNear),_.depthFar>0&&(Pe=_.depthFar)),E.near=F.near=P.near=Ee,E.far=F.far=P.far=Pe,(D!==E.near||k!==E.far)&&(r.updateRenderState({depthNear:E.near,depthFar:E.far}),D=E.near,k=E.far),P.layers.mask=ce.layers.mask|2,F.layers.mask=ce.layers.mask|4,E.layers.mask=P.layers.mask|F.layers.mask;const O=ce.parent,ee=E.cameras;Te(E,O);for(let ge=0;ge<ee.length;ge++)Te(ee[ge],O);ee.length===2?V(E,P,F):E.projectionMatrix.copy(P.projectionMatrix),De(ce,E,O)};function De(ce,Ee,Pe){Pe===null?ce.matrix.copy(Ee.matrixWorld):(ce.matrix.copy(Pe.matrixWorld),ce.matrix.invert(),ce.matrix.multiply(Ee.matrixWorld)),ce.matrix.decompose(ce.position,ce.quaternion,ce.scale),ce.updateMatrixWorld(!0),ce.projectionMatrix.copy(Ee.projectionMatrix),ce.projectionMatrixInverse.copy(Ee.projectionMatrixInverse),ce.isPerspectiveCamera&&(ce.fov=Vc*2*Math.atan(1/ce.projectionMatrix.elements[5]),ce.zoom=1)}this.getCamera=function(){return E},this.getFoveation=function(){if(!(d===null&&h===null))return l},this.setFoveation=function(ce){l=ce,d!==null&&(d.fixedFoveation=ce),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=ce)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(E)};let Fe=null;function We(ce,Ee){if(u=Ee.getViewerPose(c||o),g=Ee,u!==null){const Pe=u.views;h!==null&&(e.setRenderTargetFramebuffer(T,h.framebuffer),e.setRenderTarget(T));let O=!1;Pe.length!==E.cameras.length&&(E.cameras.length=0,O=!0);for(let me=0;me<Pe.length;me++){const Xe=Pe[me];let A=null;if(h!==null)A=h.getViewport(Xe);else{const S=f.getViewSubImage(d,Xe);A=S.viewport,me===0&&(e.setRenderTargetTextures(T,S.colorTexture,S.depthStencilTexture),e.setRenderTarget(T))}let R=w[me];R===void 0&&(R=new In,R.layers.enable(me),R.viewport=new Dt,w[me]=R),R.matrix.fromArray(Xe.transform.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale),R.projectionMatrix.fromArray(Xe.projectionMatrix),R.projectionMatrixInverse.copy(R.projectionMatrix).invert(),R.viewport.set(A.x,A.y,A.width,A.height),me===0&&(E.matrix.copy(R.matrix),E.matrix.decompose(E.position,E.quaternion,E.scale)),O===!0&&E.cameras.push(R)}const ee=r.enabledFeatures;if(ee&&ee.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&f){const me=f.getDepthInformation(Pe[0]);me&&me.isValid&&me.texture&&_.init(e,me,r.renderState)}}for(let Pe=0;Pe<x.length;Pe++){const O=y[Pe],ee=x[Pe];O!==null&&ee!==void 0&&ee.update(O,Ee,c||o)}Fe&&Fe(ce,Ee),Ee.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Ee}),g=null}const Je=new Op;Je.setAnimationLoop(We),this.setAnimationLoop=function(ce){Fe=ce},this.dispose=function(){}}}const or=new vi,f1=new Lt;function d1(t,e){function n(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,Pp(t)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,T,x,y){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),f(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&h(m,p,y)):p.isMeshMatcapMaterial?(s(m,p),g(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),_(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,T,x):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,n(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,n(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===ln&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,n(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===ln&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,n(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,n(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,n(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const T=e.get(p),x=T.envMap,y=T.envMapRotation;x&&(m.envMap.value=x,or.copy(y),or.x*=-1,or.y*=-1,or.z*=-1,x.isCubeTexture&&x.isRenderTargetTexture===!1&&(or.y*=-1,or.z*=-1),m.envMapRotation.value.setFromMatrix4(f1.makeRotationFromEuler(or)),m.flipEnvMap.value=x.isCubeTexture&&x.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,n(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,n(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,n(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,T,x){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*T,m.scale.value=x*.5,p.map&&(m.map.value=p.map,n(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,n(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,n(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,n(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function h(m,p,T){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,n(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,n(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,n(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,n(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,n(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===ln&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,n(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,n(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,n(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,n(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,n(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,n(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,n(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const T=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function h1(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,x){const y=x.program;i.uniformBlockBinding(T,y)}function c(T,x){let y=r[T.id];y===void 0&&(g(T),y=u(T),r[T.id]=y,T.addEventListener("dispose",m));const L=x.program;i.updateUBOMapping(T,L);const C=e.render.frame;s[T.id]!==C&&(d(T),s[T.id]=C)}function u(T){const x=f();T.__bindingPointIndex=x;const y=t.createBuffer(),L=T.__size,C=T.usage;return t.bindBuffer(t.UNIFORM_BUFFER,y),t.bufferData(t.UNIFORM_BUFFER,L,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,x,y),y}function f(){for(let T=0;T<a;T++)if(o.indexOf(T)===-1)return o.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(T){const x=r[T.id],y=T.uniforms,L=T.__cache;t.bindBuffer(t.UNIFORM_BUFFER,x);for(let C=0,P=y.length;C<P;C++){const F=Array.isArray(y[C])?y[C]:[y[C]];for(let w=0,E=F.length;w<E;w++){const D=F[w];if(h(D,C,w,L)===!0){const k=D.__offset,H=Array.isArray(D.value)?D.value:[D.value];let q=0;for(let de=0;de<H.length;de++){const J=H[de],fe=_(J);typeof J=="number"||typeof J=="boolean"?(D.__data[0]=J,t.bufferSubData(t.UNIFORM_BUFFER,k+q,D.__data)):J.isMatrix3?(D.__data[0]=J.elements[0],D.__data[1]=J.elements[1],D.__data[2]=J.elements[2],D.__data[3]=0,D.__data[4]=J.elements[3],D.__data[5]=J.elements[4],D.__data[6]=J.elements[5],D.__data[7]=0,D.__data[8]=J.elements[6],D.__data[9]=J.elements[7],D.__data[10]=J.elements[8],D.__data[11]=0):(J.toArray(D.__data,q),q+=fe.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,k,D.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function h(T,x,y,L){const C=T.value,P=x+"_"+y;if(L[P]===void 0)return typeof C=="number"||typeof C=="boolean"?L[P]=C:L[P]=C.clone(),!0;{const F=L[P];if(typeof C=="number"||typeof C=="boolean"){if(F!==C)return L[P]=C,!0}else if(F.equals(C)===!1)return F.copy(C),!0}return!1}function g(T){const x=T.uniforms;let y=0;const L=16;for(let P=0,F=x.length;P<F;P++){const w=Array.isArray(x[P])?x[P]:[x[P]];for(let E=0,D=w.length;E<D;E++){const k=w[E],H=Array.isArray(k.value)?k.value:[k.value];for(let q=0,de=H.length;q<de;q++){const J=H[q],fe=_(J),V=y%L,Te=V%fe.boundary,De=V+Te;y+=Te,De!==0&&L-De<fe.storage&&(y+=L-De),k.__data=new Float32Array(fe.storage/Float32Array.BYTES_PER_ELEMENT),k.__offset=y,y+=fe.storage}}}const C=y%L;return C>0&&(y+=L-C),T.__size=y,T.__cache={},this}function _(T){const x={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(x.boundary=4,x.storage=4):T.isVector2?(x.boundary=8,x.storage=8):T.isVector3||T.isColor?(x.boundary=16,x.storage=12):T.isVector4?(x.boundary=16,x.storage=16):T.isMatrix3?(x.boundary=48,x.storage=48):T.isMatrix4?(x.boundary=64,x.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),x}function m(T){const x=T.target;x.removeEventListener("dispose",m);const y=o.indexOf(x.__bindingPointIndex);o.splice(y,1),t.deleteBuffer(r[x.id]),delete r[x.id],delete s[x.id]}function p(){for(const T in r)t.deleteBuffer(r[T]);o=[],r={},s={}}return{bind:l,update:c,dispose:p}}class p1{constructor(e={}){const{canvas:n=Yx(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reverseDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let h;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");h=i.getContextAttributes().alpha}else h=o;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,p=null;const T=[],x=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Vi,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const y=this;let L=!1;this._outputColorSpace=Tn;let C=0,P=0,F=null,w=-1,E=null;const D=new Dt,k=new Dt;let H=null;const q=new _t(0);let de=0,J=n.width,fe=n.height,V=1,Te=null,De=null;const Fe=new Dt(0,0,J,fe),We=new Dt(0,0,J,fe);let Je=!1;const ce=new Ip;let Ee=!1,Pe=!1;const O=new Lt,ee=new Lt,ge=new Z,me=new Dt,Xe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let A=!1;function R(){return F===null?V:1}let S=i;function ae(M,B){return n.getContext(M,B)}try{const M={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${gu}`),n.addEventListener("webglcontextlost",Se,!1),n.addEventListener("webglcontextrestored",he,!1),n.addEventListener("webglcontextcreationerror",Y,!1),S===null){const B="webgl2";if(S=ae(B,M),S===null)throw ae(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let Q,K,se,pe,re,te,Ie,b,v,N,W,oe,G,ve,ue,_e,ye,le,Re,Ue,Ne,we,Ve,I;function Ce(){Q=new bM(S),Q.init(),we=new o1(S,Q),K=new _M(S,Q,e,we),se=new r1(S,Q),K.reverseDepthBuffer&&d&&se.buffers.depth.setReversed(!0),pe=new AM(S),re=new Xb,te=new s1(S,Q,se,re,K,we,pe),Ie=new xM(y),b=new MM(y),v=new IS(S),Ve=new mM(S,v),N=new TM(S,v,pe,Ve),W=new CM(S,N,v,pe),Re=new RM(S,K,te),_e=new vM(re),oe=new Wb(y,Ie,b,Q,K,Ve,_e),G=new d1(y,re),ve=new qb,ue=new Qb(Q),le=new pM(y,Ie,b,se,W,h,l),ye=new n1(y,W,K),I=new h1(S,pe,K,se),Ue=new gM(S,Q,pe),Ne=new wM(S,Q,pe),pe.programs=oe.programs,y.capabilities=K,y.extensions=Q,y.properties=re,y.renderLists=ve,y.shadowMap=ye,y.state=se,y.info=pe}Ce();const xe=new u1(y,S);this.xr=xe,this.getContext=function(){return S},this.getContextAttributes=function(){return S.getContextAttributes()},this.forceContextLoss=function(){const M=Q.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=Q.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(M){M!==void 0&&(V=M,this.setSize(J,fe,!1))},this.getSize=function(M){return M.set(J,fe)},this.setSize=function(M,B,X=!0){if(xe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}J=M,fe=B,n.width=Math.floor(M*V),n.height=Math.floor(B*V),X===!0&&(n.style.width=M+"px",n.style.height=B+"px"),this.setViewport(0,0,M,B)},this.getDrawingBufferSize=function(M){return M.set(J*V,fe*V).floor()},this.setDrawingBufferSize=function(M,B,X){J=M,fe=B,V=X,n.width=Math.floor(M*X),n.height=Math.floor(B*X),this.setViewport(0,0,M,B)},this.getCurrentViewport=function(M){return M.copy(D)},this.getViewport=function(M){return M.copy(Fe)},this.setViewport=function(M,B,X,$){M.isVector4?Fe.set(M.x,M.y,M.z,M.w):Fe.set(M,B,X,$),se.viewport(D.copy(Fe).multiplyScalar(V).round())},this.getScissor=function(M){return M.copy(We)},this.setScissor=function(M,B,X,$){M.isVector4?We.set(M.x,M.y,M.z,M.w):We.set(M,B,X,$),se.scissor(k.copy(We).multiplyScalar(V).round())},this.getScissorTest=function(){return Je},this.setScissorTest=function(M){se.setScissorTest(Je=M)},this.setOpaqueSort=function(M){Te=M},this.setTransparentSort=function(M){De=M},this.getClearColor=function(M){return M.copy(le.getClearColor())},this.setClearColor=function(){le.setClearColor(...arguments)},this.getClearAlpha=function(){return le.getClearAlpha()},this.setClearAlpha=function(){le.setClearAlpha(...arguments)},this.clear=function(M=!0,B=!0,X=!0){let $=0;if(M){let z=!1;if(F!==null){const be=F.texture.format;z=be===Eu||be===yu||be===Su}if(z){const be=F.texture.type,Oe=be===_i||be===xr||be===Ks||be===Zs||be===vu||be===xu,ze=le.getClearColor(),Be=le.getClearAlpha(),Ye=ze.r,Ke=ze.g,$e=ze.b;Oe?(g[0]=Ye,g[1]=Ke,g[2]=$e,g[3]=Be,S.clearBufferuiv(S.COLOR,0,g)):(_[0]=Ye,_[1]=Ke,_[2]=$e,_[3]=Be,S.clearBufferiv(S.COLOR,0,_))}else $|=S.COLOR_BUFFER_BIT}B&&($|=S.DEPTH_BUFFER_BIT),X&&($|=S.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),S.clear($)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Se,!1),n.removeEventListener("webglcontextrestored",he,!1),n.removeEventListener("webglcontextcreationerror",Y,!1),le.dispose(),ve.dispose(),ue.dispose(),re.dispose(),Ie.dispose(),b.dispose(),W.dispose(),Ve.dispose(),I.dispose(),oe.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",br),xe.removeEventListener("sessionend",Tr),nn.stop()};function Se(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function he(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const M=pe.autoReset,B=ye.enabled,X=ye.autoUpdate,$=ye.needsUpdate,z=ye.type;Ce(),pe.autoReset=M,ye.enabled=B,ye.autoUpdate=X,ye.needsUpdate=$,ye.type=z}function Y(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function Me(M){const B=M.target;B.removeEventListener("dispose",Me),ke(B)}function ke(M){rt(M),re.remove(M)}function rt(M){const B=re.get(M).programs;B!==void 0&&(B.forEach(function(X){oe.releaseProgram(X)}),M.isShaderMaterial&&oe.releaseShaderCache(M))}this.renderBufferDirect=function(M,B,X,$,z,be){B===null&&(B=Xe);const Oe=z.isMesh&&z.matrixWorld.determinant()<0,ze=bi(M,B,X,$,z);se.setMaterial($,Oe);let Be=X.index,Ye=1;if($.wireframe===!0){if(Be=N.getWireframeAttribute(X),Be===void 0)return;Ye=2}const Ke=X.drawRange,$e=X.attributes.position;let at=Ke.start*Ye,vt=(Ke.start+Ke.count)*Ye;be!==null&&(at=Math.max(at,be.start*Ye),vt=Math.min(vt,(be.start+be.count)*Ye)),Be!==null?(at=Math.max(at,0),vt=Math.min(vt,Be.count)):$e!=null&&(at=Math.max(at,0),vt=Math.min(vt,$e.count));const Rt=vt-at;if(Rt<0||Rt===1/0)return;Ve.setup(z,$,ze,X,Be);let Mt,St=Ue;if(Be!==null&&(Mt=v.get(Be),St=Ne,St.setIndex(Mt)),z.isMesh)$.wireframe===!0?(se.setLineWidth($.wireframeLinewidth*R()),St.setMode(S.LINES)):St.setMode(S.TRIANGLES);else if(z.isLine){let qe=$.linewidth;qe===void 0&&(qe=1),se.setLineWidth(qe*R()),z.isLineSegments?St.setMode(S.LINES):z.isLineLoop?St.setMode(S.LINE_LOOP):St.setMode(S.LINE_STRIP)}else z.isPoints?St.setMode(S.POINTS):z.isSprite&&St.setMode(S.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)Jr("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),St.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(Q.get("WEBGL_multi_draw"))St.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const qe=z._multiDrawStarts,At=z._multiDrawCounts,ft=z._multiDrawCount,pn=Be?v.get(Be).bytesPerElement:1,Ar=re.get($).currentProgram.getUniforms();for(let mn=0;mn<ft;mn++)Ar.setValue(S,"_gl_DrawID",mn),St.render(qe[mn]/pn,At[mn])}else if(z.isInstancedMesh)St.renderInstances(at,Rt,z.count);else if(X.isInstancedBufferGeometry){const qe=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,At=Math.min(X.instanceCount,qe);St.renderInstances(at,Rt,At)}else St.render(at,Rt)};function nt(M,B,X){M.transparent===!0&&M.side===ci&&M.forceSinglePass===!1?(M.side=ln,M.needsUpdate=!0,Yt(M,B,X),M.side=Xi,M.needsUpdate=!0,Yt(M,B,X),M.side=ci):Yt(M,B,X)}this.compile=function(M,B,X=null){X===null&&(X=M),p=ue.get(X),p.init(B),x.push(p),X.traverseVisible(function(z){z.isLight&&z.layers.test(B.layers)&&(p.pushLight(z),z.castShadow&&p.pushShadow(z))}),M!==X&&M.traverseVisible(function(z){z.isLight&&z.layers.test(B.layers)&&(p.pushLight(z),z.castShadow&&p.pushShadow(z))}),p.setupLights();const $=new Set;return M.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const be=z.material;if(be)if(Array.isArray(be))for(let Oe=0;Oe<be.length;Oe++){const ze=be[Oe];nt(ze,X,z),$.add(ze)}else nt(be,X,z),$.add(be)}),p=x.pop(),$},this.compileAsync=function(M,B,X=null){const $=this.compile(M,B,X);return new Promise(z=>{function be(){if($.forEach(function(Oe){re.get(Oe).currentProgram.isReady()&&$.delete(Oe)}),$.size===0){z(M);return}setTimeout(be,10)}Q.get("KHR_parallel_shader_compile")!==null?be():setTimeout(be,10)})};let zt=null;function tn(M){zt&&zt(M)}function br(){nn.stop()}function Tr(){nn.start()}const nn=new Op;nn.setAnimationLoop(tn),typeof self<"u"&&nn.setContext(self),this.setAnimationLoop=function(M){zt=M,xe.setAnimationLoop(M),M===null?nn.stop():nn.start()},xe.addEventListener("sessionstart",br),xe.addEventListener("sessionend",Tr),this.render=function(M,B){if(B!==void 0&&B.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(xe.cameraAutoUpdate===!0&&xe.updateCamera(B),B=xe.getCamera()),M.isScene===!0&&M.onBeforeRender(y,M,B,F),p=ue.get(M,x.length),p.init(B),x.push(p),ee.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),ce.setFromProjectionMatrix(ee),Pe=this.localClippingEnabled,Ee=_e.init(this.clippingPlanes,Pe),m=ve.get(M,T.length),m.init(),T.push(m),xe.enabled===!0&&xe.isPresenting===!0){const be=y.xr.getDepthSensingMesh();be!==null&&Ei(be,B,-1/0,y.sortObjects)}Ei(M,B,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(Te,De),A=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,A&&le.addToRenderList(m,M),this.info.render.frame++,Ee===!0&&_e.beginShadows();const X=p.state.shadowsArray;ye.render(X,M,B),Ee===!0&&_e.endShadows(),this.info.autoReset===!0&&this.info.reset();const $=m.opaque,z=m.transmissive;if(p.setupLights(),B.isArrayCamera){const be=B.cameras;if(z.length>0)for(let Oe=0,ze=be.length;Oe<ze;Oe++){const Be=be[Oe];Yi($,z,M,Be)}A&&le.render(M);for(let Oe=0,ze=be.length;Oe<ze;Oe++){const Be=be[Oe];ji(m,M,Be,Be.viewport)}}else z.length>0&&Yi($,z,M,B),A&&le.render(M),ji(m,M,B);F!==null&&P===0&&(te.updateMultisampleRenderTarget(F),te.updateRenderTargetMipmap(F)),M.isScene===!0&&M.onAfterRender(y,M,B),Ve.resetDefaultState(),w=-1,E=null,x.pop(),x.length>0?(p=x[x.length-1],Ee===!0&&_e.setGlobalState(y.clippingPlanes,p.state.camera)):p=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function Ei(M,B,X,$){if(M.visible===!1)return;if(M.layers.test(B.layers)){if(M.isGroup)X=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(B);else if(M.isLight)p.pushLight(M),M.castShadow&&p.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||ce.intersectsSprite(M)){$&&me.setFromMatrixPosition(M.matrixWorld).applyMatrix4(ee);const Oe=W.update(M),ze=M.material;ze.visible&&m.push(M,Oe,ze,X,me.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||ce.intersectsObject(M))){const Oe=W.update(M),ze=M.material;if($&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),me.copy(M.boundingSphere.center)):(Oe.boundingSphere===null&&Oe.computeBoundingSphere(),me.copy(Oe.boundingSphere.center)),me.applyMatrix4(M.matrixWorld).applyMatrix4(ee)),Array.isArray(ze)){const Be=Oe.groups;for(let Ye=0,Ke=Be.length;Ye<Ke;Ye++){const $e=Be[Ye],at=ze[$e.materialIndex];at&&at.visible&&m.push(M,Oe,at,X,me.z,$e)}}else ze.visible&&m.push(M,Oe,ze,X,me.z,null)}}const be=M.children;for(let Oe=0,ze=be.length;Oe<ze;Oe++)Ei(be[Oe],B,X,$)}function ji(M,B,X,$){const z=M.opaque,be=M.transmissive,Oe=M.transparent;p.setupLightsView(X),Ee===!0&&_e.setGlobalState(y.clippingPlanes,X),$&&se.viewport(D.copy($)),z.length>0&&st(z,B,X),be.length>0&&st(be,B,X),Oe.length>0&&st(Oe,B,X),se.buffers.depth.setTest(!0),se.buffers.depth.setMask(!0),se.buffers.color.setMask(!0),se.setPolygonOffset(!1)}function Yi(M,B,X,$){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[$.id]===void 0&&(p.state.transmissionRenderTarget[$.id]=new Sr(1,1,{generateMipmaps:!0,type:Q.has("EXT_color_buffer_half_float")||Q.has("EXT_color_buffer_float")?io:_i,minFilter:pr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:dt.workingColorSpace}));const be=p.state.transmissionRenderTarget[$.id],Oe=$.viewport||D;be.setSize(Oe.z*y.transmissionResolutionScale,Oe.w*y.transmissionResolutionScale);const ze=y.getRenderTarget(),Be=y.getActiveCubeFace(),Ye=y.getActiveMipmapLevel();y.setRenderTarget(be),y.getClearColor(q),de=y.getClearAlpha(),de<1&&y.setClearColor(16777215,.5),y.clear(),A&&le.render(X);const Ke=y.toneMapping;y.toneMapping=Vi;const $e=$.viewport;if($.viewport!==void 0&&($.viewport=void 0),p.setupLightsView($),Ee===!0&&_e.setGlobalState(y.clippingPlanes,$),st(M,X,$),te.updateMultisampleRenderTarget(be),te.updateRenderTargetMipmap(be),Q.has("WEBGL_multisampled_render_to_texture")===!1){let at=!1;for(let vt=0,Rt=B.length;vt<Rt;vt++){const Mt=B[vt],St=Mt.object,qe=Mt.geometry,At=Mt.material,ft=Mt.group;if(At.side===ci&&St.layers.test($.layers)){const pn=At.side;At.side=ln,At.needsUpdate=!0,ot(St,X,$,qe,At,ft),At.side=pn,At.needsUpdate=!0,at=!0}}at===!0&&(te.updateMultisampleRenderTarget(be),te.updateRenderTargetMipmap(be))}y.setRenderTarget(ze,Be,Ye),y.setClearColor(q,de),$e!==void 0&&($.viewport=$e),y.toneMapping=Ke}function st(M,B,X){const $=B.isScene===!0?B.overrideMaterial:null;for(let z=0,be=M.length;z<be;z++){const Oe=M[z],ze=Oe.object,Be=Oe.geometry,Ye=Oe.group;let Ke=Oe.material;Ke.allowOverride===!0&&$!==null&&(Ke=$),ze.layers.test(X.layers)&&ot(ze,B,X,Be,Ke,Ye)}}function ot(M,B,X,$,z,be){M.onBeforeRender(y,B,X,$,z,be),M.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),z.onBeforeRender(y,B,X,$,M,be),z.transparent===!0&&z.side===ci&&z.forceSinglePass===!1?(z.side=ln,z.needsUpdate=!0,y.renderBufferDirect(X,B,$,z,M,be),z.side=Xi,z.needsUpdate=!0,y.renderBufferDirect(X,B,$,z,M,be),z.side=ci):y.renderBufferDirect(X,B,$,z,M,be),M.onAfterRender(y,B,X,$,z,be)}function Yt(M,B,X){B.isScene!==!0&&(B=Xe);const $=re.get(M),z=p.state.lights,be=p.state.shadowsArray,Oe=z.state.version,ze=oe.getParameters(M,z.state,be,B,X),Be=oe.getProgramCacheKey(ze);let Ye=$.programs;$.environment=M.isMeshStandardMaterial?B.environment:null,$.fog=B.fog,$.envMap=(M.isMeshStandardMaterial?b:Ie).get(M.envMap||$.environment),$.envMapRotation=$.environment!==null&&M.envMap===null?B.environmentRotation:M.envMapRotation,Ye===void 0&&(M.addEventListener("dispose",Me),Ye=new Map,$.programs=Ye);let Ke=Ye.get(Be);if(Ke!==void 0){if($.currentProgram===Ke&&$.lightsStateVersion===Oe)return Mi(M,ze),Ke}else ze.uniforms=oe.getUniforms(M),M.onBeforeCompile(ze,y),Ke=oe.acquireProgram(ze,Be),Ye.set(Be,Ke),$.uniforms=ze.uniforms;const $e=$.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&($e.clippingPlanes=_e.uniform),Mi(M,ze),$.needsLights=Gt(M),$.lightsStateVersion=Oe,$.needsLights&&($e.ambientLightColor.value=z.state.ambient,$e.lightProbe.value=z.state.probe,$e.directionalLights.value=z.state.directional,$e.directionalLightShadows.value=z.state.directionalShadow,$e.spotLights.value=z.state.spot,$e.spotLightShadows.value=z.state.spotShadow,$e.rectAreaLights.value=z.state.rectArea,$e.ltc_1.value=z.state.rectAreaLTC1,$e.ltc_2.value=z.state.rectAreaLTC2,$e.pointLights.value=z.state.point,$e.pointLightShadows.value=z.state.pointShadow,$e.hemisphereLights.value=z.state.hemi,$e.directionalShadowMap.value=z.state.directionalShadowMap,$e.directionalShadowMatrix.value=z.state.directionalShadowMatrix,$e.spotShadowMap.value=z.state.spotShadowMap,$e.spotLightMatrix.value=z.state.spotLightMatrix,$e.spotLightMap.value=z.state.spotLightMap,$e.pointShadowMap.value=z.state.pointShadowMap,$e.pointShadowMatrix.value=z.state.pointShadowMatrix),$.currentProgram=Ke,$.uniformsList=null,Ke}function hn(M){if(M.uniformsList===null){const B=M.currentProgram.getUniforms();M.uniformsList=Jo.seqWithValue(B.seq,M.uniforms)}return M.uniformsList}function Mi(M,B){const X=re.get(M);X.outputColorSpace=B.outputColorSpace,X.batching=B.batching,X.batchingColor=B.batchingColor,X.instancing=B.instancing,X.instancingColor=B.instancingColor,X.instancingMorph=B.instancingMorph,X.skinning=B.skinning,X.morphTargets=B.morphTargets,X.morphNormals=B.morphNormals,X.morphColors=B.morphColors,X.morphTargetsCount=B.morphTargetsCount,X.numClippingPlanes=B.numClippingPlanes,X.numIntersection=B.numClipIntersection,X.vertexAlphas=B.vertexAlphas,X.vertexTangents=B.vertexTangents,X.toneMapping=B.toneMapping}function bi(M,B,X,$,z){B.isScene!==!0&&(B=Xe),te.resetTextureUnits();const be=B.fog,Oe=$.isMeshStandardMaterial?B.environment:null,ze=F===null?y.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:ss,Be=($.isMeshStandardMaterial?b:Ie).get($.envMap||Oe),Ye=$.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,Ke=!!X.attributes.tangent&&(!!$.normalMap||$.anisotropy>0),$e=!!X.morphAttributes.position,at=!!X.morphAttributes.normal,vt=!!X.morphAttributes.color;let Rt=Vi;$.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(Rt=y.toneMapping);const Mt=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,St=Mt!==void 0?Mt.length:0,qe=re.get($),At=p.state.lights;if(Ee===!0&&(Pe===!0||M!==E)){const Kt=M===E&&$.id===w;_e.setState($,M,Kt)}let ft=!1;$.version===qe.__version?(qe.needsLights&&qe.lightsStateVersion!==At.state.version||qe.outputColorSpace!==ze||z.isBatchedMesh&&qe.batching===!1||!z.isBatchedMesh&&qe.batching===!0||z.isBatchedMesh&&qe.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&qe.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&qe.instancing===!1||!z.isInstancedMesh&&qe.instancing===!0||z.isSkinnedMesh&&qe.skinning===!1||!z.isSkinnedMesh&&qe.skinning===!0||z.isInstancedMesh&&qe.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&qe.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&qe.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&qe.instancingMorph===!1&&z.morphTexture!==null||qe.envMap!==Be||$.fog===!0&&qe.fog!==be||qe.numClippingPlanes!==void 0&&(qe.numClippingPlanes!==_e.numPlanes||qe.numIntersection!==_e.numIntersection)||qe.vertexAlphas!==Ye||qe.vertexTangents!==Ke||qe.morphTargets!==$e||qe.morphNormals!==at||qe.morphColors!==vt||qe.toneMapping!==Rt||qe.morphTargetsCount!==St)&&(ft=!0):(ft=!0,qe.__version=$.version);let pn=qe.currentProgram;ft===!0&&(pn=Yt($,B,z));let Ar=!1,mn=!1,hs=!1;const wt=pn.getUniforms(),yn=qe.uniforms;if(se.useProgram(pn.program)&&(Ar=!0,mn=!0,hs=!0),$.id!==w&&(w=$.id,mn=!0),Ar||E!==M){se.buffers.depth.getReversed()?(O.copy(M.projectionMatrix),Zx(O),Jx(O),wt.setValue(S,"projectionMatrix",O)):wt.setValue(S,"projectionMatrix",M.projectionMatrix),wt.setValue(S,"viewMatrix",M.matrixWorldInverse);const rn=wt.map.cameraPosition;rn!==void 0&&rn.setValue(S,ge.setFromMatrixPosition(M.matrixWorld)),K.logarithmicDepthBuffer&&wt.setValue(S,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),($.isMeshPhongMaterial||$.isMeshToonMaterial||$.isMeshLambertMaterial||$.isMeshBasicMaterial||$.isMeshStandardMaterial||$.isShaderMaterial)&&wt.setValue(S,"isOrthographic",M.isOrthographicCamera===!0),E!==M&&(E=M,mn=!0,hs=!0)}if(z.isSkinnedMesh){wt.setOptional(S,z,"bindMatrix"),wt.setOptional(S,z,"bindMatrixInverse");const Kt=z.skeleton;Kt&&(Kt.boneTexture===null&&Kt.computeBoneTexture(),wt.setValue(S,"boneTexture",Kt.boneTexture,te))}z.isBatchedMesh&&(wt.setOptional(S,z,"batchingTexture"),wt.setValue(S,"batchingTexture",z._matricesTexture,te),wt.setOptional(S,z,"batchingIdTexture"),wt.setValue(S,"batchingIdTexture",z._indirectTexture,te),wt.setOptional(S,z,"batchingColorTexture"),z._colorsTexture!==null&&wt.setValue(S,"batchingColorTexture",z._colorsTexture,te));const En=X.morphAttributes;if((En.position!==void 0||En.normal!==void 0||En.color!==void 0)&&Re.update(z,X,pn),(mn||qe.receiveShadow!==z.receiveShadow)&&(qe.receiveShadow=z.receiveShadow,wt.setValue(S,"receiveShadow",z.receiveShadow)),$.isMeshGouraudMaterial&&$.envMap!==null&&(yn.envMap.value=Be,yn.flipEnvMap.value=Be.isCubeTexture&&Be.isRenderTargetTexture===!1?-1:1),$.isMeshStandardMaterial&&$.envMap===null&&B.environment!==null&&(yn.envMapIntensity.value=B.environmentIntensity),mn&&(wt.setValue(S,"toneMappingExposure",y.toneMappingExposure),qe.needsLights&&wr(yn,hs),be&&$.fog===!0&&G.refreshFogUniforms(yn,be),G.refreshMaterialUniforms(yn,$,V,fe,p.state.transmissionRenderTarget[M.id]),Jo.upload(S,hn(qe),yn,te)),$.isShaderMaterial&&$.uniformsNeedUpdate===!0&&(Jo.upload(S,hn(qe),yn,te),$.uniformsNeedUpdate=!1),$.isSpriteMaterial&&wt.setValue(S,"center",z.center),wt.setValue(S,"modelViewMatrix",z.modelViewMatrix),wt.setValue(S,"normalMatrix",z.normalMatrix),wt.setValue(S,"modelMatrix",z.matrixWorld),$.isShaderMaterial||$.isRawShaderMaterial){const Kt=$.uniformsGroups;for(let rn=0,$a=Kt.length;rn<$a;rn++){const Ki=Kt[rn];I.update(Ki,pn),I.bind(Ki,pn)}}return pn}function wr(M,B){M.ambientLightColor.needsUpdate=B,M.lightProbe.needsUpdate=B,M.directionalLights.needsUpdate=B,M.directionalLightShadows.needsUpdate=B,M.pointLights.needsUpdate=B,M.pointLightShadows.needsUpdate=B,M.spotLights.needsUpdate=B,M.spotLightShadows.needsUpdate=B,M.rectAreaLights.needsUpdate=B,M.hemisphereLights.needsUpdate=B}function Gt(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(M,B,X){const $=re.get(M);$.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,$.__autoAllocateDepthBuffer===!1&&($.__useRenderToTexture=!1),re.get(M.texture).__webglTexture=B,re.get(M.depthTexture).__webglTexture=$.__autoAllocateDepthBuffer?void 0:X,$.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,B){const X=re.get(M);X.__webglFramebuffer=B,X.__useDefaultFramebuffer=B===void 0};const Ti=S.createFramebuffer();this.setRenderTarget=function(M,B=0,X=0){F=M,C=B,P=X;let $=!0,z=null,be=!1,Oe=!1;if(M){const Be=re.get(M);if(Be.__useDefaultFramebuffer!==void 0)se.bindFramebuffer(S.FRAMEBUFFER,null),$=!1;else if(Be.__webglFramebuffer===void 0)te.setupRenderTarget(M);else if(Be.__hasExternalTextures)te.rebindTextures(M,re.get(M.texture).__webglTexture,re.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const $e=M.depthTexture;if(Be.__boundDepthTexture!==$e){if($e!==null&&re.has($e)&&(M.width!==$e.image.width||M.height!==$e.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");te.setupDepthRenderbuffer(M)}}const Ye=M.texture;(Ye.isData3DTexture||Ye.isDataArrayTexture||Ye.isCompressedArrayTexture)&&(Oe=!0);const Ke=re.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Ke[B])?z=Ke[B][X]:z=Ke[B],be=!0):M.samples>0&&te.useMultisampledRTT(M)===!1?z=re.get(M).__webglMultisampledFramebuffer:Array.isArray(Ke)?z=Ke[X]:z=Ke,D.copy(M.viewport),k.copy(M.scissor),H=M.scissorTest}else D.copy(Fe).multiplyScalar(V).floor(),k.copy(We).multiplyScalar(V).floor(),H=Je;if(X!==0&&(z=Ti),se.bindFramebuffer(S.FRAMEBUFFER,z)&&$&&se.drawBuffers(M,z),se.viewport(D),se.scissor(k),se.setScissorTest(H),be){const Be=re.get(M.texture);S.framebufferTexture2D(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_CUBE_MAP_POSITIVE_X+B,Be.__webglTexture,X)}else if(Oe){const Be=re.get(M.texture),Ye=B;S.framebufferTextureLayer(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,Be.__webglTexture,X,Ye)}else if(M!==null&&X!==0){const Be=re.get(M.texture);S.framebufferTexture2D(S.FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,Be.__webglTexture,X)}w=-1},this.readRenderTargetPixels=function(M,B,X,$,z,be,Oe,ze=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Be=re.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Oe!==void 0&&(Be=Be[Oe]),Be){se.bindFramebuffer(S.FRAMEBUFFER,Be);try{const Ye=M.textures[ze],Ke=Ye.format,$e=Ye.type;if(!K.textureFormatReadable(Ke)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!K.textureTypeReadable($e)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=M.width-$&&X>=0&&X<=M.height-z&&(M.textures.length>1&&S.readBuffer(S.COLOR_ATTACHMENT0+ze),S.readPixels(B,X,$,z,we.convert(Ke),we.convert($e),be))}finally{const Ye=F!==null?re.get(F).__webglFramebuffer:null;se.bindFramebuffer(S.FRAMEBUFFER,Ye)}}},this.readRenderTargetPixelsAsync=async function(M,B,X,$,z,be,Oe,ze=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Be=re.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&Oe!==void 0&&(Be=Be[Oe]),Be)if(B>=0&&B<=M.width-$&&X>=0&&X<=M.height-z){se.bindFramebuffer(S.FRAMEBUFFER,Be);const Ye=M.textures[ze],Ke=Ye.format,$e=Ye.type;if(!K.textureFormatReadable(Ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!K.textureTypeReadable($e))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const at=S.createBuffer();S.bindBuffer(S.PIXEL_PACK_BUFFER,at),S.bufferData(S.PIXEL_PACK_BUFFER,be.byteLength,S.STREAM_READ),M.textures.length>1&&S.readBuffer(S.COLOR_ATTACHMENT0+ze),S.readPixels(B,X,$,z,we.convert(Ke),we.convert($e),0);const vt=F!==null?re.get(F).__webglFramebuffer:null;se.bindFramebuffer(S.FRAMEBUFFER,vt);const Rt=S.fenceSync(S.SYNC_GPU_COMMANDS_COMPLETE,0);return S.flush(),await Kx(S,Rt,4),S.bindBuffer(S.PIXEL_PACK_BUFFER,at),S.getBufferSubData(S.PIXEL_PACK_BUFFER,0,be),S.deleteBuffer(at),S.deleteSync(Rt),be}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,B=null,X=0){const $=Math.pow(2,-X),z=Math.floor(M.image.width*$),be=Math.floor(M.image.height*$),Oe=B!==null?B.x:0,ze=B!==null?B.y:0;te.setTexture2D(M,0),S.copyTexSubImage2D(S.TEXTURE_2D,X,0,0,Oe,ze,z,be),se.unbindTexture()};const fs=S.createFramebuffer(),ds=S.createFramebuffer();this.copyTextureToTexture=function(M,B,X=null,$=null,z=0,be=null){be===null&&(z!==0?(Jr("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),be=z,z=0):be=0);let Oe,ze,Be,Ye,Ke,$e,at,vt,Rt;const Mt=M.isCompressedTexture?M.mipmaps[be]:M.image;if(X!==null)Oe=X.max.x-X.min.x,ze=X.max.y-X.min.y,Be=X.isBox3?X.max.z-X.min.z:1,Ye=X.min.x,Ke=X.min.y,$e=X.isBox3?X.min.z:0;else{const En=Math.pow(2,-z);Oe=Math.floor(Mt.width*En),ze=Math.floor(Mt.height*En),M.isDataArrayTexture?Be=Mt.depth:M.isData3DTexture?Be=Math.floor(Mt.depth*En):Be=1,Ye=0,Ke=0,$e=0}$!==null?(at=$.x,vt=$.y,Rt=$.z):(at=0,vt=0,Rt=0);const St=we.convert(B.format),qe=we.convert(B.type);let At;B.isData3DTexture?(te.setTexture3D(B,0),At=S.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(te.setTexture2DArray(B,0),At=S.TEXTURE_2D_ARRAY):(te.setTexture2D(B,0),At=S.TEXTURE_2D),S.pixelStorei(S.UNPACK_FLIP_Y_WEBGL,B.flipY),S.pixelStorei(S.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),S.pixelStorei(S.UNPACK_ALIGNMENT,B.unpackAlignment);const ft=S.getParameter(S.UNPACK_ROW_LENGTH),pn=S.getParameter(S.UNPACK_IMAGE_HEIGHT),Ar=S.getParameter(S.UNPACK_SKIP_PIXELS),mn=S.getParameter(S.UNPACK_SKIP_ROWS),hs=S.getParameter(S.UNPACK_SKIP_IMAGES);S.pixelStorei(S.UNPACK_ROW_LENGTH,Mt.width),S.pixelStorei(S.UNPACK_IMAGE_HEIGHT,Mt.height),S.pixelStorei(S.UNPACK_SKIP_PIXELS,Ye),S.pixelStorei(S.UNPACK_SKIP_ROWS,Ke),S.pixelStorei(S.UNPACK_SKIP_IMAGES,$e);const wt=M.isDataArrayTexture||M.isData3DTexture,yn=B.isDataArrayTexture||B.isData3DTexture;if(M.isDepthTexture){const En=re.get(M),Kt=re.get(B),rn=re.get(En.__renderTarget),$a=re.get(Kt.__renderTarget);se.bindFramebuffer(S.READ_FRAMEBUFFER,rn.__webglFramebuffer),se.bindFramebuffer(S.DRAW_FRAMEBUFFER,$a.__webglFramebuffer);for(let Ki=0;Ki<Be;Ki++)wt&&(S.framebufferTextureLayer(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,re.get(M).__webglTexture,z,$e+Ki),S.framebufferTextureLayer(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,re.get(B).__webglTexture,be,Rt+Ki)),S.blitFramebuffer(Ye,Ke,Oe,ze,at,vt,Oe,ze,S.DEPTH_BUFFER_BIT,S.NEAREST);se.bindFramebuffer(S.READ_FRAMEBUFFER,null),se.bindFramebuffer(S.DRAW_FRAMEBUFFER,null)}else if(z!==0||M.isRenderTargetTexture||re.has(M)){const En=re.get(M),Kt=re.get(B);se.bindFramebuffer(S.READ_FRAMEBUFFER,fs),se.bindFramebuffer(S.DRAW_FRAMEBUFFER,ds);for(let rn=0;rn<Be;rn++)wt?S.framebufferTextureLayer(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,En.__webglTexture,z,$e+rn):S.framebufferTexture2D(S.READ_FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,En.__webglTexture,z),yn?S.framebufferTextureLayer(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,Kt.__webglTexture,be,Rt+rn):S.framebufferTexture2D(S.DRAW_FRAMEBUFFER,S.COLOR_ATTACHMENT0,S.TEXTURE_2D,Kt.__webglTexture,be),z!==0?S.blitFramebuffer(Ye,Ke,Oe,ze,at,vt,Oe,ze,S.COLOR_BUFFER_BIT,S.NEAREST):yn?S.copyTexSubImage3D(At,be,at,vt,Rt+rn,Ye,Ke,Oe,ze):S.copyTexSubImage2D(At,be,at,vt,Ye,Ke,Oe,ze);se.bindFramebuffer(S.READ_FRAMEBUFFER,null),se.bindFramebuffer(S.DRAW_FRAMEBUFFER,null)}else yn?M.isDataTexture||M.isData3DTexture?S.texSubImage3D(At,be,at,vt,Rt,Oe,ze,Be,St,qe,Mt.data):B.isCompressedArrayTexture?S.compressedTexSubImage3D(At,be,at,vt,Rt,Oe,ze,Be,St,Mt.data):S.texSubImage3D(At,be,at,vt,Rt,Oe,ze,Be,St,qe,Mt):M.isDataTexture?S.texSubImage2D(S.TEXTURE_2D,be,at,vt,Oe,ze,St,qe,Mt.data):M.isCompressedTexture?S.compressedTexSubImage2D(S.TEXTURE_2D,be,at,vt,Mt.width,Mt.height,St,Mt.data):S.texSubImage2D(S.TEXTURE_2D,be,at,vt,Oe,ze,St,qe,Mt);S.pixelStorei(S.UNPACK_ROW_LENGTH,ft),S.pixelStorei(S.UNPACK_IMAGE_HEIGHT,pn),S.pixelStorei(S.UNPACK_SKIP_PIXELS,Ar),S.pixelStorei(S.UNPACK_SKIP_ROWS,mn),S.pixelStorei(S.UNPACK_SKIP_IMAGES,hs),be===0&&B.generateMipmaps&&S.generateMipmap(At),se.unbindTexture()},this.copyTextureToTexture3D=function(M,B,X=null,$=null,z=0){return Jr('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,B,X,$,z)},this.initRenderTarget=function(M){re.get(M).__webglFramebuffer===void 0&&te.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?te.setTextureCube(M,0):M.isData3DTexture?te.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?te.setTexture2DArray(M,0):te.setTexture2D(M,0),se.unbindTexture()},this.resetState=function(){C=0,P=0,F=null,se.reset(),Ve.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return di}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=dt._getDrawingBufferColorSpace(e),n.unpackColorSpace=dt._getUnpackColorSpace()}}const m1={key:0,class:"fallback-background"},g1={__name:"FireAshBackground",setup(t){const e=Object.freeze({PARTICLE_COUNT:300,WIND_RADIUS:80,WIND_RADIUS_SQUARED:6400,WIND_STRENGTH:1200,HORIZONTAL_DRIFT:.3,HORIZONTAL_DRIFT_HALF:.15,MIN_UPWARD_SPEED:.25,MAX_UPWARD_SPEED:.6,MIN_SIZE:4,MAX_SIZE:10,VELOCITY_DAMPING:.98,VELOCITY_RESTORATION:.02,MOUSE_VELOCITY_DAMPING:.95,MOUSE_DRAG_FACTOR:.05,WIND_FORCE_FACTOR:.1,MAX_VELOCITY_X:2,MIN_VELOCITY_X:-2,MAX_VELOCITY_Y:3,MIN_VELOCITY_Y:-1,LIFETIME_INCREMENT:8e-4,LIFETIME_INCREMENT_FAST:.004,MAX_PIXEL_RATIO:1.5,WIND_FORCE:120,UPWARD_SPEED_RANGE:.35,SIZE_RANGE:6,AVERAGE_UPWARD_SPEED:.425,AVERAGE_UPWARD_SPEED_RESTORATION:.0085}),n=Nt(null),i=Nt(!0);let r,s,o,a,l;e.PARTICLE_COUNT;let c=e.PARTICLE_COUNT,u=new pt(-1e4,-1e4),f=new pt(0,0),d=new pt(-1e4,-1e4),h,g,_,m,p,T,x,y,L,C,P=!0,F=0,w=!1,E=0,D=0,k=2,H=5,q=0,de=0,J=0,fe=!1,V=3,Te=null,De=0,Fe=3e3,We=3e3,Je=[],ce=null,Ee={left:0,top:0,width:0,height:0};const Pe={width:0,height:0,halfHeight:0};let O={x:0,y:0},ee={position:!1,velocity:!1,lifetime:!1},ge=null,me=null;const Xe=new ArrayBuffer(4),A=new Float32Array(Xe),R=new Uint32Array(Xe),S=()=>{try{const ve=document.createElement("canvas");return!!(ve.getContext("webgl")||ve.getContext("experimental-webgl"))}catch{return!1}},ae=()=>{P=!document.hidden},Q=()=>{Te||(Te=setInterval(()=>{const ve=Date.now()-De;w&&ve>=Fe&&se()},We))},K=()=>{Te&&(clearInterval(Te),Te=null)},se=(ve=null,ue=null)=>{if(!a||Je.length<60)return;const _e=a.geometry.attributes,ye=_e.position.array,le=_e.velocity.array,Re=_e.size.array,Ue=_e.phase.array,Ne=_e.lifetime.array;let we,Ve;ve!==null&&ue!==null?(we=ve-Ee.left-Ee.width*.5,Ve=-(ue-Ee.top-Ee.height*.5)):(we=(Math.random()-.5)*Ee.width*.8,Ve=(Math.random()-.5)*Ee.height*.8);const I=6.283185307179586,Ce=3.75,xe=7.5,Se=e.MIN_SIZE,he=e.SIZE_RANGE,Y=new Float32Array(60*4);for(let Me=0;Me<240;Me++)Y[Me]=Math.random();for(let Me=0;Me<60;Me++){const ke=Je.pop(),rt=ke*3,nt=Me*4,zt=Y[nt]*I,tn=Y[nt]*3,br=Math.cos(zt),Tr=Math.sin(zt);ye[rt]=we+br*tn,ye[rt+1]=Ve+Tr*tn,ye[rt+2]=0;const nn=Me*2,Ei=(Y[nt]-.5)*.5,ji=Math.cos(Ei),Yi=Math.sin(Ei),st=ce[nn]*ji-ce[nn+1]*Yi,ot=ce[nn]*Yi+ce[nn+1]*ji,Yt=Ce+Y[nt+1]*xe;le[rt]=st*Yt,le[rt+1]=ot*Yt,le[rt+2]=0,Re[ke]=Se+Y[nt+2]*he,Ue[ke]=Y[nt+3]*I,Ne[ke]=-3}_e.position.needsUpdate=!0,_e.velocity.needsUpdate=!0,_e.lifetime.needsUpdate=!0,_e.size.needsUpdate=!0,_e.phase.needsUpdate=!0},pe=ve=>{ve.preventDefault(),l&&(cancelAnimationFrame(l),l=null)},re=()=>{W()},te=()=>{const ve=Math.random();return O.x=(ve-.5)*e.HORIZONTAL_DRIFT,O.y=e.MIN_UPWARD_SPEED+ve*e.UPWARD_SPEED_RANGE,O},Ie=ve=>{const ue=.5*ve;A[0]=ve,R[0]=1597463007-(R[0]>>1);let _e=A[0];return _e=_e*(1.5-ue*_e*_e),_e},b=(ve=null)=>{if(!n.value)return;const ue=ve||n.value.getBoundingClientRect();Ee.left=ue.left,Ee.top=ue.top,Ee.width=ue.width,Ee.height=ue.height,Pe.width=ue.width,Pe.height=ue.height,Pe.halfHeight=ue.height*.5},v=()=>{const ue=Math.PI*2/60;ce=new Float32Array(60*2);for(let ye=0;ye<60;ye++){const le=ye*ue;ce[ye*2]=Math.cos(le),ce[ye*2+1]=Math.sin(le)}const _e=e.WIND_RADIUS+1;ge=new Float32Array(_e*2);for(let ye=0;ye<_e;ye++){const le=ye,Re=le<e.WIND_RADIUS?(1-le/e.WIND_RADIUS)*e.WIND_STRENGTH*e.WIND_FORCE_FACTOR:0;ge[ye*2]=le>0?Re/le:0,ge[ye*2+1]=le}me=new Float32Array(150*3);for(let ye=0;ye<150;ye++){const le=-3+ye*.02;let Re=1,Ue=1,Ne=0;le<-2?Re=Ue=.98:le<-.5?(Re=Ue=.97,Ne=-.25):(Re=Ue=.88,Ne=.1),me[ye*3]=Re,me[ye*3+1]=Ue,me[ye*3+2]=Ne}Je=[]},N=(ve,ue)=>{Je.length=0;for(let _e=ue-1;_e>=0;_e--)ve[_e]>1&&Je.push(_e)},W=()=>{if(!n.value)return;if(!S()){i.value=!1,console.warn("WebGL not supported, using fallback background");return}const ve=n.value.getBoundingClientRect();b(ve);const{width:ue,height:_e}=Pe;v(),r=new MS,s=new Np(ue/-2,ue/2,_e/2,_e/-2,.1,1e3),s.position.z=1;try{o=new p1({alpha:!0,antialias:!1,powerPreference:"high-performance",stencil:!1,depth:!1})}catch(Se){console.error("Failed to create WebGL renderer:",Se),i.value=!1;return}o.setSize(ue,_e),o.setPixelRatio(Math.min(window.devicePixelRatio,e.MAX_PIXEL_RATIO)),n.value.appendChild(o.domElement),o.domElement.addEventListener("webglcontextlost",pe,!1),o.domElement.addEventListener("webglcontextrestored",re,!1);const ye=new yi,le=new Float32Array(e.PARTICLE_COUNT*3),Re=new Float32Array(e.PARTICLE_COUNT*3),Ue=new Float32Array(e.PARTICLE_COUNT),Ne=new Float32Array(e.PARTICLE_COUNT),we=new Float32Array(e.PARTICLE_COUNT);for(let Se=0;Se<e.PARTICLE_COUNT;Se++){const he=Se*3;le[he]=(Math.random()-.5)*ue,le[he+1]=(Math.random()-.5)*_e,le[he+2]=0;const Y=te();Re[he]=Y.x,Re[he+1]=Y.y,Re[he+2]=0,Ue[Se]=e.MIN_SIZE+Math.random()*e.SIZE_RANGE,Ne[Se]=Math.random()*Math.PI*2,we[Se]=Math.random()}ye.setAttribute("position",new Ut(le,3)),ye.setAttribute("velocity",new Ut(Re,3)),ye.setAttribute("size",new Ut(Ue,1)),ye.setAttribute("phase",new Ut(Ne,1)),ye.setAttribute("lifetime",new Ut(we,1));const Ve=new xi({uniforms:{time:{value:0},isRainbowMode:{value:0}},vertexShader:`
...
`+s):i.stack=s}catch{}}throw i}}_request(e,n){typeof e=="string"?(n=n||{},n.url=e):n=e||{},n=yr(this.defaults,n);const{transitional:i,paramsSerializer:r,headers:s}=n;i!==void 0&&ta.assertOptions(i,{silentJSONParsing:Wn.transitional(Wn.boolean),forcedJSONParsing:Wn.transitional(Wn.boolean),clarifyTimeoutError:Wn.transitional(Wn.boolean)},!1),r!=null&&(ie.isFunction(r)?n.paramsSerializer={serialize:r}:ta.assertOptions(r,{encode:Wn.function,serialize:Wn.function},!0)),n.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?n.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:n.allowAbsoluteUrls=!0),ta.assertOptions(n,{baseUrl:Wn.spelling("baseURL"),withXsrfToken:Wn.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let o=s&&ie.merge(s.common,s[n.method]);s&&ie.forEach(["delete","get","head","post","put","patch","common"],g=>{delete s[g]}),n.headers=dn.concat(o,s);const a=[];let l=!0;this.interceptors.request.forEach(function(_){typeof _.runWhen=="function"&&_.runWhen(n)===!1||(l=l&&_.synchronous,a.unshift(_.fulfilled,_.rejected))});const c=[];this.interceptors.response.forEach(function(_){c.push(_.fulfilled,_.rejected)});let u,f=0,d;if(!l){const g=[Nd.bind(this),void 0];for(g.unshift.apply(g,a),g.push.apply(g,c),d=g.length,u=Promise.resolve(n);f<d;)u=u.then(g[f++],g[f++]);return u}d=a.length;let h=n;for(f=0;f<d;){const g=a[f++],_=a[f++];try{h=g(h)}catch(m){_.call(this,m);break}}try{u=Nd.call(this,h)}catch(g){return Promise.reject(g)}for(f=0,d=c.length;f<d;)u=u.then(c[f++],c[f++]);return u}getUri(e){e=yr(this.defaults,e);const n=rm(e.baseURL,e.url,e.allowAbsoluteUrls);return Qp(n,e.params,e.paramsSerializer)}};ie.forEach(["delete","get","head","options"],function(e){vr.prototype[e]=function(n,i){return this.request(yr(i||{},{method:e,url:n,data:(i||{}).data}))}});ie.forEach(["post","put","patch"],function(e){function n(i){return function(s,o,a){return this.request(yr(a||{},{method:e,headers:i?{"Content-Type":"multipart/form-data"}:{},url:s,data:o}))}}vr.prototype[e]=n(),vr.prototype[e+"Form"]=n(!0)});let Ew=class um{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(s){n=s});const i=this;this.promise.then(r=>{if(!i._listeners)return;let s=i._listeners.length;for(;s-- >0;)i._listeners[s](r);i._listeners=null}),this.promise.then=r=>{let s;const o=new Promise(a=>{i.subscribe(a),s=a}).then(r);return o.cancel=function(){i.unsubscribe(s)},o},e(function(s,o,a){i.reason||(i.reason=new us(s,o,a),n(i.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const n=this._listeners.indexOf(e);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const e=new AbortController,n=i=>{e.abort(i)};return this.subscribe(n),e.signal.unsubscribe=()=>this.unsubscribe(n),e.signal}static source(){let e;return{token:new um(function(r){e=r}),cancel:e}}};function Mw(t){return function(n){return t.apply(null,n)}}function bw(t){return ie.isObject(t)&&t.isAxiosError===!0}const Zc={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(Zc).forEach(([t,e])=>{Zc[e]=t});function fm(t){const e=new vr(t),n=Hp(vr.prototype.request,e);return ie.extend(n,vr.prototype,e,{allOwnKeys:!0}),ie.extend(n,e,null,{allOwnKeys:!0}),n.create=function(r){return fm(yr(t,r))},n}const Tt=fm(fo);Tt.Axios=vr;Tt.CanceledError=us;Tt.CancelToken=Ew;Tt.isCancel=nm;Tt.VERSION=cm;Tt.toFormData=Ga;Tt.AxiosError=Qe;Tt.Cancel=Tt.CanceledError;Tt.all=function(e){return Promise.all(e)};Tt.spread=Mw;Tt.isAxiosError=bw;Tt.mergeConfig=yr;Tt.AxiosHeaders=dn;Tt.formToJSON=t=>tm(ie.isHTMLForm(t)?new FormData(t):t);Tt.getAdapter=lm.getAdapter;Tt.HttpStatusCode=Zc;Tt.default=Tt;const{Axios:AR,AxiosError:RR,CanceledError:CR,isCancel:PR,CancelToken:DR,VERSION:LR,all:IR,Cancel:UR,isAxiosError:NR,spread:OR,toFormData:FR,AxiosHeaders:BR,HttpStatusCode:kR,formToJSON:zR,getAdapter:HR,mergeConfig:VR}=Tt,Tw={class:"flex justify-center"},ww={class:"px-8 xl:px-0 max-w-[1280px] space-y-48"},Aw={class:"space-y-32"},Rw={key:0,class:"flex flex-col gap-y-12"},Cw=["href"],Pw=["src"],Dw={key:1,class:"flex flex-col gap-y-12"},Lw=["href"],Iw=["src"],Uw={key:2,class:"flex flex-col gap-y-12"},Nw=["href"],Ow=["src"],Fw={key:0,class:"flex flex-col gap-y-12"},Bw={class:"grid sm:grid-cols-3 md:grid-cols-3 gap-x-12 gap-y-12 sm:gap-y-16"},kw={class:"flex flex-col gap-x-3 gap-y-6 items-center"},zw=["src"],Hw={class:"flex flex-col gap-y-2"},Vw={key:0,class:"text-zinc-400 text-sm font-semibold"},Gw={class:"flex gap-x-4 gap-y-4 justify-end pointer-cursor"},Ww=["href"],Xw=["href"],$w=["href"],qw=["href"],jw=["href"],Yw=["href"],Kw=["href"],Zw=["href"],Jw=["href"],Qw=["href"],eA=["href"],tA={key:1,class:"flex flex-col gap-y-12"},nA={class:"grid grid-cols-1 gap-x-12 gap-y-12"},iA={class:"flex flex-col gap-x-3 gap-y-6 items-center"},rA=["src"],sA={class:"flex flex-col gap-y-2"},oA={key:0,class:"text-zinc-400 text-sm font-semibold"},aA={class:"flex gap-x-4 gap-y-4 justify-end pointer-cursor"},lA=["href"],cA=["href"],uA=["href"],fA=["href"],dA=["href"],hA=["href"],pA=["href"],mA=["href"],gA=["href"],_A=["href"],vA=["href"],xA={key:2,class:"flex flex-col gap-y-12"},SA={class:"flex flex-row justify-center items-center space-x-16"},yA=["href"],EA=["src"],MA={__name:"Sponsors",setup(t){const e=Nt([]),n=Nt(null),i=Nt(!1);let r=null;const s=ct(()=>e.value.filter(p=>p.tier==="Platinum"&&p.should_display===!0)),o=ct(()=>e.value.filter(p=>p.tier==="Gold"&&p.should_display===!0)),a=ct(()=>e.value.filter(p=>p.tier==="Silver"&&p.should_display===!0)),l=ct(()=>e.value.filter(p=>p.tier==="dev_growth"&&p.should_display===!0)),c=ct(()=>{const p=e.value.filter(T=>T.tier==="Individual"&&T.should_display===!0);return f(p)}),u=ct(()=>e.value.filter(p=>p.tier==="Lunch"&&p.should_display===!0));zn(()=>{d(),r=new IntersectionObserver(p=>{p.forEach(T=>{i.value=T.isIntersecting,T.isIntersecting?window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!0}})):window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!1}}))})},{threshold:.3}),n.value&&r.observe(n.value)}),Mr(()=>{r&&n.value&&r.unobserve(n.value)});const f=p=>{const T=[...p];for(let x=T.length-1;x>0;x--){const y=Math.floor(Math.random()*(x+1));[T[x],T[y]]=[T[y],T[x]]}return T},d=async()=>{try{const T=await Tt.get("/2025/assets/json/sponsors.json");e.value=T.data}catch(p){console.error(p)}},h=p=>`/2025/assets/sponsors/${p}`,g=p=>{const T=["from-zinc-200 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400"];return T[p%T.length]},_=p=>{if(!i.value)return;const T=p.target;T.tagName==="BUTTON"||T.tagName==="A"||T.closest("button")||T.closest("a")||window.dispatchEvent(new CustomEvent("firework",{detail:{x:p.clientX,y:p.clientY}}))},m=()=>{window.location.href="mailto:letswift.official@gmail.com?subject=Let%27Swift%202025%20%ED%9B%84%EC%9B%90%20%EB%AC%B8%EC%9D%98%20%2F%20Sponsorship%20Inquiry"};return(p,T)=>(j(),ne("div",{ref_key:"sponsorsSection",ref:n,class:"space-y-16 py-36 md:scroll-mt-28",onClick:_},[Ae(co,{title:"행사 후원"}),U("div",Tw,[U("div",ww,[U("div",Aw,[s.value.length!==0?(j(),ne("div",Rw,[T[0]||(T[0]=U("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-slate-100 to-slate-400"},"플래티넘",-1)),(j(!0),ne(ut,null,Ct(s.value,x=>(j(),ne("div",{key:x.id,class:"flex flex-col items-center space-y-4 text-white"},[U("a",{href:x.social.web,target:"_blank",class:"pointer-cursor"},[U("img",{src:h(x.image_name),loading:"lazy",class:"w-full md:h-24 object-contain"},null,8,Pw)],8,Cw)]))),128))])):Ge("",!0),o.value.length!==0?(j(),ne("div",Dw,[T[1]||(T[1]=U("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-amber-100 to-amber-400"},"골드",-1)),(j(!0),ne(ut,null,Ct(o.value,x=>(j(),ne("div",{key:x.id,class:"flex flex-col items-center space-y-4 text-white"},[U("a",{href:x.social.web,target:"_blank",class:"pointer-cursor w-3/4"},[U("img",{src:h(x.image_name),loading:"lazy",class:"w-full h-20 object-contain"},null,8,Iw)],8,Lw)]))),128))])):Ge("",!0),a.value.length!==0?(j(),ne("div",Uw,[T[2]||(T[2]=U("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-zinc-300 to-zinc-600"},"실버",-1)),(j(!0),ne(ut,null,Ct(a.value,x=>(j(),ne("div",{key:x.id,class:"flex flex-col items-center space-y-4 text-white"},[U("a",{href:x.social.web,target:"_blank",class:"pointer-cursor w-2/3"},[U("img",{src:h(x.image_name),loading:"lazy",class:"w-full sm:h-24 object-contain"},null,8,Ow)],8,Nw)]))),128))])):Ge("",!0)]),c.value.length!==0?(j(),ne("div",Fw,[T[3]||(T[3]=U("div",{class:"font-bold text-lg md:text-xl text-rainbow"},"개인 후원",-1)),U("div",Bw,[(j(!0),ne(ut,null,Ct(c.value,(x,y)=>(j(),ne("div",{key:x.id,class:"items-center text-white"},[U("div",kw,[U("div",null,[U("img",{src:h(x.image_name),loading:"lazy",class:"bg-gradient-to-b from-zinc-300/10 to-zinc-300/20 rounded-full w-24 h-24 object-cover"},null,8,zw)]),U("div",Hw,[U("div",{class:Rn(["font-bold text-lg bg-linear-to-br bg-clip-text text-transparent",g(y)])},it(x.name),3),x.description?(j(),ne("div",Vw,it(x.description),1)):Ge("",!0)]),U("div",Gw,[x.social.email?(j(),ne("a",{key:0,href:`mailto:${x.social.email}`,target:"_blank"},[Ae(He(ui),{fill:"gray",width:"16",height:"16"})],8,Ww)):Ge("",!0),x.social.web?(j(),ne("a",{key:1,href:x.social.web,target:"_blank"},[Ae(He(ui),{fill:"gray",width:"16",height:"16"})],8,Xw)):Ge("",!0),x.social.linkedin?(j(),ne("a",{key:2,href:x.social.linkedin,target:"_blank"},[Ae(He(qs),{fill:"gray",width:"16",height:"16"})],8,$w)):Ge("",!0),x.social.instagram?(j(),ne("a",{key:3,href:x.social.instagram,target:"_blank"},[Ae(He($s),{fill:"gray",width:"16",height:"16"})],8,qw)):Ge("",!0),x.social.facebook?(j(),ne("a",{key:4,href:x.social.facebook,target:"_blank"},[Ae(He(fa),{fill:"gray",width:"16",height:"16"})],8,jw)):Ge("",!0),x.social.github?(j(),ne("a",{key:5,href:x.social.github,target:"_blank"},[Ae(He(Xs),{fill:"gray",width:"16",height:"16"})],8,Yw)):Ge("",!0),x.social.youtube?(j(),ne("a",{key:6,href:x.social.youtube,target:"_blank"},[Ae(He(Ys),{fill:"gray",width:"16",height:"16"})],8,Kw)):Ge("",!0),x.social.x?(j(),ne("a",{key:7,href:x.social.x,target:"_blank"},[Ae(He(js),{fill:"gray",width:"16",height:"16"})],8,Zw)):Ge("",!0),x.social.mastodon?(j(),ne("a",{key:8,href:x.social.mastodon,target:"_blank"},[Ae(He(da),{fill:"gray",width:"16",height:"16"})],8,Jw)):Ge("",!0),x.social.medium?(j(),ne("a",{key:9,href:x.social.medium,target:"_blank"},[Ae(He(ha),{fill:"gray",width:"16",height:"16"})],8,Qw)):Ge("",!0),x.social.thread?(j(),ne("a",{key:10,href:x.social.thread,target:"_blank"},[Ae(He(pa),{fill:"gray",width:"16",height:"16"})],8,eA)):Ge("",!0)])])]))),128))])])):Ge("",!0),u.value.length!==0?(j(),ne("div",tA,[T[4]||(T[4]=U("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-orange-300 to-orange-600"},"연사 점심 지원",-1)),U("div",nA,[(j(!0),ne(ut,null,Ct(u.value,(x,y)=>(j(),ne("div",{key:x.id,class:"items-center text-white"},[U("div",iA,[U("div",null,[U("img",{src:h(x.image_name),loading:"lazy",class:"bg-gradient-to-b from-zinc-300/10 to-zinc-300/20 rounded-full w-24 h-24 object-cover"},null,8,rA)]),U("div",sA,[U("div",{class:Rn(["font-bold text-lg bg-linear-to-br bg-clip-text text-transparent",g(y)])},it(x.name),3),x.description?(j(),ne("div",oA,it(x.description),1)):Ge("",!0)]),U("div",aA,[x.social.email?(j(),ne("a",{key:0,href:`mailto:${x.social.email}`,target:"_blank"},[Ae(He(ui),{fill:"gray",width:"16",height:"16"})],8,lA)):Ge("",!0),x.social.web?(j(),ne("a",{key:1,href:x.social.web,target:"_blank"},[Ae(He(ui),{fill:"gray",width:"16",height:"16"})],8,cA)):Ge("",!0),x.social.linkedin?(j(),ne("a",{key:2,href:x.social.linkedin,target:"_blank"},[Ae(He(qs),{fill:"gray",width:"16",height:"16"})],8,uA)):Ge("",!0),x.social.instagram?(j(),ne("a",{key:3,href:x.social.instagram,target:"_blank"},[Ae(He($s),{fill:"gray",width:"16",height:"16"})],8,fA)):Ge("",!0),x.social.facebook?(j(),ne("a",{key:4,href:x.social.facebook,target:"_blank"},[Ae(He(fa),{fill:"gray",width:"16",height:"16"})],8,dA)):Ge("",!0),x.social.github?(j(),ne("a",{key:5,href:x.social.github,target:"_blank"},[Ae(He(Xs),{fill:"gray",width:"16",height:"16"})],8,hA)):Ge("",!0),x.social.youtube?(j(),ne("a",{key:6,href:x.social.youtube,target:"_blank"},[Ae(He(Ys),{fill:"gray",width:"16",height:"16"})],8,pA)):Ge("",!0),x.social.x?(j(),ne("a",{key:7,href:x.social.x,target:"_blank"},[Ae(He(js),{fill:"gray",width:"16",height:"16"})],8,mA)):Ge("",!0),x.social.mastodon?(j(),ne("a",{key:8,href:x.social.mastodon,target:"_blank"},[Ae(He(da),{fill:"gray",width:"16",height:"16"})],8,gA)):Ge("",!0),x.social.medium?(j(),ne("a",{key:9,href:x.social.medium,target:"_blank"},[Ae(He(ha),{fill:"gray",width:"16",height:"16"})],8,_A)):Ge("",!0),x.social.thread?(j(),ne("a",{key:10,href:x.social.thread,target:"_blank"},[Ae(He(pa),{fill:"gray",width:"16",height:"16"})],8,vA)):Ge("",!0)])])]))),128))])])):Ge("",!0),l.value.length!==0?(j(),ne("div",xA,[T[5]||(T[5]=U("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-green-300 to-green-600"},"개발자 성장 지원",-1)),U("div",SA,[(j(!0),ne(ut,null,Ct(l.value,x=>(j(),ne("div",{key:x.id,class:"text-white w-1/3"},[U("a",{href:x.social.web,target:"_blank",class:"pointer-cursor"},[U("img",{src:h(x.image_name),loading:"lazy",class:"w-full sm:h-14 object-contain"},null,8,EA)],8,yA)]))),128))])])):Ge("",!0),U("button",{onClick:m,class:"px-6 py-3 rounded-full cursor-pointer bg-themeMain/40 border border-themeMain/60 text-white text-lg font-bold hover:bg-themeMain/50 hover:border-themeMain/80 transition-all duration-200 active:bg-themeMain/60 select-none","aria-label":"Let'Swift 2025 후원 문의하기"}," 후원 문의 ")])])],512))}},bA={class:"flex justify-center"},TA={class:"px-8 xl:px-0 max-w-[1280px] flex flex-col gap-y-16 md:gap-y-32 w-full"},wA={class:"grid grid-cols-1 lg:grid-cols-1 gap-x-8 md:gap-x-16 gap-y-16 justify-center"},AA=["href"],RA=["src"],CA={class:"grid grid-cols-3 md:grid-cols-3 gap-x-8 md:gap-x-16 gap-y-16 justify-center"},PA=["src"],DA={class:"grid grid-cols-2 lg:grid-cols-2 gap-x-8 md:gap-x-16 gap-y-16 justify-center"},LA=["href"],IA=["src"],UA={__name:"SponsorsMini",setup(t){const e=Nt([]),n=Nt(null),i=Nt(!1);let r=null;const s=ct(()=>e.value.filter(h=>h.tier!=="Individual"&&h.tier!=="Lunch"&&h.tier!=="dev_growth"&&h.should_display===!0)),o=ct(()=>e.value.filter(h=>h.tier==="dev_growth"&&h.should_display===!0)),a=ct(()=>{const h=e.value.filter(g=>(g.tier==="Individual"||g.tier==="Lunch")&&g.should_display===!0);return l(h)});zn(()=>{c(),r=new IntersectionObserver(h=>{h.forEach(g=>{i.value=g.isIntersecting,g.isIntersecting?window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!0}})):window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!1}}))})},{threshold:.3}),n.value&&r.observe(n.value)}),Mr(()=>{r&&n.value&&r.unobserve(n.value)});const l=h=>{const g=[...h];for(let _=g.length-1;_>0;_--){const m=Math.floor(Math.random()*(_+1));[g[_],g[m]]=[g[m],g[_]]}return g},c=async()=>{try{const g=await Tt.get("/2025/assets/json/sponsors.json");e.value=g.data}catch(h){console.error(h)}},u=h=>`/2025/assets/sponsors/${h}`,f=h=>{const g=["from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400"];return g[h%g.length]},d=h=>{if(!i.value)return;const g=h.target;g.tagName==="BUTTON"||g.tagName==="A"||g.closest("button")||g.closest("a")||window.dispatchEvent(new CustomEvent("firework",{detail:{x:h.clientX,y:h.clientY}}))};return(h,g)=>(j(),ne("div",{ref_key:"sponsorsMiniSection",ref:n,class:"space-y-24 py-16",onClick:d},[g[0]||(g[0]=U("h3",{class:"font-medium text-4xl md:text-6xl text-rainbow text-cherishline leading-tight pb-2 pt-4"},"Special Thanks to",-1)),U("div",bA,[U("div",TA,[U("div",wA,[(j(!0),ne(ut,null,Ct(s.value,_=>(j(),ne("div",{key:_.id,class:"flex flex-col items-center text-white"},[U("a",{href:_.social.web,target:"_blank",class:"pointer-cursor"},[U("img",{src:u(_.image_name),loading:"lazy",class:"h-10 lg:h-16 object-contain"},null,8,RA)],8,AA)]))),128))]),U("div",CA,[(j(!0),ne(ut,null,Ct(a.value,(_,m)=>(j(),ne("div",{key:_.id,class:"flex flex-col gap-y-4 items-center text-white"},[U("img",{src:u(_.image_name),loading:"lazy",class:"bg-gradient-to-b from-zinc-300/10 to-zinc-300/20 rounded-full w-16 h-16 object-cover"},null,8,PA),U("span",{class:Rn(["font-black font-mono text-xs md:text-sm bg-linear-to-br bg-clip-text text-transparent",f(m)])},it(_.name),3)]))),128))]),U("div",DA,[(j(!0),ne(ut,null,Ct(o.value,_=>(j(),ne("div",{key:_.id,class:"flex flex-col items-center text-white"},[U("a",{href:_.social.web,target:"_blank",class:"pointer-cursor"},[U("img",{src:u(_.image_name),loading:"lazy",class:"h-8 lg:h-12 object-contain"},null,8,IA)],8,LA)]))),128))])])])],512))}},NA={class:"relative space-y-12 py-0 md:scroll-mt-28"},OA={class:"w-full space-y-8"},FA={class:"flex justify-center"},BA={class:"w-full px-8 xl:px-0 max-w-[1280px] space-y-4"},kA={key:0,class:"bg-white/30 w-full h-[480px] md:h-[720px] rounded-3xl overflow-hidden",style:{filter:"invert(90%) hue-rotate(180deg)"}},zA={__name:"Venue",setup(t){const e=Nt(2),n=()=>{typeof daum<"u"&&daum.roughmap&&daum.roughmap.Lander?new daum.roughmap.Lander({timestamp:"1728435092684",key:"2kudi",mapWidth:"1280",mapHeight:"720"}).render():console.error("Daum map library not loaded properly.")};zn(()=>{n()});const i=()=>{try{const o=r();s(o,"letswift-2025.ics")}catch(o){console.error("Failed to generate calendar file:",o),window.open("https://calendar.google.com/calendar/render?action=TEMPLATE&text=Let%27Swift%202025&dates=20251124T010000Z/20251124T090000Z&details=Let%27Swift%202025%20Conference&location=%EC%84%B8%EC%A2%85%EB%8C%80%ED%95%99%EA%B5%90%20%EA%B4%91%EA%B0%9C%ED%86%A0%EA%B4%80","_blank")}},r=()=>{const o={title:"Let'Swift 2025",description:"Let'Swift 2025 Conference - iOS Swift Developer Conference",location:"세종대학교 컨벤션센터, 서울특별시 광진구",startDate:"20251124T100000",endDate:"20251124T180000",timestamp:new Date().toISOString().replace(/[-:]/g,"").split(".")[0]+"Z"};return`BEGIN:VCALENDAR
VERSION:2.0
PRODID:-//Let'Swift//Let'Swift 2025//EN
CALSCALE:GREGORIAN
METHOD:PUBLISH
