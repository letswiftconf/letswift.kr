...
`)+`
`+p);const w=y+m+o,E=y+p+a,L=ad(r,r.VERTEX_SHADER,w),C=ad(r,r.FRAGMENT_SHADER,E);r.attachShader(v,L),r.attachShader(v,C),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function P(D){if(t.debug.checkShaderErrors){const B=r.getProgramInfoLog(v).trim(),G=r.getShaderInfoLog(L).trim(),Y=r.getShaderInfoLog(C).trim();let he=!0,J=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(he=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,L,C);else{const fe=cd(r,L,"vertex"),q=cd(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
...
Program Info Log: `+B+`
`+fe+`
`+q)}else B!==""?console.warn("THREE.WebGLProgram: Program Info Log:",B):(G===""||Y==="")&&(J=!1);J&&(D.diagnostics={runnable:he,programLog:B,vertexShader:{log:G,prefix:m},fragmentShader:{log:Y,prefix:p}})}r.deleteShader(L),r.deleteShader(C),F=new Ho(r,v),T=Cb(r,v)}let F;this.getUniforms=function(){return F===void 0&&P(this),F};let T;this.getAttributes=function(){return T===void 0&&P(this),T};let S=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return S===!1&&(S=r.getProgramParameter(v,Sb)),S},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(v),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=yb++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=L,this.fragmentShader=C,this}let Hb=0;class Vb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new Gb(e),n.set(e,i)),i}}class Gb{constructor(e){this.id=Hb++,this.code=e,this.usedTimes=0}}function Wb(t,e,n,i,r,s,o){const a=new xp,l=new Vb,c=new Set,u=[],f=r.logarithmicDepthBuffer,d=r.vertexTextures;let h=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(T){return c.add(T),T===0?"uv":`uv${T}`}function m(T,S,D,B,G){const Y=B.fog,he=G.geometry,J=T.isMeshStandardMaterial?B.environment:null,fe=(T.isMeshStandardMaterial?n:e).get(T.envMap||J),q=fe&&fe.mapping===Ta?fe.image.height:null,Me=g[T.type];T.precision!==null&&(h=r.getMaxPrecision(T.precision),h!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",h,"instead."));const Ae=he.morphAttributes.position||he.morphAttributes.normal||he.morphAttributes.color,Re=Ae!==void 0?Ae.length:0;let He=0;he.morphAttributes.position!==void 0&&(He=1),he.morphAttributes.normal!==void 0&&(He=2),he.morphAttributes.color!==void 0&&(He=3);let We,ue,ye,Ne;if(Me){const Ye=qn[Me];We=Ye.vertexShader,ue=Ye.fragmentShader}else We=T.vertexShader,ue=T.fragmentShader,l.update(T),ye=l.getVertexShaderID(T),Ne=l.getFragmentShaderID(T);const O=t.getRenderTarget(),le=t.state.buffers.depth.getReversed(),me=G.isInstancedMesh===!0,pe=G.isBatchedMesh===!0,Ve=!!T.map,A=!!T.matcap,R=!!fe,x=!!T.aoMap,re=!!T.lightMap,Q=!!T.bumpMap,z=!!T.normalMap,j=!!T.displacementMap,se=!!T.emissiveMap,V=!!T.metalnessMap,X=!!T.roughnessMap,be=T.anisotropy>0,M=T.clearcoat>0,_=T.dispersion>0,I=T.iridescence>0,$=T.sheen>0,te=T.transmission>0,W=be&&!!T.anisotropyMap,Pe=M&&!!T.clearcoatMap,ae=M&&!!T.clearcoatNormalMap,ge=M&&!!T.clearcoatRoughnessMap,xe=I&&!!T.iridescenceMap,ie=I&&!!T.iridescenceThicknessMap,Te=$&&!!T.sheenColorMap,Oe=$&&!!T.sheenRoughnessMap,Fe=!!T.specularMap,we=!!T.specularColorMap,qe=!!T.specularIntensityMap,U=te&&!!T.transmissionMap,De=te&&!!T.thicknessMap,_e=!!T.gradientMap,Be=!!T.alphaMap,Se=T.alphaTest>0,de=!!T.alphaHash,ve=!!T.extensions;let Ce=ki;T.toneMapped&&(O===null||O.isXRRenderTarget===!0)&&(Ce=t.toneMapping);const nt={shaderID:Me,shaderType:T.type,shaderName:T.name,vertexShader:We,fragmentShader:ue,defines:T.defines,customVertexShaderID:ye,customFragmentShaderID:Ne,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:h,batching:pe,batchingColor:pe&&G._colorsTexture!==null,instancing:me,instancingColor:me&&G.instanceColor!==null,instancingMorph:me&&G.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:O===null?t.outputColorSpace:O.isXRRenderTarget===!0?O.texture.colorSpace:Qr,alphaToCoverage:!!T.alphaToCoverage,map:Ve,matcap:A,envMap:R,envMapMode:R&&fe.mapping,envMapCubeUVHeight:q,aoMap:x,lightMap:re,bumpMap:Q,normalMap:z,displacementMap:d&&j,emissiveMap:se,normalMapObjectSpace:z&&T.normalMapType===zx,normalMapTangentSpace:z&&T.normalMapType===kx,metalnessMap:V,roughnessMap:X,anisotropy:be,anisotropyMap:W,clearcoat:M,clearcoatMap:Pe,clearcoatNormalMap:ae,clearcoatRoughnessMap:ge,dispersion:_,iridescence:I,iridescenceMap:xe,iridescenceThicknessMap:ie,sheen:$,sheenColorMap:Te,sheenRoughnessMap:Oe,specularMap:Fe,specularColorMap:we,specularIntensityMap:qe,transmission:te,transmissionMap:U,thicknessMap:De,gradientMap:_e,opaque:T.transparent===!1&&T.blending===Xr&&T.alphaToCoverage===!1,alphaMap:Be,alphaTest:Se,alphaHash:de,combine:T.combine,mapUv:Ve&&v(T.map.channel),aoMapUv:x&&v(T.aoMap.channel),lightMapUv:re&&v(T.lightMap.channel),bumpMapUv:Q&&v(T.bumpMap.channel),normalMapUv:z&&v(T.normalMap.channel),displacementMapUv:j&&v(T.displacementMap.channel),emissiveMapUv:se&&v(T.emissiveMap.channel),metalnessMapUv:V&&v(T.metalnessMap.channel),roughnessMapUv:X&&v(T.roughnessMap.channel),anisotropyMapUv:W&&v(T.anisotropyMap.channel),clearcoatMapUv:Pe&&v(T.clearcoatMap.channel),clearcoatNormalMapUv:ae&&v(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ge&&v(T.clearcoatRoughnessMap.channel),iridescenceMapUv:xe&&v(T.iridescenceMap.channel),iridescenceThicknessMapUv:ie&&v(T.iridescenceThicknessMap.channel),sheenColorMapUv:Te&&v(T.sheenColorMap.channel),sheenRoughnessMapUv:Oe&&v(T.sheenRoughnessMap.channel),specularMapUv:Fe&&v(T.specularMap.channel),specularColorMapUv:we&&v(T.specularColorMap.channel),specularIntensityMapUv:qe&&v(T.specularIntensityMap.channel),transmissionMapUv:U&&v(T.transmissionMap.channel),thicknessMapUv:De&&v(T.thicknessMap.channel),alphaMapUv:Be&&v(T.alphaMap.channel),vertexTangents:!!he.attributes.tangent&&(z||be),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!he.attributes.color&&he.attributes.color.itemSize===4,pointsUvs:G.isPoints===!0&&!!he.attributes.uv&&(Ve||Be),fog:!!Y,useFog:T.fog===!0,fogExp2:!!Y&&Y.isFogExp2,flatShading:T.flatShading===!0&&T.wireframe===!1,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:f,reverseDepthBuffer:le,skinning:G.isSkinnedMesh===!0,morphTargets:he.morphAttributes.position!==void 0,morphNormals:he.morphAttributes.normal!==void 0,morphColors:he.morphAttributes.color!==void 0,morphTargetsCount:Re,morphTextureStride:He,numDirLights:S.directional.length,numPointLights:S.point.length,numSpotLights:S.spot.length,numSpotLightMaps:S.spotLightMap.length,numRectAreaLights:S.rectArea.length,numHemiLights:S.hemi.length,numDirLightShadows:S.directionalShadowMap.length,numPointLightShadows:S.pointShadowMap.length,numSpotLightShadows:S.spotShadowMap.length,numSpotLightShadowsWithMaps:S.numSpotLightShadowsWithMaps,numLightProbes:S.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:T.dithering,shadowMapEnabled:t.shadowMap.enabled&&D.length>0,shadowMapType:t.shadowMap.type,toneMapping:Ce,decodeVideoTexture:Ve&&T.map.isVideoTexture===!0&&ct.getTransfer(T.map.colorSpace)===_t,decodeVideoTextureEmissive:se&&T.emissiveMap.isVideoTexture===!0&&ct.getTransfer(T.emissiveMap.colorSpace)===_t,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===fi,flipSided:T.side===sn,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionClipCullDistance:ve&&T.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ve&&T.extensions.multiDraw===!0||pe)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return nt.vertexUv1s=c.has(1),nt.vertexUv2s=c.has(2),nt.vertexUv3s=c.has(3),c.clear(),nt}function p(T){const S=[];if(T.shaderID?S.push(T.shaderID):(S.push(T.customVertexShaderID),S.push(T.customFragmentShaderID)),T.defines!==void 0)for(const D in T.defines)S.push(D),S.push(T.defines[D]);return T.isRawShaderMaterial===!1&&(y(S,T),w(S,T),S.push(t.outputColorSpace)),S.push(T.customProgramCacheKey),S.join()}function y(T,S){T.push(S.precision),T.push(S.outputColorSpace),T.push(S.envMapMode),T.push(S.envMapCubeUVHeight),T.push(S.mapUv),T.push(S.alphaMapUv),T.push(S.lightMapUv),T.push(S.aoMapUv),T.push(S.bumpMapUv),T.push(S.normalMapUv),T.push(S.displacementMapUv),T.push(S.emissiveMapUv),T.push(S.metalnessMapUv),T.push(S.roughnessMapUv),T.push(S.anisotropyMapUv),T.push(S.clearcoatMapUv),T.push(S.clearcoatNormalMapUv),T.push(S.clearcoatRoughnessMapUv),T.push(S.iridescenceMapUv),T.push(S.iridescenceThicknessMapUv),T.push(S.sheenColorMapUv),T.push(S.sheenRoughnessMapUv),T.push(S.specularMapUv),T.push(S.specularColorMapUv),T.push(S.specularIntensityMapUv),T.push(S.transmissionMapUv),T.push(S.thicknessMapUv),T.push(S.combine),T.push(S.fogExp2),T.push(S.sizeAttenuation),T.push(S.morphTargetsCount),T.push(S.morphAttributeCount),T.push(S.numDirLights),T.push(S.numPointLights),T.push(S.numSpotLights),T.push(S.numSpotLightMaps),T.push(S.numHemiLights),T.push(S.numRectAreaLights),T.push(S.numDirLightShadows),T.push(S.numPointLightShadows),T.push(S.numSpotLightShadows),T.push(S.numSpotLightShadowsWithMaps),T.push(S.numLightProbes),T.push(S.shadowMapType),T.push(S.toneMapping),T.push(S.numClippingPlanes),T.push(S.numClipIntersection),T.push(S.depthPacking)}function w(T,S){a.disableAll(),S.supportsVertexTextures&&a.enable(0),S.instancing&&a.enable(1),S.instancingColor&&a.enable(2),S.instancingMorph&&a.enable(3),S.matcap&&a.enable(4),S.envMap&&a.enable(5),S.normalMapObjectSpace&&a.enable(6),S.normalMapTangentSpace&&a.enable(7),S.clearcoat&&a.enable(8),S.iridescence&&a.enable(9),S.alphaTest&&a.enable(10),S.vertexColors&&a.enable(11),S.vertexAlphas&&a.enable(12),S.vertexUv1s&&a.enable(13),S.vertexUv2s&&a.enable(14),S.vertexUv3s&&a.enable(15),S.vertexTangents&&a.enable(16),S.anisotropy&&a.enable(17),S.alphaHash&&a.enable(18),S.batching&&a.enable(19),S.dispersion&&a.enable(20),S.batchingColor&&a.enable(21),S.gradientMap&&a.enable(22),T.push(a.mask),a.disableAll(),S.fog&&a.enable(0),S.useFog&&a.enable(1),S.flatShading&&a.enable(2),S.logarithmicDepthBuffer&&a.enable(3),S.reverseDepthBuffer&&a.enable(4),S.skinning&&a.enable(5),S.morphTargets&&a.enable(6),S.morphNormals&&a.enable(7),S.morphColors&&a.enable(8),S.premultipliedAlpha&&a.enable(9),S.shadowMapEnabled&&a.enable(10),S.doubleSided&&a.enable(11),S.flipSided&&a.enable(12),S.useDepthPacking&&a.enable(13),S.dithering&&a.enable(14),S.transmission&&a.enable(15),S.sheen&&a.enable(16),S.opaque&&a.enable(17),S.pointsUvs&&a.enable(18),S.decodeVideoTexture&&a.enable(19),S.decodeVideoTextureEmissive&&a.enable(20),S.alphaToCoverage&&a.enable(21),T.push(a.mask)}function E(T){const S=g[T.type];let D;if(S){const B=qn[S];D=_S.clone(B.uniforms)}else D=T.uniforms;return D}function L(T,S){let D;for(let B=0,G=u.length;B<G;B++){const Y=u[B];if(Y.cacheKey===S){D=Y,++D.usedTimes;break}}return D===void 0&&(D=new zb(t,S,T,s),u.push(D)),D}function C(T){if(--T.usedTimes===0){const S=u.indexOf(T);u[S]=u[u.length-1],u.pop(),T.destroy()}}function P(T){l.remove(T)}function F(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:E,acquireProgram:L,releaseProgram:C,releaseShaderCache:P,programs:u,dispose:F}}function Xb(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function $b(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function pd(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function md(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(f,d,h,g,v,m){let p=t[e];return p===void 0?(p={id:f.id,object:f,geometry:d,material:h,groupOrder:g,renderOrder:f.renderOrder,z:v,group:m},t[e]=p):(p.id=f.id,p.object=f,p.geometry=d,p.material=h,p.groupOrder=g,p.renderOrder=f.renderOrder,p.z=v,p.group=m),e++,p}function a(f,d,h,g,v,m){const p=o(f,d,h,g,v,m);h.transmission>0?i.push(p):h.transparent===!0?r.push(p):n.push(p)}function l(f,d,h,g,v,m){const p=o(f,d,h,g,v,m);h.transmission>0?i.unshift(p):h.transparent===!0?r.unshift(p):n.unshift(p)}function c(f,d){n.length>1&&n.sort(f||$b),i.length>1&&i.sort(d||pd),r.length>1&&r.sort(d||pd)}function u(){for(let f=e,d=t.length;f<d;f++){const h=t[f];if(h.id===null)break;h.id=null,h.object=null,h.geometry=null,h.material=null,h.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:a,unshift:l,finish:u,sort:c}}function qb(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new md,t.set(i,[o])):r>=s.length?(o=new md,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function jb(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new Z,color:new mt};break;case"SpotLight":n={position:new Z,direction:new Z,color:new mt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new Z,color:new mt,distance:0,decay:0};break;case"HemisphereLight":n={direction:new Z,skyColor:new mt,groundColor:new mt};break;case"RectAreaLight":n={color:new mt,position:new Z,halfWidth:new Z,halfHeight:new Z};break}return t[e.id]=n,n}}}function Yb(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new dt};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new dt};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new dt,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let Kb=0;function Zb(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function Jb(t){const e=new jb,n=Yb(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new Z);const r=new Z,s=new Pt,o=new Pt;function a(c){let u=0,f=0,d=0;for(let T=0;T<9;T++)i.probe[T].set(0,0,0);let h=0,g=0,v=0,m=0,p=0,y=0,w=0,E=0,L=0,C=0,P=0;c.sort(Zb);for(let T=0,S=c.length;T<S;T++){const D=c[T],B=D.color,G=D.intensity,Y=D.distance,he=D.shadow&&D.shadow.map?D.shadow.map.texture:null;if(D.isAmbientLight)u+=B.r*G,f+=B.g*G,d+=B.b*G;else if(D.isLightProbe){for(let J=0;J<9;J++)i.probe[J].addScaledVector(D.sh.coefficients[J],G);P++}else if(D.isDirectionalLight){const J=e.get(D);if(J.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){const fe=D.shadow,q=n.get(D);q.shadowIntensity=fe.intensity,q.shadowBias=fe.bias,q.shadowNormalBias=fe.normalBias,q.shadowRadius=fe.radius,q.shadowMapSize=fe.mapSize,i.directionalShadow[h]=q,i.directionalShadowMap[h]=he,i.directionalShadowMatrix[h]=D.shadow.matrix,y++}i.directional[h]=J,h++}else if(D.isSpotLight){const J=e.get(D);J.position.setFromMatrixPosition(D.matrixWorld),J.color.copy(B).multiplyScalar(G),J.distance=Y,J.coneCos=Math.cos(D.angle),J.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),J.decay=D.decay,i.spot[v]=J;const fe=D.shadow;if(D.map&&(i.spotLightMap[L]=D.map,L++,fe.updateMatrices(D),D.castShadow&&C++),i.spotLightMatrix[v]=fe.matrix,D.castShadow){const q=n.get(D);q.shadowIntensity=fe.intensity,q.shadowBias=fe.bias,q.shadowNormalBias=fe.normalBias,q.shadowRadius=fe.radius,q.shadowMapSize=fe.mapSize,i.spotShadow[v]=q,i.spotShadowMap[v]=he,E++}v++}else if(D.isRectAreaLight){const J=e.get(D);J.color.copy(B).multiplyScalar(G),J.halfWidth.set(D.width*.5,0,0),J.halfHeight.set(0,D.height*.5,0),i.rectArea[m]=J,m++}else if(D.isPointLight){const J=e.get(D);if(J.color.copy(D.color).multiplyScalar(D.intensity),J.distance=D.distance,J.decay=D.decay,D.castShadow){const fe=D.shadow,q=n.get(D);q.shadowIntensity=fe.intensity,q.shadowBias=fe.bias,q.shadowNormalBias=fe.normalBias,q.shadowRadius=fe.radius,q.shadowMapSize=fe.mapSize,q.shadowCameraNear=fe.camera.near,q.shadowCameraFar=fe.camera.far,i.pointShadow[g]=q,i.pointShadowMap[g]=he,i.pointShadowMatrix[g]=D.shadow.matrix,w++}i.point[g]=J,g++}else if(D.isHemisphereLight){const J=e.get(D);J.skyColor.copy(D.color).multiplyScalar(G),J.groundColor.copy(D.groundColor).multiplyScalar(G),i.hemi[p]=J,p++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Le.LTC_FLOAT_1,i.rectAreaLTC2=Le.LTC_FLOAT_2):(i.rectAreaLTC1=Le.LTC_HALF_1,i.rectAreaLTC2=Le.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=f,i.ambient[2]=d;const F=i.hash;(F.directionalLength!==h||F.pointLength!==g||F.spotLength!==v||F.rectAreaLength!==m||F.hemiLength!==p||F.numDirectionalShadows!==y||F.numPointShadows!==w||F.numSpotShadows!==E||F.numSpotMaps!==L||F.numLightProbes!==P)&&(i.directional.length=h,i.spot.length=v,i.rectArea.length=m,i.point.length=g,i.hemi.length=p,i.directionalShadow.length=y,i.directionalShadowMap.length=y,i.pointShadow.length=w,i.pointShadowMap.length=w,i.spotShadow.length=E,i.spotShadowMap.length=E,i.directionalShadowMatrix.length=y,i.pointShadowMatrix.length=w,i.spotLightMatrix.length=E+L-C,i.spotLightMap.length=L,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=P,F.directionalLength=h,F.pointLength=g,F.spotLength=v,F.rectAreaLength=m,F.hemiLength=p,F.numDirectionalShadows=y,F.numPointShadows=w,F.numSpotShadows=E,F.numSpotMaps=L,F.numLightProbes=P,i.version=Kb++)}function l(c,u){let f=0,d=0,h=0,g=0,v=0;const m=u.matrixWorldInverse;for(let p=0,y=c.length;p<y;p++){const w=c[p];if(w.isDirectionalLight){const E=i.directional[f];E.direction.setFromMatrixPosition(w.matrixWorld),r.setFromMatrixPosition(w.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(m),f++}else if(w.isSpotLight){const E=i.spot[h];E.position.setFromMatrixPosition(w.matrixWorld),E.position.applyMatrix4(m),E.direction.setFromMatrixPosition(w.matrixWorld),r.setFromMatrixPosition(w.target.matrixWorld),E.direction.sub(r),E.direction.transformDirection(m),h++}else if(w.isRectAreaLight){const E=i.rectArea[g];E.position.setFromMatrixPosition(w.matrixWorld),E.position.applyMatrix4(m),o.identity(),s.copy(w.matrixWorld),s.premultiply(m),o.extractRotation(s),E.halfWidth.set(w.width*.5,0,0),E.halfHeight.set(0,w.height*.5,0),E.halfWidth.applyMatrix4(o),E.halfHeight.applyMatrix4(o),g++}else if(w.isPointLight){const E=i.point[d];E.position.setFromMatrixPosition(w.matrixWorld),E.position.applyMatrix4(m),d++}else if(w.isHemisphereLight){const E=i.hemi[v];E.direction.setFromMatrixPosition(w.matrixWorld),E.direction.transformDirection(m),v++}}}return{setup:a,setupView:l,state:i}}function gd(t){const e=new Jb(t),n=[],i=[];function r(u){c.camera=u,n.length=0,i.length=0}function s(u){n.push(u)}function o(u){i.push(u)}function a(){e.setup(n)}function l(u){e.setupView(n,u)}const c={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function Qb(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new gd(t),e.set(r,[a])):s>=o.length?(a=new gd(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const e1=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function n1(t,e,n){let i=new Ap;const r=new dt,s=new dt,o=new Ct,a=new CS({depthPacking:Bx}),l=new PS,c={},u=n.maxTextureSize,f={[Vi]:sn,[sn]:Vi,[fi]:fi},d=new Si({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new dt},radius:{value:4}},vertexShader:e1,fragmentShader:t1}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const g=new Ei;g.setAttribute("position",new It(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new pi(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=rp;let p=this.type;this.render=function(C,P,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const T=t.getRenderTarget(),S=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),B=t.state;B.setBlending(Bi),B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const G=p!==ai&&this.type===ai,Y=p===ai&&this.type!==ai;for(let he=0,J=C.length;he<J;he++){const fe=C[he],q=fe.shadow;if(q===void 0){console.warn("THREE.WebGLShadowMap:",fe,"has no shadow.");continue}if(q.autoUpdate===!1&&q.needsUpdate===!1)continue;r.copy(q.mapSize);const Me=q.getFrameExtents();if(r.multiply(Me),s.copy(q.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Me.x),r.x=s.x*Me.x,q.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Me.y),r.y=s.y*Me.y,q.mapSize.y=s.y)),q.map===null||G===!0||Y===!0){const Re=this.type!==ai?{minFilter:Nn,magFilter:Nn}:{};q.map!==null&&q.map.dispose(),q.map=new _r(r.x,r.y,Re),q.map.texture.name=fe.name+".shadowMap",q.camera.updateProjectionMatrix()}t.setRenderTarget(q.map),t.clear();const Ae=q.getViewportCount();for(let Re=0;Re<Ae;Re++){const He=q.getViewport(Re);o.set(s.x*He.x,s.y*He.y,s.x*He.z,s.y*He.w),B.viewport(o),q.updateMatrices(fe,Re),i=q.getFrustum(),E(P,F,q.camera,fe,this.type)}q.isPointLightShadow!==!0&&this.type===ai&&y(q,F),q.needsUpdate=!1}p=this.type,m.needsUpdate=!1,t.setRenderTarget(T,S,D)};function y(C,P){const F=e.update(v);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,h.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new _r(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(P,null,F,d,v,null),h.uniforms.shadow_pass.value=C.mapPass.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(P,null,F,h,v,null)}function w(C,P,F,T){let S=null;const D=F.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(D!==void 0)S=D;else if(S=F.isPointLight===!0?l:a,t.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const B=S.uuid,G=P.uuid;let Y=c[B];Y===void 0&&(Y={},c[B]=Y);let he=Y[G];he===void 0&&(he=S.clone(),Y[G]=he,P.addEventListener("dispose",L)),S=he}if(S.visible=P.visible,S.wireframe=P.wireframe,T===ai?S.side=P.shadowSide!==null?P.shadowSide:P.side:S.side=P.shadowSide!==null?P.shadowSide:f[P.side],S.alphaMap=P.alphaMap,S.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,S.map=P.map,S.clipShadows=P.clipShadows,S.clippingPlanes=P.clippingPlanes,S.clipIntersection=P.clipIntersection,S.displacementMap=P.displacementMap,S.displacementScale=P.displacementScale,S.displacementBias=P.displacementBias,S.wireframeLinewidth=P.wireframeLinewidth,S.linewidth=P.linewidth,F.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const B=t.properties.get(S);B.light=F}return S}function E(C,P,F,T,S){if(C.visible===!1)return;if(C.layers.test(P.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&S===ai)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,C.matrixWorld);const G=e.update(C),Y=C.material;if(Array.isArray(Y)){const he=G.groups;for(let J=0,fe=he.length;J<fe;J++){const q=he[J],Me=Y[q.materialIndex];if(Me&&Me.visible){const Ae=w(C,Me,T,S);C.onBeforeShadow(t,C,P,F,G,Ae,q),t.renderBufferDirect(F,null,G,Ae,C,q),C.onAfterShadow(t,C,P,F,G,Ae,q)}}}else if(Y.visible){const he=w(C,Y,T,S);C.onBeforeShadow(t,C,P,F,G,he,null),t.renderBufferDirect(F,null,G,he,C,null),C.onAfterShadow(t,C,P,F,G,he,null)}}const B=C.children;for(let G=0,Y=B.length;G<Y;G++)E(B[G],P,F,T,S)}function L(C){C.target.removeEventListener("dispose",L);for(const F in c){const T=c[F],S=C.target.uuid;S in T&&(T[S].dispose(),delete T[S])}}}const i1={[Yl]:Kl,[Zl]:ec,[Jl]:tc,[Kr]:Ql,[Kl]:Yl,[ec]:Zl,[tc]:Jl,[Ql]:Kr};function r1(t,e){function n(){let U=!1;const De=new Ct;let _e=null;const Be=new Ct(0,0,0,0);return{setMask:function(Se){_e!==Se&&!U&&(t.colorMask(Se,Se,Se,Se),_e=Se)},setLocked:function(Se){U=Se},setClear:function(Se,de,ve,Ce,nt){nt===!0&&(Se*=Ce,de*=Ce,ve*=Ce),De.set(Se,de,ve,Ce),Be.equals(De)===!1&&(t.clearColor(Se,de,ve,Ce),Be.copy(De))},reset:function(){U=!1,_e=null,Be.set(-1,0,0,0)}}}function i(){let U=!1,De=!1,_e=null,Be=null,Se=null;return{setReversed:function(de){if(De!==de){const ve=e.get("EXT_clip_control");de?ve.clipControlEXT(ve.LOWER_LEFT_EXT,ve.ZERO_TO_ONE_EXT):ve.clipControlEXT(ve.LOWER_LEFT_EXT,ve.NEGATIVE_ONE_TO_ONE_EXT),De=de;const Ce=Se;Se=null,this.setClear(Ce)}},getReversed:function(){return De},setTest:function(de){de?O(t.DEPTH_TEST):le(t.DEPTH_TEST)},setMask:function(de){_e!==de&&!U&&(t.depthMask(de),_e=de)},setFunc:function(de){if(De&&(de=i1[de]),Be!==de){switch(de){case Yl:t.depthFunc(t.NEVER);break;case Kl:t.depthFunc(t.ALWAYS);break;case Zl:t.depthFunc(t.LESS);break;case Kr:t.depthFunc(t.LEQUAL);break;case Jl:t.depthFunc(t.EQUAL);break;case Ql:t.depthFunc(t.GEQUAL);break;case ec:t.depthFunc(t.GREATER);break;case tc:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}Be=de}},setLocked:function(de){U=de},setClear:function(de){Se!==de&&(De&&(de=1-de),t.clearDepth(de),Se=de)},reset:function(){U=!1,_e=null,Be=null,Se=null,De=!1}}}function r(){let U=!1,De=null,_e=null,Be=null,Se=null,de=null,ve=null,Ce=null,nt=null;return{setTest:function(Ye){U||(Ye?O(t.STENCIL_TEST):le(t.STENCIL_TEST))},setMask:function(Ye){De!==Ye&&!U&&(t.stencilMask(Ye),De=Ye)},setFunc:function(Ye,Dt,Nt){(_e!==Ye||Be!==Dt||Se!==Nt)&&(t.stencilFunc(Ye,Dt,Nt),_e=Ye,Be=Dt,Se=Nt)},setOp:function(Ye,Dt,Nt){(de!==Ye||ve!==Dt||Ce!==Nt)&&(t.stencilOp(Ye,Dt,Nt),de=Ye,ve=Dt,Ce=Nt)},setLocked:function(Ye){U=Ye},setClear:function(Ye){nt!==Ye&&(t.clearStencil(Ye),nt=Ye)},reset:function(){U=!1,De=null,_e=null,Be=null,Se=null,de=null,ve=null,Ce=null,nt=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},f={},d=new WeakMap,h=[],g=null,v=!1,m=null,p=null,y=null,w=null,E=null,L=null,C=null,P=new mt(0,0,0),F=0,T=!1,S=null,D=null,B=null,G=null,Y=null;const he=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let J=!1,fe=0;const q=t.getParameter(t.VERSION);q.indexOf("WebGL")!==-1?(fe=parseFloat(/^WebGL (\d)/.exec(q)[1]),J=fe>=1):q.indexOf("OpenGL ES")!==-1&&(fe=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),J=fe>=2);let Me=null,Ae={};const Re=t.getParameter(t.SCISSOR_BOX),He=t.getParameter(t.VIEWPORT),We=new Ct().fromArray(Re),ue=new Ct().fromArray(He);function ye(U,De,_e,Be){const Se=new Uint8Array(4),de=t.createTexture();t.bindTexture(U,de),t.texParameteri(U,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(U,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let ve=0;ve<_e;ve++)U===t.TEXTURE_3D||U===t.TEXTURE_2D_ARRAY?t.texImage3D(De,0,t.RGBA,1,1,Be,0,t.RGBA,t.UNSIGNED_BYTE,Se):t.texImage2D(De+ve,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,Se);return de}const Ne={};Ne[t.TEXTURE_2D]=ye(t.TEXTURE_2D,t.TEXTURE_2D,1),Ne[t.TEXTURE_CUBE_MAP]=ye(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),Ne[t.TEXTURE_2D_ARRAY]=ye(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),Ne[t.TEXTURE_3D]=ye(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),O(t.DEPTH_TEST),o.setFunc(Kr),Q(!1),z(yf),O(t.CULL_FACE),x(Bi);function O(U){u[U]!==!0&&(t.enable(U),u[U]=!0)}function le(U){u[U]!==!1&&(t.disable(U),u[U]=!1)}function me(U,De){return f[U]!==De?(t.bindFramebuffer(U,De),f[U]=De,U===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=De),U===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=De),!0):!1}function pe(U,De){let _e=h,Be=!1;if(U){_e=d.get(De),_e===void 0&&(_e=[],d.set(De,_e));const Se=U.textures;if(_e.length!==Se.length||_e[0]!==t.COLOR_ATTACHMENT0){for(let de=0,ve=Se.length;de<ve;de++)_e[de]=t.COLOR_ATTACHMENT0+de;_e.length=Se.length,Be=!0}}else _e[0]!==t.BACK&&(_e[0]=t.BACK,Be=!0);Be&&t.drawBuffers(_e)}function Ve(U){return g!==U?(t.useProgram(U),g=U,!0):!1}const A={[ar]:t.FUNC_ADD,[ux]:t.FUNC_SUBTRACT,[fx]:t.FUNC_REVERSE_SUBTRACT};A[dx]=t.MIN,A[hx]=t.MAX;const R={[px]:t.ZERO,[mx]:t.ONE,[gx]:t.SRC_COLOR,[ql]:t.SRC_ALPHA,[Ex]:t.SRC_ALPHA_SATURATE,[Sx]:t.DST_COLOR,[vx]:t.DST_ALPHA,[_x]:t.ONE_MINUS_SRC_COLOR,[jl]:t.ONE_MINUS_SRC_ALPHA,[yx]:t.ONE_MINUS_DST_COLOR,[xx]:t.ONE_MINUS_DST_ALPHA,[Mx]:t.CONSTANT_COLOR,[bx]:t.ONE_MINUS_CONSTANT_COLOR,[Tx]:t.CONSTANT_ALPHA,[wx]:t.ONE_MINUS_CONSTANT_ALPHA};function x(U,De,_e,Be,Se,de,ve,Ce,nt,Ye){if(U===Bi){v===!0&&(le(t.BLEND),v=!1);return}if(v===!1&&(O(t.BLEND),v=!0),U!==cx){if(U!==m||Ye!==T){if((p!==ar||E!==ar)&&(t.blendEquation(t.FUNC_ADD),p=ar,E=ar),Ye)switch(U){case Xr:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case $l:t.blendFunc(t.ONE,t.ONE);break;case Ef:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Mf:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Xr:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case $l:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Ef:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Mf:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}y=null,w=null,L=null,C=null,P.set(0,0,0),F=0,m=U,T=Ye}return}Se=Se||De,de=de||_e,ve=ve||Be,(De!==p||Se!==E)&&(t.blendEquationSeparate(A[De],A[Se]),p=De,E=Se),(_e!==y||Be!==w||de!==L||ve!==C)&&(t.blendFuncSeparate(R[_e],R[Be],R[de],R[ve]),y=_e,w=Be,L=de,C=ve),(Ce.equals(P)===!1||nt!==F)&&(t.blendColor(Ce.r,Ce.g,Ce.b,nt),P.copy(Ce),F=nt),m=U,T=!1}function re(U,De){U.side===fi?le(t.CULL_FACE):O(t.CULL_FACE);let _e=U.side===sn;De&&(_e=!_e),Q(_e),U.blending===Xr&&U.transparent===!1?x(Bi):x(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const Be=U.stencilWrite;a.setTest(Be),Be&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),se(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?O(t.SAMPLE_ALPHA_TO_COVERAGE):le(t.SAMPLE_ALPHA_TO_COVERAGE)}function Q(U){S!==U&&(U?t.frontFace(t.CW):t.frontFace(t.CCW),S=U)}function z(U){U!==ox?(O(t.CULL_FACE),U!==D&&(U===yf?t.cullFace(t.BACK):U===ax?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):le(t.CULL_FACE),D=U}function j(U){U!==B&&(J&&t.lineWidth(U),B=U)}function se(U,De,_e){U?(O(t.POLYGON_OFFSET_FILL),(G!==De||Y!==_e)&&(t.polygonOffset(De,_e),G=De,Y=_e)):le(t.POLYGON_OFFSET_FILL)}function V(U){U?O(t.SCISSOR_TEST):le(t.SCISSOR_TEST)}function X(U){U===void 0&&(U=t.TEXTURE0+he-1),Me!==U&&(t.activeTexture(U),Me=U)}function be(U,De,_e){_e===void 0&&(Me===null?_e=t.TEXTURE0+he-1:_e=Me);let Be=Ae[_e];Be===void 0&&(Be={type:void 0,texture:void 0},Ae[_e]=Be),(Be.type!==U||Be.texture!==De)&&(Me!==_e&&(t.activeTexture(_e),Me=_e),t.bindTexture(U,De||Ne[U]),Be.type=U,Be.texture=De)}function M(){const U=Ae[Me];U!==void 0&&U.type!==void 0&&(t.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function _(){try{t.compressedTexImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function I(){try{t.compressedTexImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function $(){try{t.texSubImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function te(){try{t.texSubImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function W(){try{t.compressedTexSubImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Pe(){try{t.compressedTexSubImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ae(){try{t.texStorage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ge(){try{t.texStorage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function xe(){try{t.texImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ie(){try{t.texImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Te(U){We.equals(U)===!1&&(t.scissor(U.x,U.y,U.z,U.w),We.copy(U))}function Oe(U){ue.equals(U)===!1&&(t.viewport(U.x,U.y,U.z,U.w),ue.copy(U))}function Fe(U,De){let _e=c.get(De);_e===void 0&&(_e=new WeakMap,c.set(De,_e));let Be=_e.get(U);Be===void 0&&(Be=t.getUniformBlockIndex(De,U.name),_e.set(U,Be))}function we(U,De){const Be=c.get(De).get(U);l.get(De)!==Be&&(t.uniformBlockBinding(De,Be,U.__bindingPointIndex),l.set(De,Be))}function qe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),u={},Me=null,Ae={},f={},d=new WeakMap,h=[],g=null,v=!1,m=null,p=null,y=null,w=null,E=null,L=null,C=null,P=new mt(0,0,0),F=0,T=!1,S=null,D=null,B=null,G=null,Y=null,We.set(0,0,t.canvas.width,t.canvas.height),ue.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:O,disable:le,bindFramebuffer:me,drawBuffers:pe,useProgram:Ve,setBlending:x,setMaterial:re,setFlipSided:Q,setCullFace:z,setLineWidth:j,setPolygonOffset:se,setScissorTest:V,activeTexture:X,bindTexture:be,unbindTexture:M,compressedTexImage2D:_,compressedTexImage3D:I,texImage2D:xe,texImage3D:ie,updateUBOMapping:Fe,uniformBlockBinding:we,texStorage2D:ae,texStorage3D:ge,texSubImage2D:$,texSubImage3D:te,compressedTexSubImage2D:W,compressedTexSubImage3D:Pe,scissor:Te,viewport:Oe,reset:qe}}function s1(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new dt,u=new WeakMap;let f;const d=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(M,_){return h?new OffscreenCanvas(M,_):na("canvas")}function v(M,_,I){let $=1;const te=be(M);if((te.width>I||te.height>I)&&($=I/Math.max(te.width,te.height)),$<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const W=Math.floor($*te.width),Pe=Math.floor($*te.height);f===void 0&&(f=g(W,Pe));const ae=_?g(W,Pe):f;return ae.width=W,ae.height=Pe,ae.getContext("2d").drawImage(M,0,0,W,Pe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+W+"x"+Pe+")."),ae}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),M;return M}function m(M){return M.generateMipmaps}function p(M){t.generateMipmap(M)}function y(M){return M.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?t.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function w(M,_,I,$,te=!1){if(M!==null){if(t[M]!==void 0)return t[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let W=_;if(_===t.RED&&(I===t.FLOAT&&(W=t.R32F),I===t.HALF_FLOAT&&(W=t.R16F),I===t.UNSIGNED_BYTE&&(W=t.R8)),_===t.RED_INTEGER&&(I===t.UNSIGNED_BYTE&&(W=t.R8UI),I===t.UNSIGNED_SHORT&&(W=t.R16UI),I===t.UNSIGNED_INT&&(W=t.R32UI),I===t.BYTE&&(W=t.R8I),I===t.SHORT&&(W=t.R16I),I===t.INT&&(W=t.R32I)),_===t.RG&&(I===t.FLOAT&&(W=t.RG32F),I===t.HALF_FLOAT&&(W=t.RG16F),I===t.UNSIGNED_BYTE&&(W=t.RG8)),_===t.RG_INTEGER&&(I===t.UNSIGNED_BYTE&&(W=t.RG8UI),I===t.UNSIGNED_SHORT&&(W=t.RG16UI),I===t.UNSIGNED_INT&&(W=t.RG32UI),I===t.BYTE&&(W=t.RG8I),I===t.SHORT&&(W=t.RG16I),I===t.INT&&(W=t.RG32I)),_===t.RGB_INTEGER&&(I===t.UNSIGNED_BYTE&&(W=t.RGB8UI),I===t.UNSIGNED_SHORT&&(W=t.RGB16UI),I===t.UNSIGNED_INT&&(W=t.RGB32UI),I===t.BYTE&&(W=t.RGB8I),I===t.SHORT&&(W=t.RGB16I),I===t.INT&&(W=t.RGB32I)),_===t.RGBA_INTEGER&&(I===t.UNSIGNED_BYTE&&(W=t.RGBA8UI),I===t.UNSIGNED_SHORT&&(W=t.RGBA16UI),I===t.UNSIGNED_INT&&(W=t.RGBA32UI),I===t.BYTE&&(W=t.RGBA8I),I===t.SHORT&&(W=t.RGBA16I),I===t.INT&&(W=t.RGBA32I)),_===t.RGB&&I===t.UNSIGNED_INT_5_9_9_9_REV&&(W=t.RGB9_E5),_===t.RGBA){const Pe=te?ea:ct.getTransfer($);I===t.FLOAT&&(W=t.RGBA32F),I===t.HALF_FLOAT&&(W=t.RGBA16F),I===t.UNSIGNED_BYTE&&(W=Pe===_t?t.SRGB8_ALPHA8:t.RGBA8),I===t.UNSIGNED_SHORT_4_4_4_4&&(W=t.RGBA4),I===t.UNSIGNED_SHORT_5_5_5_1&&(W=t.RGB5_A1)}return(W===t.R16F||W===t.R32F||W===t.RG16F||W===t.RG32F||W===t.RGBA16F||W===t.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function E(M,_){let I;return M?_===null||_===gr||_===ks?I=t.DEPTH24_STENCIL8:_===di?I=t.DEPTH32F_STENCIL8:_===Bs&&(I=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===gr||_===ks?I=t.DEPTH_COMPONENT24:_===di?I=t.DEPTH_COMPONENT32F:_===Bs&&(I=t.DEPTH_COMPONENT16),I}function L(M,_){return m(M)===!0||M.isFramebufferTexture&&M.minFilter!==Nn&&M.minFilter!==jn?Math.log2(Math.max(_.width,_.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?_.mipmaps.length:1}function C(M){const _=M.target;_.removeEventListener("dispose",C),F(_),_.isVideoTexture&&u.delete(_)}function P(M){const _=M.target;_.removeEventListener("dispose",P),S(_)}function F(M){const _=i.get(M);if(_.__webglInit===void 0)return;const I=M.source,$=d.get(I);if($){const te=$[_.__cacheKey];te.usedTimes--,te.usedTimes===0&&T(M),Object.keys($).length===0&&d.delete(I)}i.remove(M)}function T(M){const _=i.get(M);t.deleteTexture(_.__webglTexture);const I=M.source,$=d.get(I);delete $[_.__cacheKey],o.memory.textures--}function S(M){const _=i.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),i.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(_.__webglFramebuffer[$]))for(let te=0;te<_.__webglFramebuffer[$].length;te++)t.deleteFramebuffer(_.__webglFramebuffer[$][te]);else t.deleteFramebuffer(_.__webglFramebuffer[$]);_.__webglDepthbuffer&&t.deleteRenderbuffer(_.__webglDepthbuffer[$])}else{if(Array.isArray(_.__webglFramebuffer))for(let $=0;$<_.__webglFramebuffer.length;$++)t.deleteFramebuffer(_.__webglFramebuffer[$]);else t.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&t.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&t.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let $=0;$<_.__webglColorRenderbuffer.length;$++)_.__webglColorRenderbuffer[$]&&t.deleteRenderbuffer(_.__webglColorRenderbuffer[$]);_.__webglDepthRenderbuffer&&t.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const I=M.textures;for(let $=0,te=I.length;$<te;$++){const W=i.get(I[$]);W.__webglTexture&&(t.deleteTexture(W.__webglTexture),o.memory.textures--),i.remove(I[$])}i.remove(M)}let D=0;function B(){D=0}function G(){const M=D;return M>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),D+=1,M}function Y(M){const _=[];return _.push(M.wrapS),_.push(M.wrapT),_.push(M.wrapR||0),_.push(M.magFilter),_.push(M.minFilter),_.push(M.anisotropy),_.push(M.internalFormat),_.push(M.format),_.push(M.type),_.push(M.generateMipmaps),_.push(M.premultiplyAlpha),_.push(M.flipY),_.push(M.unpackAlignment),_.push(M.colorSpace),_.join()}function he(M,_){const I=i.get(M);if(M.isVideoTexture&&V(M),M.isRenderTargetTexture===!1&&M.version>0&&I.__version!==M.version){const $=M.image;if($===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if($.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ne(I,M,_);return}}n.bindTexture(t.TEXTURE_2D,I.__webglTexture,t.TEXTURE0+_)}function J(M,_){const I=i.get(M);if(M.version>0&&I.__version!==M.version){Ne(I,M,_);return}n.bindTexture(t.TEXTURE_2D_ARRAY,I.__webglTexture,t.TEXTURE0+_)}function fe(M,_){const I=i.get(M);if(M.version>0&&I.__version!==M.version){Ne(I,M,_);return}n.bindTexture(t.TEXTURE_3D,I.__webglTexture,t.TEXTURE0+_)}function q(M,_){const I=i.get(M);if(M.version>0&&I.__version!==M.version){O(I,M,_);return}n.bindTexture(t.TEXTURE_CUBE_MAP,I.__webglTexture,t.TEXTURE0+_)}const Me={[rc]:t.REPEAT,[cr]:t.CLAMP_TO_EDGE,[sc]:t.MIRRORED_REPEAT},Ae={[Nn]:t.NEAREST,[Ox]:t.NEAREST_MIPMAP_NEAREST,[so]:t.NEAREST_MIPMAP_LINEAR,[jn]:t.LINEAR,[Ja]:t.LINEAR_MIPMAP_NEAREST,[ur]:t.LINEAR_MIPMAP_LINEAR},Re={[Hx]:t.NEVER,[qx]:t.ALWAYS,[Vx]:t.LESS,[mp]:t.LEQUAL,[Gx]:t.EQUAL,[$x]:t.GEQUAL,[Wx]:t.GREATER,[Xx]:t.NOTEQUAL};function He(M,_){if(_.type===di&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===jn||_.magFilter===Ja||_.magFilter===so||_.magFilter===ur||_.minFilter===jn||_.minFilter===Ja||_.minFilter===so||_.minFilter===ur)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(M,t.TEXTURE_WRAP_S,Me[_.wrapS]),t.texParameteri(M,t.TEXTURE_WRAP_T,Me[_.wrapT]),(M===t.TEXTURE_3D||M===t.TEXTURE_2D_ARRAY)&&t.texParameteri(M,t.TEXTURE_WRAP_R,Me[_.wrapR]),t.texParameteri(M,t.TEXTURE_MAG_FILTER,Ae[_.magFilter]),t.texParameteri(M,t.TEXTURE_MIN_FILTER,Ae[_.minFilter]),_.compareFunction&&(t.texParameteri(M,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(M,t.TEXTURE_COMPARE_FUNC,Re[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Nn||_.minFilter!==so&&_.minFilter!==ur||_.type===di&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||i.get(_).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");t.texParameterf(M,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,r.getMaxAnisotropy())),i.get(_).__currentAnisotropy=_.anisotropy}}}function We(M,_){let I=!1;M.__webglInit===void 0&&(M.__webglInit=!0,_.addEventListener("dispose",C));const $=_.source;let te=d.get($);te===void 0&&(te={},d.set($,te));const W=Y(_);if(W!==M.__cacheKey){te[W]===void 0&&(te[W]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,I=!0),te[W].usedTimes++;const Pe=te[M.__cacheKey];Pe!==void 0&&(te[M.__cacheKey].usedTimes--,Pe.usedTimes===0&&T(_)),M.__cacheKey=W,M.__webglTexture=te[W].texture}return I}function ue(M,_,I){return Math.floor(Math.floor(M/I)/_)}function ye(M,_,I,$){const W=M.updateRanges;if(W.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,_.width,_.height,I,$,_.data);else{W.sort((ie,Te)=>ie.start-Te.start);let Pe=0;for(let ie=1;ie<W.length;ie++){const Te=W[Pe],Oe=W[ie],Fe=Te.start+Te.count,we=ue(Oe.start,_.width,4),qe=ue(Te.start,_.width,4);Oe.start<=Fe+1&&we===qe&&ue(Oe.start+Oe.count-1,_.width,4)===we?Te.count=Math.max(Te.count,Oe.start+Oe.count-Te.start):(++Pe,W[Pe]=Oe)}W.length=Pe+1;const ae=t.getParameter(t.UNPACK_ROW_LENGTH),ge=t.getParameter(t.UNPACK_SKIP_PIXELS),xe=t.getParameter(t.UNPACK_SKIP_ROWS);t.pixelStorei(t.UNPACK_ROW_LENGTH,_.width);for(let ie=0,Te=W.length;ie<Te;ie++){const Oe=W[ie],Fe=Math.floor(Oe.start/4),we=Math.ceil(Oe.count/4),qe=Fe%_.width,U=Math.floor(Fe/_.width),De=we,_e=1;t.pixelStorei(t.UNPACK_SKIP_PIXELS,qe),t.pixelStorei(t.UNPACK_SKIP_ROWS,U),n.texSubImage2D(t.TEXTURE_2D,0,qe,U,De,_e,I,$,_.data)}M.clearUpdateRanges(),t.pixelStorei(t.UNPACK_ROW_LENGTH,ae),t.pixelStorei(t.UNPACK_SKIP_PIXELS,ge),t.pixelStorei(t.UNPACK_SKIP_ROWS,xe)}}function Ne(M,_,I){let $=t.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&($=t.TEXTURE_2D_ARRAY),_.isData3DTexture&&($=t.TEXTURE_3D);const te=We(M,_),W=_.source;n.bindTexture($,M.__webglTexture,t.TEXTURE0+I);const Pe=i.get(W);if(W.version!==Pe.__version||te===!0){n.activeTexture(t.TEXTURE0+I);const ae=ct.getPrimaries(ct.workingColorSpace),ge=_.colorSpace===Ni?null:ct.getPrimaries(_.colorSpace),xe=_.colorSpace===Ni||ae===ge?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let ie=v(_.image,!1,r.maxTextureSize);ie=X(_,ie);const Te=s.convert(_.format,_.colorSpace),Oe=s.convert(_.type);let Fe=w(_.internalFormat,Te,Oe,_.colorSpace,_.isVideoTexture);He($,_);let we;const qe=_.mipmaps,U=_.isVideoTexture!==!0,De=Pe.__version===void 0||te===!0,_e=W.dataReady,Be=L(_,ie);if(_.isDepthTexture)Fe=E(_.format===Hs,_.type),De&&(U?n.texStorage2D(t.TEXTURE_2D,1,Fe,ie.width,ie.height):n.texImage2D(t.TEXTURE_2D,0,Fe,ie.width,ie.height,0,Te,Oe,null));else if(_.isDataTexture)if(qe.length>0){U&&De&&n.texStorage2D(t.TEXTURE_2D,Be,Fe,qe[0].width,qe[0].height);for(let Se=0,de=qe.length;Se<de;Se++)we=qe[Se],U?_e&&n.texSubImage2D(t.TEXTURE_2D,Se,0,0,we.width,we.height,Te,Oe,we.data):n.texImage2D(t.TEXTURE_2D,Se,Fe,we.width,we.height,0,Te,Oe,we.data);_.generateMipmaps=!1}else U?(De&&n.texStorage2D(t.TEXTURE_2D,Be,Fe,ie.width,ie.height),_e&&ye(_,ie,Te,Oe)):n.texImage2D(t.TEXTURE_2D,0,Fe,ie.width,ie.height,0,Te,Oe,ie.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){U&&De&&n.texStorage3D(t.TEXTURE_2D_ARRAY,Be,Fe,qe[0].width,qe[0].height,ie.depth);for(let Se=0,de=qe.length;Se<de;Se++)if(we=qe[Se],_.format!==In)if(Te!==null)if(U){if(_e)if(_.layerUpdates.size>0){const ve=$f(we.width,we.height,_.format,_.type);for(const Ce of _.layerUpdates){const nt=we.data.subarray(Ce*ve/we.data.BYTES_PER_ELEMENT,(Ce+1)*ve/we.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Se,0,0,Ce,we.width,we.height,1,Te,nt)}_.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,Se,0,0,0,we.width,we.height,ie.depth,Te,we.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,Se,Fe,we.width,we.height,ie.depth,0,we.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?_e&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,Se,0,0,0,we.width,we.height,ie.depth,Te,Oe,we.data):n.texImage3D(t.TEXTURE_2D_ARRAY,Se,Fe,we.width,we.height,ie.depth,0,Te,Oe,we.data)}else{U&&De&&n.texStorage2D(t.TEXTURE_2D,Be,Fe,qe[0].width,qe[0].height);for(let Se=0,de=qe.length;Se<de;Se++)we=qe[Se],_.format!==In?Te!==null?U?_e&&n.compressedTexSubImage2D(t.TEXTURE_2D,Se,0,0,we.width,we.height,Te,we.data):n.compressedTexImage2D(t.TEXTURE_2D,Se,Fe,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?_e&&n.texSubImage2D(t.TEXTURE_2D,Se,0,0,we.width,we.height,Te,Oe,we.data):n.texImage2D(t.TEXTURE_2D,Se,Fe,we.width,we.height,0,Te,Oe,we.data)}else if(_.isDataArrayTexture)if(U){if(De&&n.texStorage3D(t.TEXTURE_2D_ARRAY,Be,Fe,ie.width,ie.height,ie.depth),_e)if(_.layerUpdates.size>0){const Se=$f(ie.width,ie.height,_.format,_.type);for(const de of _.layerUpdates){const ve=ie.data.subarray(de*Se/ie.data.BYTES_PER_ELEMENT,(de+1)*Se/ie.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,de,ie.width,ie.height,1,Te,Oe,ve)}_.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,Te,Oe,ie.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Fe,ie.width,ie.height,ie.depth,0,Te,Oe,ie.data);else if(_.isData3DTexture)U?(De&&n.texStorage3D(t.TEXTURE_3D,Be,Fe,ie.width,ie.height,ie.depth),_e&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,Te,Oe,ie.data)):n.texImage3D(t.TEXTURE_3D,0,Fe,ie.width,ie.height,ie.depth,0,Te,Oe,ie.data);else if(_.isFramebufferTexture){if(De)if(U)n.texStorage2D(t.TEXTURE_2D,Be,Fe,ie.width,ie.height);else{let Se=ie.width,de=ie.height;for(let ve=0;ve<Be;ve++)n.texImage2D(t.TEXTURE_2D,ve,Fe,Se,de,0,Te,Oe,null),Se>>=1,de>>=1}}else if(qe.length>0){if(U&&De){const Se=be(qe[0]);n.texStorage2D(t.TEXTURE_2D,Be,Fe,Se.width,Se.height)}for(let Se=0,de=qe.length;Se<de;Se++)we=qe[Se],U?_e&&n.texSubImage2D(t.TEXTURE_2D,Se,0,0,Te,Oe,we):n.texImage2D(t.TEXTURE_2D,Se,Fe,Te,Oe,we);_.generateMipmaps=!1}else if(U){if(De){const Se=be(ie);n.texStorage2D(t.TEXTURE_2D,Be,Fe,Se.width,Se.height)}_e&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Te,Oe,ie)}else n.texImage2D(t.TEXTURE_2D,0,Fe,Te,Oe,ie);m(_)&&p($),Pe.__version=W.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function O(M,_,I){if(_.image.length!==6)return;const $=We(M,_),te=_.source;n.bindTexture(t.TEXTURE_CUBE_MAP,M.__webglTexture,t.TEXTURE0+I);const W=i.get(te);if(te.version!==W.__version||$===!0){n.activeTexture(t.TEXTURE0+I);const Pe=ct.getPrimaries(ct.workingColorSpace),ae=_.colorSpace===Ni?null:ct.getPrimaries(_.colorSpace),ge=_.colorSpace===Ni||Pe===ae?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge);const xe=_.isCompressedTexture||_.image[0].isCompressedTexture,ie=_.image[0]&&_.image[0].isDataTexture,Te=[];for(let de=0;de<6;de++)!xe&&!ie?Te[de]=v(_.image[de],!0,r.maxCubemapSize):Te[de]=ie?_.image[de].image:_.image[de],Te[de]=X(_,Te[de]);const Oe=Te[0],Fe=s.convert(_.format,_.colorSpace),we=s.convert(_.type),qe=w(_.internalFormat,Fe,we,_.colorSpace),U=_.isVideoTexture!==!0,De=W.__version===void 0||$===!0,_e=te.dataReady;let Be=L(_,Oe);He(t.TEXTURE_CUBE_MAP,_);let Se;if(xe){U&&De&&n.texStorage2D(t.TEXTURE_CUBE_MAP,Be,qe,Oe.width,Oe.height);for(let de=0;de<6;de++){Se=Te[de].mipmaps;for(let ve=0;ve<Se.length;ve++){const Ce=Se[ve];_.format!==In?Fe!==null?U?_e&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve,0,0,Ce.width,Ce.height,Fe,Ce.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve,qe,Ce.width,Ce.height,0,Ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?_e&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve,0,0,Ce.width,Ce.height,Fe,we,Ce.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve,qe,Ce.width,Ce.height,0,Fe,we,Ce.data)}}}else{if(Se=_.mipmaps,U&&De){Se.length>0&&Be++;const de=be(Te[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,Be,qe,de.width,de.height)}for(let de=0;de<6;de++)if(ie){U?_e&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Te[de].width,Te[de].height,Fe,we,Te[de].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,qe,Te[de].width,Te[de].height,0,Fe,we,Te[de].data);for(let ve=0;ve<Se.length;ve++){const nt=Se[ve].image[de].image;U?_e&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve+1,0,0,nt.width,nt.height,Fe,we,nt.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve+1,qe,nt.width,nt.height,0,Fe,we,nt.data)}}else{U?_e&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Fe,we,Te[de]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,qe,Fe,we,Te[de]);for(let ve=0;ve<Se.length;ve++){const Ce=Se[ve];U?_e&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve+1,0,0,Fe,we,Ce.image[de]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,ve+1,qe,Fe,we,Ce.image[de])}}}m(_)&&p(t.TEXTURE_CUBE_MAP),W.__version=te.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function le(M,_,I,$,te,W){const Pe=s.convert(I.format,I.colorSpace),ae=s.convert(I.type),ge=w(I.internalFormat,Pe,ae,I.colorSpace),xe=i.get(_),ie=i.get(I);if(ie.__renderTarget=_,!xe.__hasExternalTextures){const Te=Math.max(1,_.width>>W),Oe=Math.max(1,_.height>>W);te===t.TEXTURE_3D||te===t.TEXTURE_2D_ARRAY?n.texImage3D(te,W,ge,Te,Oe,_.depth,0,Pe,ae,null):n.texImage2D(te,W,ge,Te,Oe,0,Pe,ae,null)}n.bindFramebuffer(t.FRAMEBUFFER,M),se(_)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,$,te,ie.__webglTexture,0,j(_)):(te===t.TEXTURE_2D||te>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,$,te,ie.__webglTexture,W),n.bindFramebuffer(t.FRAMEBUFFER,null)}function me(M,_,I){if(t.bindRenderbuffer(t.RENDERBUFFER,M),_.depthBuffer){const $=_.depthTexture,te=$&&$.isDepthTexture?$.type:null,W=E(_.stencilBuffer,te),Pe=_.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ae=j(_);se(_)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ae,W,_.width,_.height):I?t.renderbufferStorageMultisample(t.RENDERBUFFER,ae,W,_.width,_.height):t.renderbufferStorage(t.RENDERBUFFER,W,_.width,_.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Pe,t.RENDERBUFFER,M)}else{const $=_.textures;for(let te=0;te<$.length;te++){const W=$[te],Pe=s.convert(W.format,W.colorSpace),ae=s.convert(W.type),ge=w(W.internalFormat,Pe,ae,W.colorSpace),xe=j(_);I&&se(_)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,xe,ge,_.width,_.height):se(_)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,xe,ge,_.width,_.height):t.renderbufferStorage(t.RENDERBUFFER,ge,_.width,_.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function pe(M,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,M),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=i.get(_.depthTexture);$.__renderTarget=_,(!$.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),he(_.depthTexture,0);const te=$.__webglTexture,W=j(_);if(_.depthTexture.format===zs)se(_)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,te,0,W):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,te,0);else if(_.depthTexture.format===Hs)se(_)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,te,0,W):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,te,0);else throw new Error("Unknown depthTexture format")}function Ve(M){const _=i.get(M),I=M.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==M.depthTexture){const $=M.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),$){const te=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,$.removeEventListener("dispose",te)};$.addEventListener("dispose",te),_.__depthDisposeCallback=te}_.__boundDepthTexture=$}if(M.depthTexture&&!_.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");const $=M.texture.mipmaps;$&&$.length>0?pe(_.__webglFramebuffer[0],M):pe(_.__webglFramebuffer,M)}else if(I){_.__webglDepthbuffer=[];for(let $=0;$<6;$++)if(n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer[$]),_.__webglDepthbuffer[$]===void 0)_.__webglDepthbuffer[$]=t.createRenderbuffer(),me(_.__webglDepthbuffer[$],M,!1);else{const te=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,W=_.__webglDepthbuffer[$];t.bindRenderbuffer(t.RENDERBUFFER,W),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,W)}}else{const $=M.texture.mipmaps;if($&&$.length>0?n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=t.createRenderbuffer(),me(_.__webglDepthbuffer,M,!1);else{const te=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,W=_.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,W),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,W)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function A(M,_,I){const $=i.get(M);_!==void 0&&le($.__webglFramebuffer,M,M.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),I!==void 0&&Ve(M)}function R(M){const _=M.texture,I=i.get(M),$=i.get(_);M.addEventListener("dispose",P);const te=M.textures,W=M.isWebGLCubeRenderTarget===!0,Pe=te.length>1;if(Pe||($.__webglTexture===void 0&&($.__webglTexture=t.createTexture()),$.__version=_.version,o.memory.textures++),W){I.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0){I.__webglFramebuffer[ae]=[];for(let ge=0;ge<_.mipmaps.length;ge++)I.__webglFramebuffer[ae][ge]=t.createFramebuffer()}else I.__webglFramebuffer[ae]=t.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){I.__webglFramebuffer=[];for(let ae=0;ae<_.mipmaps.length;ae++)I.__webglFramebuffer[ae]=t.createFramebuffer()}else I.__webglFramebuffer=t.createFramebuffer();if(Pe)for(let ae=0,ge=te.length;ae<ge;ae++){const xe=i.get(te[ae]);xe.__webglTexture===void 0&&(xe.__webglTexture=t.createTexture(),o.memory.textures++)}if(M.samples>0&&se(M)===!1){I.__webglMultisampledFramebuffer=t.createFramebuffer(),I.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ae=0;ae<te.length;ae++){const ge=te[ae];I.__webglColorRenderbuffer[ae]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,I.__webglColorRenderbuffer[ae]);const xe=s.convert(ge.format,ge.colorSpace),ie=s.convert(ge.type),Te=w(ge.internalFormat,xe,ie,ge.colorSpace,M.isXRRenderTarget===!0),Oe=j(M);t.renderbufferStorageMultisample(t.RENDERBUFFER,Oe,Te,M.width,M.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ae,t.RENDERBUFFER,I.__webglColorRenderbuffer[ae])}t.bindRenderbuffer(t.RENDERBUFFER,null),M.depthBuffer&&(I.__webglDepthRenderbuffer=t.createRenderbuffer(),me(I.__webglDepthRenderbuffer,M,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(W){n.bindTexture(t.TEXTURE_CUBE_MAP,$.__webglTexture),He(t.TEXTURE_CUBE_MAP,_);for(let ae=0;ae<6;ae++)if(_.mipmaps&&_.mipmaps.length>0)for(let ge=0;ge<_.mipmaps.length;ge++)le(I.__webglFramebuffer[ae][ge],M,_,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ge);else le(I.__webglFramebuffer[ae],M,_,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(_)&&p(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Pe){for(let ae=0,ge=te.length;ae<ge;ae++){const xe=te[ae],ie=i.get(xe);n.bindTexture(t.TEXTURE_2D,ie.__webglTexture),He(t.TEXTURE_2D,xe),le(I.__webglFramebuffer,M,xe,t.COLOR_ATTACHMENT0+ae,t.TEXTURE_2D,0),m(xe)&&p(t.TEXTURE_2D)}n.unbindTexture()}else{let ae=t.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(ae=M.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ae,$.__webglTexture),He(ae,_),_.mipmaps&&_.mipmaps.length>0)for(let ge=0;ge<_.mipmaps.length;ge++)le(I.__webglFramebuffer[ge],M,_,t.COLOR_ATTACHMENT0,ae,ge);else le(I.__webglFramebuffer,M,_,t.COLOR_ATTACHMENT0,ae,0);m(_)&&p(ae),n.unbindTexture()}M.depthBuffer&&Ve(M)}function x(M){const _=M.textures;for(let I=0,$=_.length;I<$;I++){const te=_[I];if(m(te)){const W=y(M),Pe=i.get(te).__webglTexture;n.bindTexture(W,Pe),p(W),n.unbindTexture()}}}const re=[],Q=[];function z(M){if(M.samples>0){if(se(M)===!1){const _=M.textures,I=M.width,$=M.height;let te=t.COLOR_BUFFER_BIT;const W=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Pe=i.get(M),ae=_.length>1;if(ae)for(let xe=0;xe<_.length;xe++)n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer);const ge=M.texture.mipmaps;ge&&ge.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let xe=0;xe<_.length;xe++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(te|=t.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(te|=t.STENCIL_BUFFER_BIT)),ae){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[xe]);const ie=i.get(_[xe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,ie,0)}t.blitFramebuffer(0,0,I,$,0,0,I,$,te,t.NEAREST),l===!0&&(re.length=0,Q.length=0,re.push(t.COLOR_ATTACHMENT0+xe),M.depthBuffer&&M.resolveDepthBuffer===!1&&(re.push(W),Q.push(W),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Q)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,re))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ae)for(let xe=0;xe<_.length;xe++){n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[xe]);const ie=i.get(_[xe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,ie,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&l){const _=M.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[_])}}}function j(M){return Math.min(r.maxSamples,M.samples)}function se(M){const _=i.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function V(M){const _=o.render.frame;u.get(M)!==_&&(u.set(M,_),M.update())}function X(M,_){const I=M.colorSpace,$=M.format,te=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||I!==Qr&&I!==Ni&&(ct.getTransfer(I)===_t?($!==In||te!==vi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),_}function be(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(c.width=M.naturalWidth||M.width,c.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(c.width=M.displayWidth,c.height=M.displayHeight):(c.width=M.width,c.height=M.height),c}this.allocateTextureUnit=G,this.resetTextureUnits=B,this.setTexture2D=he,this.setTexture2DArray=J,this.setTexture3D=fe,this.setTextureCube=q,this.rebindTextures=A,this.setupRenderTarget=R,this.updateRenderTargetMipmap=x,this.updateMultisampleRenderTarget=z,this.setupDepthRenderbuffer=Ve,this.setupFrameBufferTexture=le,this.useMultisampledRTT=se}function o1(t,e){function n(i,r=Ni){let s;const o=ct.getTransfer(r);if(i===vi)return t.UNSIGNED_BYTE;if(i===du)return t.UNSIGNED_SHORT_4_4_4_4;if(i===hu)return t.UNSIGNED_SHORT_5_5_5_1;if(i===cp)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===ap)return t.BYTE;if(i===lp)return t.SHORT;if(i===Bs)return t.UNSIGNED_SHORT;if(i===fu)return t.INT;if(i===gr)return t.UNSIGNED_INT;if(i===di)return t.FLOAT;if(i===Xs)return t.HALF_FLOAT;if(i===up)return t.ALPHA;if(i===fp)return t.RGB;if(i===In)return t.RGBA;if(i===zs)return t.DEPTH_COMPONENT;if(i===Hs)return t.DEPTH_STENCIL;if(i===dp)return t.RED;if(i===pu)return t.RED_INTEGER;if(i===hp)return t.RG;if(i===mu)return t.RG_INTEGER;if(i===gu)return t.RGBA_INTEGER;if(i===Oo||i===Fo||i===Bo||i===ko)if(o===_t)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Oo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Fo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Bo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ko)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Oo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Fo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Bo)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ko)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===oc||i===ac||i===lc||i===cc)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===oc)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===ac)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===lc)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===cc)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===uc||i===fc||i===dc)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===uc||i===fc)return o===_t?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===dc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===hc||i===pc||i===mc||i===gc||i===_c||i===vc||i===xc||i===Sc||i===yc||i===Ec||i===Mc||i===bc||i===Tc||i===wc)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===hc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===pc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===mc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===gc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===_c)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===vc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===xc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Sc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===yc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ec)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Mc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===bc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Tc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===wc)return o===_t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===zo||i===Ac||i===Rc)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===zo)return o===_t?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Ac)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Rc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===pp||i===Cc||i===Pc||i===Dc)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===zo)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Cc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Pc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Dc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ks?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const a1=`
void main() {
...
void main() {
...
}`;class c1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new on,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!==i.depthNear||n.depthFar!==i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new Si({vertexShader:a1,fragmentShader:l1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new pi(new Aa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class u1 extends ts{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,d=null,h=null,g=null;const v=new c1,m=n.getContextAttributes();let p=null,y=null;const w=[],E=[],L=new dt;let C=null;const P=new Dn;P.viewport=new Ct;const F=new Dn;F.viewport=new Ct;const T=[P,F],S=new DS;let D=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ue){let ye=w[ue];return ye===void 0&&(ye=new yl,w[ue]=ye),ye.getTargetRaySpace()},this.getControllerGrip=function(ue){let ye=w[ue];return ye===void 0&&(ye=new yl,w[ue]=ye),ye.getGripSpace()},this.getHand=function(ue){let ye=w[ue];return ye===void 0&&(ye=new yl,w[ue]=ye),ye.getHandSpace()};function G(ue){const ye=E.indexOf(ue.inputSource);if(ye===-1)return;const Ne=w[ye];Ne!==void 0&&(Ne.update(ue.inputSource,ue.frame,c||o),Ne.dispatchEvent({type:ue.type,data:ue.inputSource}))}function Y(){r.removeEventListener("select",G),r.removeEventListener("selectstart",G),r.removeEventListener("selectend",G),r.removeEventListener("squeeze",G),r.removeEventListener("squeezestart",G),r.removeEventListener("squeezeend",G),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",he);for(let ue=0;ue<w.length;ue++){const ye=E[ue];ye!==null&&(E[ue]=null,w[ue].disconnect(ye))}D=null,B=null,v.reset(),e.setRenderTarget(p),h=null,d=null,f=null,r=null,y=null,We.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ue){s=ue,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ue){a=ue,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(ue){c=ue},this.getBaseLayer=function(){return d!==null?d:h},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(ue){if(r=ue,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",G),r.addEventListener("selectstart",G),r.addEventListener("selectend",G),r.addEventListener("squeeze",G),r.addEventListener("squeezestart",G),r.addEventListener("squeezeend",G),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",he),m.xrCompatible!==!0&&await n.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(L),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ne=null,O=null,le=null;m.depth&&(le=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,Ne=m.stencil?Hs:zs,O=m.stencil?ks:gr);const me={colorFormat:n.RGBA8,depthFormat:le,scaleFactor:s};f=new XRWebGLBinding(r,n),d=f.createProjectionLayer(me),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new _r(d.textureWidth,d.textureHeight,{format:In,type:vi,depthTexture:new Rp(d.textureWidth,d.textureHeight,O,void 0,void 0,void 0,void 0,void 0,void 0,Ne),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const Ne={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,n,Ne),r.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),y=new _r(h.framebufferWidth,h.framebufferHeight,{format:In,type:vi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),We.setContext(r),We.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function he(ue){for(let ye=0;ye<ue.removed.length;ye++){const Ne=ue.removed[ye],O=E.indexOf(Ne);O>=0&&(E[O]=null,w[O].disconnect(Ne))}for(let ye=0;ye<ue.added.length;ye++){const Ne=ue.added[ye];let O=E.indexOf(Ne);if(O===-1){for(let me=0;me<w.length;me++)if(me>=E.length){E.push(Ne),O=me;break}else if(E[me]===null){E[me]=Ne,O=me;break}if(O===-1)break}const le=w[O];le&&le.connect(Ne)}}const J=new Z,fe=new Z;function q(ue,ye,Ne){J.setFromMatrixPosition(ye.matrixWorld),fe.setFromMatrixPosition(Ne.matrixWorld);const O=J.distanceTo(fe),le=ye.projectionMatrix.elements,me=Ne.projectionMatrix.elements,pe=le[14]/(le[10]-1),Ve=le[14]/(le[10]+1),A=(le[9]+1)/le[5],R=(le[9]-1)/le[5],x=(le[8]-1)/le[0],re=(me[8]+1)/me[0],Q=pe*x,z=pe*re,j=O/(-x+re),se=j*-x;if(ye.matrixWorld.decompose(ue.position,ue.quaternion,ue.scale),ue.translateX(se),ue.translateZ(j),ue.matrixWorld.compose(ue.position,ue.quaternion,ue.scale),ue.matrixWorldInverse.copy(ue.matrixWorld).invert(),le[10]===-1)ue.projectionMatrix.copy(ye.projectionMatrix),ue.projectionMatrixInverse.copy(ye.projectionMatrixInverse);else{const V=pe+j,X=Ve+j,be=Q-se,M=z+(O-se),_=A*Ve/X*V,I=R*Ve/X*V;ue.projectionMatrix.makePerspective(be,M,_,I,V,X),ue.projectionMatrixInverse.copy(ue.projectionMatrix).invert()}}function Me(ue,ye){ye===null?ue.matrixWorld.copy(ue.matrix):ue.matrixWorld.multiplyMatrices(ye.matrixWorld,ue.matrix),ue.matrixWorldInverse.copy(ue.matrixWorld).invert()}this.updateCamera=function(ue){if(r===null)return;let ye=ue.near,Ne=ue.far;v.texture!==null&&(v.depthNear>0&&(ye=v.depthNear),v.depthFar>0&&(Ne=v.depthFar)),S.near=F.near=P.near=ye,S.far=F.far=P.far=Ne,(D!==S.near||B!==S.far)&&(r.updateRenderState({depthNear:S.near,depthFar:S.far}),D=S.near,B=S.far),P.layers.mask=ue.layers.mask|2,F.layers.mask=ue.layers.mask|4,S.layers.mask=P.layers.mask|F.layers.mask;const O=ue.parent,le=S.cameras;Me(S,O);for(let me=0;me<le.length;me++)Me(le[me],O);le.length===2?q(S,P,F):S.projectionMatrix.copy(P.projectionMatrix),Ae(ue,S,O)};function Ae(ue,ye,Ne){Ne===null?ue.matrix.copy(ye.matrixWorld):(ue.matrix.copy(Ne.matrixWorld),ue.matrix.invert(),ue.matrix.multiply(ye.matrixWorld)),ue.matrix.decompose(ue.position,ue.quaternion,ue.scale),ue.updateMatrixWorld(!0),ue.projectionMatrix.copy(ye.projectionMatrix),ue.projectionMatrixInverse.copy(ye.projectionMatrixInverse),ue.isPerspectiveCamera&&(ue.fov=Lc*2*Math.atan(1/ue.projectionMatrix.elements[5]),ue.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(d===null&&h===null))return l},this.setFoveation=function(ue){l=ue,d!==null&&(d.fixedFoveation=ue),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=ue)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(S)};let Re=null;function He(ue,ye){if(u=ye.getViewerPose(c||o),g=ye,u!==null){const Ne=u.views;h!==null&&(e.setRenderTargetFramebuffer(y,h.framebuffer),e.setRenderTarget(y));let O=!1;Ne.length!==S.cameras.length&&(S.cameras.length=0,O=!0);for(let pe=0;pe<Ne.length;pe++){const Ve=Ne[pe];let A=null;if(h!==null)A=h.getViewport(Ve);else{const x=f.getViewSubImage(d,Ve);A=x.viewport,pe===0&&(e.setRenderTargetTextures(y,x.colorTexture,x.depthStencilTexture),e.setRenderTarget(y))}let R=T[pe];R===void 0&&(R=new Dn,R.layers.enable(pe),R.viewport=new Ct,T[pe]=R),R.matrix.fromArray(Ve.transform.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale),R.projectionMatrix.fromArray(Ve.projectionMatrix),R.projectionMatrixInverse.copy(R.projectionMatrix).invert(),R.viewport.set(A.x,A.y,A.width,A.height),pe===0&&(S.matrix.copy(R.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),O===!0&&S.cameras.push(R)}const le=r.enabledFeatures;if(le&&le.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&f){const pe=f.getDepthInformation(Ne[0]);pe&&pe.isValid&&pe.texture&&v.init(e,pe,r.renderState)}}for(let Ne=0;Ne<w.length;Ne++){const O=E[Ne],le=w[Ne];O!==null&&le!==void 0&&le.update(O,ye,c||o)}Re&&Re(ue,ye),ye.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ye}),g=null}const We=new Pp;We.setAnimationLoop(He),this.setAnimationLoop=function(ue){Re=ue},this.dispose=function(){}}}const nr=new xi,f1=new Pt;function d1(t,e){function n(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,bp(t)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,y,w,E){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),f(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&h(m,p,E)):p.isMeshMatcapMaterial?(s(m,p),g(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),v(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,y,w):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,n(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,n(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===sn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,n(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===sn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,n(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,n(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,n(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const y=e.get(p),w=y.envMap,E=y.envMapRotation;w&&(m.envMap.value=w,nr.copy(E),nr.x*=-1,nr.y*=-1,nr.z*=-1,w.isCubeTexture&&w.isRenderTargetTexture===!1&&(nr.y*=-1,nr.z*=-1),m.envMapRotation.value.setFromMatrix4(f1.makeRotationFromEuler(nr)),m.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,n(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,n(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,n(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,y,w){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*y,m.scale.value=w*.5,p.map&&(m.map.value=p.map,n(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,n(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,n(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,n(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,n(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function h(m,p,y){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,n(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,n(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,n(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,n(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,n(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===sn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,n(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,n(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,n(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,n(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,n(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,n(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,n(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function v(m,p){const y=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function h1(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(y,w){const E=w.program;i.uniformBlockBinding(y,E)}function c(y,w){let E=r[y.id];E===void 0&&(g(y),E=u(y),r[y.id]=E,y.addEventListener("dispose",m));const L=w.program;i.updateUBOMapping(y,L);const C=e.render.frame;s[y.id]!==C&&(d(y),s[y.id]=C)}function u(y){const w=f();y.__bindingPointIndex=w;const E=t.createBuffer(),L=y.__size,C=y.usage;return t.bindBuffer(t.UNIFORM_BUFFER,E),t.bufferData(t.UNIFORM_BUFFER,L,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,w,E),E}function f(){for(let y=0;y<a;y++)if(o.indexOf(y)===-1)return o.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const w=r[y.id],E=y.uniforms,L=y.__cache;t.bindBuffer(t.UNIFORM_BUFFER,w);for(let C=0,P=E.length;C<P;C++){const F=Array.isArray(E[C])?E[C]:[E[C]];for(let T=0,S=F.length;T<S;T++){const D=F[T];if(h(D,C,T,L)===!0){const B=D.__offset,G=Array.isArray(D.value)?D.value:[D.value];let Y=0;for(let he=0;he<G.length;he++){const J=G[he],fe=v(J);typeof J=="number"||typeof J=="boolean"?(D.__data[0]=J,t.bufferSubData(t.UNIFORM_BUFFER,B+Y,D.__data)):J.isMatrix3?(D.__data[0]=J.elements[0],D.__data[1]=J.elements[1],D.__data[2]=J.elements[2],D.__data[3]=0,D.__data[4]=J.elements[3],D.__data[5]=J.elements[4],D.__data[6]=J.elements[5],D.__data[7]=0,D.__data[8]=J.elements[6],D.__data[9]=J.elements[7],D.__data[10]=J.elements[8],D.__data[11]=0):(J.toArray(D.__data,Y),Y+=fe.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,B,D.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function h(y,w,E,L){const C=y.value,P=w+"_"+E;if(L[P]===void 0)return typeof C=="number"||typeof C=="boolean"?L[P]=C:L[P]=C.clone(),!0;{const F=L[P];if(typeof C=="number"||typeof C=="boolean"){if(F!==C)return L[P]=C,!0}else if(F.equals(C)===!1)return F.copy(C),!0}return!1}function g(y){const w=y.uniforms;let E=0;const L=16;for(let P=0,F=w.length;P<F;P++){const T=Array.isArray(w[P])?w[P]:[w[P]];for(let S=0,D=T.length;S<D;S++){const B=T[S],G=Array.isArray(B.value)?B.value:[B.value];for(let Y=0,he=G.length;Y<he;Y++){const J=G[Y],fe=v(J),q=E%L,Me=q%fe.boundary,Ae=q+Me;E+=Me,Ae!==0&&L-Ae<fe.storage&&(E+=L-Ae),B.__data=new Float32Array(fe.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=E,E+=fe.storage}}}const C=E%L;return C>0&&(E+=L-C),y.__size=E,y.__cache={},this}function v(y){const w={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(w.boundary=4,w.storage=4):y.isVector2?(w.boundary=8,w.storage=8):y.isVector3||y.isColor?(w.boundary=16,w.storage=12):y.isVector4?(w.boundary=16,w.storage=16):y.isMatrix3?(w.boundary=48,w.storage=48):y.isMatrix4?(w.boundary=64,w.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),w}function m(y){const w=y.target;w.removeEventListener("dispose",m);const E=o.indexOf(w.__bindingPointIndex);o.splice(E,1),t.deleteBuffer(r[w.id]),delete r[w.id],delete s[w.id]}function p(){for(const y in r)t.deleteBuffer(r[y]);o=[],r={},s={}}return{bind:l,update:c,dispose:p}}class p1{constructor(e={}){const{canvas:n=Yx(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reverseDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let h;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");h=i.getContextAttributes().alpha}else h=o;const g=new Uint32Array(4),v=new Int32Array(4);let m=null,p=null;const y=[],w=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ki,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const E=this;let L=!1;this._outputColorSpace=Mn;let C=0,P=0,F=null,T=-1,S=null;const D=new Ct,B=new Ct;let G=null;const Y=new mt(0);let he=0,J=n.width,fe=n.height,q=1,Me=null,Ae=null;const Re=new Ct(0,0,J,fe),He=new Ct(0,0,J,fe);let We=!1;const ue=new Ap;let ye=!1,Ne=!1;const O=new Pt,le=new Pt,me=new Z,pe=new Ct,Ve={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let A=!1;function R(){return F===null?q:1}let x=i;function re(b,k){return n.getContext(b,k)}try{const b={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${uu}`),n.addEventListener("webglcontextlost",Be,!1),n.addEventListener("webglcontextrestored",Se,!1),n.addEventListener("webglcontextcreationerror",de,!1),x===null){const k="webgl2";if(x=re(k,b),x===null)throw re(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Q,z,j,se,V,X,be,M,_,I,$,te,W,Pe,ae,ge,xe,ie,Te,Oe,Fe,we,qe,U;function De(){Q=new bM(x),Q.init(),we=new o1(x,Q),z=new _M(x,Q,e,we),j=new r1(x,Q),z.reverseDepthBuffer&&d&&j.buffers.depth.setReversed(!0),se=new AM(x),V=new Xb,X=new s1(x,Q,j,V,z,we,se),be=new xM(E),M=new MM(E),_=new IS(x),qe=new mM(x,_),I=new TM(x,_,se,qe),$=new CM(x,I,_,se),Te=new RM(x,z,X),ge=new vM(V),te=new Wb(E,be,M,Q,z,qe,ge),W=new d1(E,V),Pe=new qb,ae=new Qb(Q),ie=new pM(E,be,M,j,$,h,l),xe=new n1(E,$,z),U=new h1(x,se,z,j),Oe=new gM(x,Q,se),Fe=new wM(x,Q,se),se.programs=te.programs,E.capabilities=z,E.extensions=Q,E.properties=V,E.renderLists=Pe,E.shadowMap=xe,E.state=j,E.info=se}De();const _e=new u1(E,x);this.xr=_e,this.getContext=function(){return x},this.getContextAttributes=function(){return x.getContextAttributes()},this.forceContextLoss=function(){const b=Q.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Q.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(b){b!==void 0&&(q=b,this.setSize(J,fe,!1))},this.getSize=function(b){return b.set(J,fe)},this.setSize=function(b,k,K=!0){if(_e.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}J=b,fe=k,n.width=Math.floor(b*q),n.height=Math.floor(k*q),K===!0&&(n.style.width=b+"px",n.style.height=k+"px"),this.setViewport(0,0,b,k)},this.getDrawingBufferSize=function(b){return b.set(J*q,fe*q).floor()},this.setDrawingBufferSize=function(b,k,K){J=b,fe=k,q=K,n.width=Math.floor(b*K),n.height=Math.floor(k*K),this.setViewport(0,0,b,k)},this.getCurrentViewport=function(b){return b.copy(D)},this.getViewport=function(b){return b.copy(Re)},this.setViewport=function(b,k,K,ee){b.isVector4?Re.set(b.x,b.y,b.z,b.w):Re.set(b,k,K,ee),j.viewport(D.copy(Re).multiplyScalar(q).round())},this.getScissor=function(b){return b.copy(He)},this.setScissor=function(b,k,K,ee){b.isVector4?He.set(b.x,b.y,b.z,b.w):He.set(b,k,K,ee),j.scissor(B.copy(He).multiplyScalar(q).round())},this.getScissorTest=function(){return We},this.setScissorTest=function(b){j.setScissorTest(We=b)},this.setOpaqueSort=function(b){Me=b},this.setTransparentSort=function(b){Ae=b},this.getClearColor=function(b){return b.copy(ie.getClearColor())},this.setClearColor=function(){ie.setClearColor(...arguments)},this.getClearAlpha=function(){return ie.getClearAlpha()},this.setClearAlpha=function(){ie.setClearAlpha(...arguments)},this.clear=function(b=!0,k=!0,K=!0){let ee=0;if(b){let H=!1;if(F!==null){const Ee=F.texture.format;H=Ee===gu||Ee===mu||Ee===pu}if(H){const Ee=F.texture.type,Ue=Ee===vi||Ee===gr||Ee===Bs||Ee===ks||Ee===du||Ee===hu,ze=ie.getClearColor(),ke=ie.getClearAlpha(),Ke=ze.r,Ze=ze.g,Ge=ze.b;Ue?(g[0]=Ke,g[1]=Ze,g[2]=Ge,g[3]=ke,x.clearBufferuiv(x.COLOR,0,g)):(v[0]=Ke,v[1]=Ze,v[2]=Ge,v[3]=ke,x.clearBufferiv(x.COLOR,0,v))}else ee|=x.COLOR_BUFFER_BIT}k&&(ee|=x.DEPTH_BUFFER_BIT),K&&(ee|=x.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),x.clear(ee)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Be,!1),n.removeEventListener("webglcontextrestored",Se,!1),n.removeEventListener("webglcontextcreationerror",de,!1),ie.dispose(),Pe.dispose(),ae.dispose(),V.dispose(),be.dispose(),M.dispose(),$.dispose(),qe.dispose(),U.dispose(),te.dispose(),_e.dispose(),_e.removeEventListener("sessionstart",Zn),_e.removeEventListener("sessionend",Ot),Ft.stop()};function Be(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function Se(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const b=se.autoReset,k=xe.enabled,K=xe.autoUpdate,ee=xe.needsUpdate,H=xe.type;De(),se.autoReset=b,xe.enabled=k,xe.autoUpdate=K,xe.needsUpdate=ee,xe.type=H}function de(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function ve(b){const k=b.target;k.removeEventListener("dispose",ve),Ce(k)}function Ce(b){nt(b),V.remove(b)}function nt(b){const k=V.get(b).programs;k!==void 0&&(k.forEach(function(K){te.releaseProgram(K)}),b.isShaderMaterial&&te.releaseShaderCache(b))}this.renderBufferDirect=function(b,k,K,ee,H,Ee){k===null&&(k=Ve);const Ue=H.isMesh&&H.matrixWorld.determinant()<0,ze=am(b,k,K,ee,H);j.setMaterial(ee,Ue);let ke=K.index,Ke=1;if(ee.wireframe===!0){if(ke=I.getWireframeAttribute(K),ke===void 0)return;Ke=2}const Ze=K.drawRange,Ge=K.attributes.position;let st=Ze.start*Ke,gt=(Ze.start+Ze.count)*Ke;Ee!==null&&(st=Math.max(st,Ee.start*Ke),gt=Math.min(gt,(Ee.start+Ee.count)*Ke)),ke!==null?(st=Math.max(st,0),gt=Math.min(gt,ke.count)):Ge!=null&&(st=Math.max(st,0),gt=Math.min(gt,Ge.count));const wt=gt-st;if(wt<0||wt===1/0)return;qe.setup(H,ee,ze,K,ke);let yt,vt=Oe;if(ke!==null&&(yt=_.get(ke),vt=Fe,vt.setIndex(yt)),H.isMesh)ee.wireframe===!0?(j.setLineWidth(ee.wireframeLinewidth*R()),vt.setMode(x.LINES)):vt.setMode(x.TRIANGLES);else if(H.isLine){let Xe=ee.linewidth;Xe===void 0&&(Xe=1),j.setLineWidth(Xe*R()),H.isLineSegments?vt.setMode(x.LINES):H.isLineLoop?vt.setMode(x.LINE_LOOP):vt.setMode(x.LINE_STRIP)}else H.isPoints?vt.setMode(x.POINTS):H.isSprite&&vt.setMode(x.TRIANGLES);if(H.isBatchedMesh)if(H._multiDrawInstances!==null)$r("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),vt.renderMultiDrawInstances(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount,H._multiDrawInstances);else if(Q.get("WEBGL_multi_draw"))vt.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const Xe=H._multiDrawStarts,Tt=H._multiDrawCounts,lt=H._multiDrawCount,fn=ke?_.get(ke).bytesPerElement:1,yr=V.get(ee).currentProgram.getUniforms();for(let dn=0;dn<lt;dn++)yr.setValue(x,"_gl_DrawID",dn),vt.render(Xe[dn]/fn,Tt[dn])}else if(H.isInstancedMesh)vt.renderInstances(st,wt,H.count);else if(K.isInstancedBufferGeometry){const Xe=K._maxInstanceCount!==void 0?K._maxInstanceCount:1/0,Tt=Math.min(K.instanceCount,Xe);vt.renderInstances(st,wt,Tt)}else vt.render(st,wt)};function Ye(b,k,K){b.transparent===!0&&b.side===fi&&b.forceSinglePass===!1?(b.side=sn,b.needsUpdate=!0,vn(b,k,K),b.side=Vi,b.needsUpdate=!0,vn(b,k,K),b.side=fi):vn(b,k,K)}this.compile=function(b,k,K=null){K===null&&(K=b),p=ae.get(K),p.init(k),w.push(p),K.traverseVisible(function(H){H.isLight&&H.layers.test(k.layers)&&(p.pushLight(H),H.castShadow&&p.pushShadow(H))}),b!==K&&b.traverseVisible(function(H){H.isLight&&H.layers.test(k.layers)&&(p.pushLight(H),H.castShadow&&p.pushShadow(H))}),p.setupLights();const ee=new Set;return b.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const Ee=H.material;if(Ee)if(Array.isArray(Ee))for(let Ue=0;Ue<Ee.length;Ue++){const ze=Ee[Ue];Ye(ze,K,H),ee.add(ze)}else Ye(Ee,K,H),ee.add(Ee)}),p=w.pop(),ee},this.compileAsync=function(b,k,K=null){const ee=this.compile(b,k,K);return new Promise(H=>{function Ee(){if(ee.forEach(function(Ue){V.get(Ue).currentProgram.isReady()&&ee.delete(Ue)}),ee.size===0){H(b);return}setTimeout(Ee,10)}Q.get("KHR_parallel_shader_compile")!==null?Ee():setTimeout(Ee,10)})};let Dt=null;function Nt(b){Dt&&Dt(b)}function Zn(){Ft.stop()}function Ot(){Ft.start()}const Ft=new Pp;Ft.setAnimationLoop(Nt),typeof self<"u"&&Ft.setContext(self),this.setAnimationLoop=function(b){Dt=b,_e.setAnimationLoop(b),b===null?Ft.stop():Ft.start()},_e.addEventListener("sessionstart",Zn),_e.addEventListener("sessionend",Ot),this.render=function(b,k){if(k!==void 0&&k.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),_e.enabled===!0&&_e.isPresenting===!0&&(_e.cameraAutoUpdate===!0&&_e.updateCamera(k),k=_e.getCamera()),b.isScene===!0&&b.onBeforeRender(E,b,k,F),p=ae.get(b,w.length),p.init(k),w.push(p),le.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),ue.setFromProjectionMatrix(le),Ne=this.localClippingEnabled,ye=ge.init(this.clippingPlanes,Ne),m=Pe.get(b,y.length),m.init(),y.push(m),_e.enabled===!0&&_e.isPresenting===!0){const Ee=E.xr.getDepthSensingMesh();Ee!==null&&Vn(Ee,k,-1/0,E.sortObjects)}Vn(b,k,0,E.sortObjects),m.finish(),E.sortObjects===!0&&m.sort(Me,Ae),A=_e.enabled===!1||_e.isPresenting===!1||_e.hasDepthSensing()===!1,A&&ie.addToRenderList(m,b),this.info.render.frame++,ye===!0&&ge.beginShadows();const K=p.state.shadowsArray;xe.render(K,b,k),ye===!0&&ge.endShadows(),this.info.autoReset===!0&&this.info.reset();const ee=m.opaque,H=m.transmissive;if(p.setupLights(),k.isArrayCamera){const Ee=k.cameras;if(H.length>0)for(let Ue=0,ze=Ee.length;Ue<ze;Ue++){const ke=Ee[Ue];un(ee,H,b,ke)}A&&ie.render(b);for(let Ue=0,ze=Ee.length;Ue<ze;Ue++){const ke=Ee[Ue];Jn(m,b,ke,ke.viewport)}}else H.length>0&&un(ee,H,b,k),A&&ie.render(b),Jn(m,b,k);F!==null&&P===0&&(X.updateMultisampleRenderTarget(F),X.updateRenderTargetMipmap(F)),b.isScene===!0&&b.onAfterRender(E,b,k),qe.resetDefaultState(),T=-1,S=null,w.pop(),w.length>0?(p=w[w.length-1],ye===!0&&ge.setGlobalState(E.clippingPlanes,p.state.camera)):p=null,y.pop(),y.length>0?m=y[y.length-1]:m=null};function Vn(b,k,K,ee){if(b.visible===!1)return;if(b.layers.test(k.layers)){if(b.isGroup)K=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(k);else if(b.isLight)p.pushLight(b),b.castShadow&&p.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||ue.intersectsSprite(b)){ee&&pe.setFromMatrixPosition(b.matrixWorld).applyMatrix4(le);const Ue=$.update(b),ze=b.material;ze.visible&&m.push(b,Ue,ze,K,pe.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||ue.intersectsObject(b))){const Ue=$.update(b),ze=b.material;if(ee&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),pe.copy(b.boundingSphere.center)):(Ue.boundingSphere===null&&Ue.computeBoundingSphere(),pe.copy(Ue.boundingSphere.center)),pe.applyMatrix4(b.matrixWorld).applyMatrix4(le)),Array.isArray(ze)){const ke=Ue.groups;for(let Ke=0,Ze=ke.length;Ke<Ze;Ke++){const Ge=ke[Ke],st=ze[Ge.materialIndex];st&&st.visible&&m.push(b,Ue,st,K,pe.z,Ge)}}else ze.visible&&m.push(b,Ue,ze,K,pe.z,null)}}const Ee=b.children;for(let Ue=0,ze=Ee.length;Ue<ze;Ue++)Vn(Ee[Ue],k,K,ee)}function Jn(b,k,K,ee){const H=b.opaque,Ee=b.transmissive,Ue=b.transparent;p.setupLightsView(K),ye===!0&&ge.setGlobalState(E.clippingPlanes,K),ee&&j.viewport(D.copy(ee)),H.length>0&&An(H,k,K),Ee.length>0&&An(Ee,k,K),Ue.length>0&&An(Ue,k,K),j.buffers.depth.setTest(!0),j.buffers.depth.setMask(!0),j.buffers.color.setMask(!0),j.setPolygonOffset(!1)}function un(b,k,K,ee){if((K.isScene===!0?K.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[ee.id]===void 0&&(p.state.transmissionRenderTarget[ee.id]=new _r(1,1,{generateMipmaps:!0,type:Q.has("EXT_color_buffer_half_float")||Q.has("EXT_color_buffer_float")?Xs:vi,minFilter:ur,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ct.workingColorSpace}));const Ee=p.state.transmissionRenderTarget[ee.id],Ue=ee.viewport||D;Ee.setSize(Ue.z*E.transmissionResolutionScale,Ue.w*E.transmissionResolutionScale);const ze=E.getRenderTarget(),ke=E.getActiveCubeFace(),Ke=E.getActiveMipmapLevel();E.setRenderTarget(Ee),E.getClearColor(Y),he=E.getClearAlpha(),he<1&&E.setClearColor(16777215,.5),E.clear(),A&&ie.render(K);const Ze=E.toneMapping;E.toneMapping=ki;const Ge=ee.viewport;if(ee.viewport!==void 0&&(ee.viewport=void 0),p.setupLightsView(ee),ye===!0&&ge.setGlobalState(E.clippingPlanes,ee),An(b,K,ee),X.updateMultisampleRenderTarget(Ee),X.updateRenderTargetMipmap(Ee),Q.has("WEBGL_multisampled_render_to_texture")===!1){let st=!1;for(let gt=0,wt=k.length;gt<wt;gt++){const yt=k[gt],vt=yt.object,Xe=yt.geometry,Tt=yt.material,lt=yt.group;if(Tt.side===fi&&vt.layers.test(ee.layers)){const fn=Tt.side;Tt.side=sn,Tt.needsUpdate=!0,Xi(vt,K,ee,Xe,Tt,lt),Tt.side=fn,Tt.needsUpdate=!0,st=!0}}st===!0&&(X.updateMultisampleRenderTarget(Ee),X.updateRenderTargetMipmap(Ee))}E.setRenderTarget(ze,ke,Ke),E.setClearColor(Y,he),Ge!==void 0&&(ee.viewport=Ge),E.toneMapping=Ze}function An(b,k,K){const ee=k.isScene===!0?k.overrideMaterial:null;for(let H=0,Ee=b.length;H<Ee;H++){const Ue=b[H],ze=Ue.object,ke=Ue.geometry,Ke=Ue.group;let Ze=Ue.material;Ze.allowOverride===!0&&ee!==null&&(Ze=ee),ze.layers.test(K.layers)&&Xi(ze,k,K,ke,Ze,Ke)}}function Xi(b,k,K,ee,H,Ee){b.onBeforeRender(E,k,K,ee,H,Ee),b.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),H.onBeforeRender(E,k,K,ee,b,Ee),H.transparent===!0&&H.side===fi&&H.forceSinglePass===!1?(H.side=sn,H.needsUpdate=!0,E.renderBufferDirect(K,k,ee,H,b,Ee),H.side=Vi,H.needsUpdate=!0,E.renderBufferDirect(K,k,ee,H,b,Ee),H.side=fi):E.renderBufferDirect(K,k,ee,H,b,Ee),b.onAfterRender(E,k,K,ee,H,Ee)}function vn(b,k,K){k.isScene!==!0&&(k=Ve);const ee=V.get(b),H=p.state.lights,Ee=p.state.shadowsArray,Ue=H.state.version,ze=te.getParameters(b,H.state,Ee,k,K),ke=te.getProgramCacheKey(ze);let Ke=ee.programs;ee.environment=b.isMeshStandardMaterial?k.environment:null,ee.fog=k.fog,ee.envMap=(b.isMeshStandardMaterial?M:be).get(b.envMap||ee.environment),ee.envMapRotation=ee.environment!==null&&b.envMap===null?k.environmentRotation:b.envMapRotation,Ke===void 0&&(b.addEventListener("dispose",ve),Ke=new Map,ee.programs=Ke);let Ze=Ke.get(ke);if(Ze!==void 0){if(ee.currentProgram===Ze&&ee.lightsStateVersion===Ue)return ss(b,ze),Ze}else ze.uniforms=te.getUniforms(b),b.onBeforeCompile(ze,E),Ze=te.acquireProgram(ze,ke),Ke.set(ke,Ze),ee.uniforms=ze.uniforms;const Ge=ee.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Ge.clippingPlanes=ge.uniform),ss(b,ze),ee.needsLights=cm(b),ee.lightsStateVersion=Ue,ee.needsLights&&(Ge.ambientLightColor.value=H.state.ambient,Ge.lightProbe.value=H.state.probe,Ge.directionalLights.value=H.state.directional,Ge.directionalLightShadows.value=H.state.directionalShadow,Ge.spotLights.value=H.state.spot,Ge.spotLightShadows.value=H.state.spotShadow,Ge.rectAreaLights.value=H.state.rectArea,Ge.ltc_1.value=H.state.rectAreaLTC1,Ge.ltc_2.value=H.state.rectAreaLTC2,Ge.pointLights.value=H.state.point,Ge.pointLightShadows.value=H.state.pointShadow,Ge.hemisphereLights.value=H.state.hemi,Ge.directionalShadowMap.value=H.state.directionalShadowMap,Ge.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Ge.spotShadowMap.value=H.state.spotShadowMap,Ge.spotLightMatrix.value=H.state.spotLightMatrix,Ge.spotLightMap.value=H.state.spotLightMap,Ge.pointShadowMap.value=H.state.pointShadowMap,Ge.pointShadowMatrix.value=H.state.pointShadowMatrix),ee.currentProgram=Ze,ee.uniformsList=null,Ze}function eo(b){if(b.uniformsList===null){const k=b.currentProgram.getUniforms();b.uniformsList=Ho.seqWithValue(k.seq,b.uniforms)}return b.uniformsList}function ss(b,k){const K=V.get(b);K.outputColorSpace=k.outputColorSpace,K.batching=k.batching,K.batchingColor=k.batchingColor,K.instancing=k.instancing,K.instancingColor=k.instancingColor,K.instancingMorph=k.instancingMorph,K.skinning=k.skinning,K.morphTargets=k.morphTargets,K.morphNormals=k.morphNormals,K.morphColors=k.morphColors,K.morphTargetsCount=k.morphTargetsCount,K.numClippingPlanes=k.numClippingPlanes,K.numIntersection=k.numClipIntersection,K.vertexAlphas=k.vertexAlphas,K.vertexTangents=k.vertexTangents,K.toneMapping=k.toneMapping}function am(b,k,K,ee,H){k.isScene!==!0&&(k=Ve),X.resetTextureUnits();const Ee=k.fog,Ue=ee.isMeshStandardMaterial?k.environment:null,ze=F===null?E.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Qr,ke=(ee.isMeshStandardMaterial?M:be).get(ee.envMap||Ue),Ke=ee.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,Ze=!!K.attributes.tangent&&(!!ee.normalMap||ee.anisotropy>0),Ge=!!K.morphAttributes.position,st=!!K.morphAttributes.normal,gt=!!K.morphAttributes.color;let wt=ki;ee.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(wt=E.toneMapping);const yt=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,vt=yt!==void 0?yt.length:0,Xe=V.get(ee),Tt=p.state.lights;if(ye===!0&&(Ne===!0||b!==S)){const Yt=b===S&&ee.id===T;ge.setState(ee,b,Yt)}let lt=!1;ee.version===Xe.__version?(Xe.needsLights&&Xe.lightsStateVersion!==Tt.state.version||Xe.outputColorSpace!==ze||H.isBatchedMesh&&Xe.batching===!1||!H.isBatchedMesh&&Xe.batching===!0||H.isBatchedMesh&&Xe.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&Xe.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&Xe.instancing===!1||!H.isInstancedMesh&&Xe.instancing===!0||H.isSkinnedMesh&&Xe.skinning===!1||!H.isSkinnedMesh&&Xe.skinning===!0||H.isInstancedMesh&&Xe.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Xe.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&Xe.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&Xe.instancingMorph===!1&&H.morphTexture!==null||Xe.envMap!==ke||ee.fog===!0&&Xe.fog!==Ee||Xe.numClippingPlanes!==void 0&&(Xe.numClippingPlanes!==ge.numPlanes||Xe.numIntersection!==ge.numIntersection)||Xe.vertexAlphas!==Ke||Xe.vertexTangents!==Ze||Xe.morphTargets!==Ge||Xe.morphNormals!==st||Xe.morphColors!==gt||Xe.toneMapping!==wt||Xe.morphTargetsCount!==vt)&&(lt=!0):(lt=!0,Xe.__version=ee.version);let fn=Xe.currentProgram;lt===!0&&(fn=vn(ee,k,H));let yr=!1,dn=!1,os=!1;const bt=fn.getUniforms(),xn=Xe.uniforms;if(j.useProgram(fn.program)&&(yr=!0,dn=!0,os=!0),ee.id!==T&&(T=ee.id,dn=!0),yr||S!==b){j.buffers.depth.getReversed()?(O.copy(b.projectionMatrix),Zx(O),Jx(O),bt.setValue(x,"projectionMatrix",O)):bt.setValue(x,"projectionMatrix",b.projectionMatrix),bt.setValue(x,"viewMatrix",b.matrixWorldInverse);const en=bt.map.cameraPosition;en!==void 0&&en.setValue(x,me.setFromMatrixPosition(b.matrixWorld)),z.logarithmicDepthBuffer&&bt.setValue(x,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(ee.isMeshPhongMaterial||ee.isMeshToonMaterial||ee.isMeshLambertMaterial||ee.isMeshBasicMaterial||ee.isMeshStandardMaterial||ee.isShaderMaterial)&&bt.setValue(x,"isOrthographic",b.isOrthographicCamera===!0),S!==b&&(S=b,dn=!0,os=!0)}if(H.isSkinnedMesh){bt.setOptional(x,H,"bindMatrix"),bt.setOptional(x,H,"bindMatrixInverse");const Yt=H.skeleton;Yt&&(Yt.boneTexture===null&&Yt.computeBoneTexture(),bt.setValue(x,"boneTexture",Yt.boneTexture,X))}H.isBatchedMesh&&(bt.setOptional(x,H,"batchingTexture"),bt.setValue(x,"batchingTexture",H._matricesTexture,X),bt.setOptional(x,H,"batchingIdTexture"),bt.setValue(x,"batchingIdTexture",H._indirectTexture,X),bt.setOptional(x,H,"batchingColorTexture"),H._colorsTexture!==null&&bt.setValue(x,"batchingColorTexture",H._colorsTexture,X));const Sn=K.morphAttributes;if((Sn.position!==void 0||Sn.normal!==void 0||Sn.color!==void 0)&&Te.update(H,K,fn),(dn||Xe.receiveShadow!==H.receiveShadow)&&(Xe.receiveShadow=H.receiveShadow,bt.setValue(x,"receiveShadow",H.receiveShadow)),ee.isMeshGouraudMaterial&&ee.envMap!==null&&(xn.envMap.value=ke,xn.flipEnvMap.value=ke.isCubeTexture&&ke.isRenderTargetTexture===!1?-1:1),ee.isMeshStandardMaterial&&ee.envMap===null&&k.environment!==null&&(xn.envMapIntensity.value=k.environmentIntensity),dn&&(bt.setValue(x,"toneMappingExposure",E.toneMappingExposure),Xe.needsLights&&lm(xn,os),Ee&&ee.fog===!0&&W.refreshFogUniforms(xn,Ee),W.refreshMaterialUniforms(xn,ee,q,fe,p.state.transmissionRenderTarget[b.id]),Ho.upload(x,eo(Xe),xn,X)),ee.isShaderMaterial&&ee.uniformsNeedUpdate===!0&&(Ho.upload(x,eo(Xe),xn,X),ee.uniformsNeedUpdate=!1),ee.isSpriteMaterial&&bt.setValue(x,"center",H.center),bt.setValue(x,"modelViewMatrix",H.modelViewMatrix),bt.setValue(x,"normalMatrix",H.normalMatrix),bt.setValue(x,"modelMatrix",H.matrixWorld),ee.isShaderMaterial||ee.isRawShaderMaterial){const Yt=ee.uniformsGroups;for(let en=0,Oa=Yt.length;en<Oa;en++){const $i=Yt[en];U.update($i,fn),U.bind($i,fn)}}return fn}function lm(b,k){b.ambientLightColor.needsUpdate=k,b.lightProbe.needsUpdate=k,b.directionalLights.needsUpdate=k,b.directionalLightShadows.needsUpdate=k,b.pointLights.needsUpdate=k,b.pointLightShadows.needsUpdate=k,b.spotLights.needsUpdate=k,b.spotLightShadows.needsUpdate=k,b.rectAreaLights.needsUpdate=k,b.hemisphereLights.needsUpdate=k}function cm(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(b,k,K){const ee=V.get(b);ee.__autoAllocateDepthBuffer=b.resolveDepthBuffer===!1,ee.__autoAllocateDepthBuffer===!1&&(ee.__useRenderToTexture=!1),V.get(b.texture).__webglTexture=k,V.get(b.depthTexture).__webglTexture=ee.__autoAllocateDepthBuffer?void 0:K,ee.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(b,k){const K=V.get(b);K.__webglFramebuffer=k,K.__useDefaultFramebuffer=k===void 0};const um=x.createFramebuffer();this.setRenderTarget=function(b,k=0,K=0){F=b,C=k,P=K;let ee=!0,H=null,Ee=!1,Ue=!1;if(b){const ke=V.get(b);if(ke.__useDefaultFramebuffer!==void 0)j.bindFramebuffer(x.FRAMEBUFFER,null),ee=!1;else if(ke.__webglFramebuffer===void 0)X.setupRenderTarget(b);else if(ke.__hasExternalTextures)X.rebindTextures(b,V.get(b.texture).__webglTexture,V.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const Ge=b.depthTexture;if(ke.__boundDepthTexture!==Ge){if(Ge!==null&&V.has(Ge)&&(b.width!==Ge.image.width||b.height!==Ge.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");X.setupDepthRenderbuffer(b)}}const Ke=b.texture;(Ke.isData3DTexture||Ke.isDataArrayTexture||Ke.isCompressedArrayTexture)&&(Ue=!0);const Ze=V.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Ze[k])?H=Ze[k][K]:H=Ze[k],Ee=!0):b.samples>0&&X.useMultisampledRTT(b)===!1?H=V.get(b).__webglMultisampledFramebuffer:Array.isArray(Ze)?H=Ze[K]:H=Ze,D.copy(b.viewport),B.copy(b.scissor),G=b.scissorTest}else D.copy(Re).multiplyScalar(q).floor(),B.copy(He).multiplyScalar(q).floor(),G=We;if(K!==0&&(H=um),j.bindFramebuffer(x.FRAMEBUFFER,H)&&ee&&j.drawBuffers(b,H),j.viewport(D),j.scissor(B),j.setScissorTest(G),Ee){const ke=V.get(b.texture);x.framebufferTexture2D(x.FRAMEBUFFER,x.COLOR_ATTACHMENT0,x.TEXTURE_CUBE_MAP_POSITIVE_X+k,ke.__webglTexture,K)}else if(Ue){const ke=V.get(b.texture),Ke=k;x.framebufferTextureLayer(x.FRAMEBUFFER,x.COLOR_ATTACHMENT0,ke.__webglTexture,K,Ke)}else if(b!==null&&K!==0){const ke=V.get(b.texture);x.framebufferTexture2D(x.FRAMEBUFFER,x.COLOR_ATTACHMENT0,x.TEXTURE_2D,ke.__webglTexture,K)}T=-1},this.readRenderTargetPixels=function(b,k,K,ee,H,Ee,Ue,ze=0){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ke=V.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Ue!==void 0&&(ke=ke[Ue]),ke){j.bindFramebuffer(x.FRAMEBUFFER,ke);try{const Ke=b.textures[ze],Ze=Ke.format,Ge=Ke.type;if(!z.textureFormatReadable(Ze)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!z.textureTypeReadable(Ge)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=b.width-ee&&K>=0&&K<=b.height-H&&(b.textures.length>1&&x.readBuffer(x.COLOR_ATTACHMENT0+ze),x.readPixels(k,K,ee,H,we.convert(Ze),we.convert(Ge),Ee))}finally{const Ke=F!==null?V.get(F).__webglFramebuffer:null;j.bindFramebuffer(x.FRAMEBUFFER,Ke)}}},this.readRenderTargetPixelsAsync=async function(b,k,K,ee,H,Ee,Ue,ze=0){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ke=V.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Ue!==void 0&&(ke=ke[Ue]),ke)if(k>=0&&k<=b.width-ee&&K>=0&&K<=b.height-H){j.bindFramebuffer(x.FRAMEBUFFER,ke);const Ke=b.textures[ze],Ze=Ke.format,Ge=Ke.type;if(!z.textureFormatReadable(Ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!z.textureTypeReadable(Ge))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const st=x.createBuffer();x.bindBuffer(x.PIXEL_PACK_BUFFER,st),x.bufferData(x.PIXEL_PACK_BUFFER,Ee.byteLength,x.STREAM_READ),b.textures.length>1&&x.readBuffer(x.COLOR_ATTACHMENT0+ze),x.readPixels(k,K,ee,H,we.convert(Ze),we.convert(Ge),0);const gt=F!==null?V.get(F).__webglFramebuffer:null;j.bindFramebuffer(x.FRAMEBUFFER,gt);const wt=x.fenceSync(x.SYNC_GPU_COMMANDS_COMPLETE,0);return x.flush(),await Kx(x,wt,4),x.bindBuffer(x.PIXEL_PACK_BUFFER,st),x.getBufferSubData(x.PIXEL_PACK_BUFFER,0,Ee),x.deleteBuffer(st),x.deleteSync(wt),Ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(b,k=null,K=0){const ee=Math.pow(2,-K),H=Math.floor(b.image.width*ee),Ee=Math.floor(b.image.height*ee),Ue=k!==null?k.x:0,ze=k!==null?k.y:0;X.setTexture2D(b,0),x.copyTexSubImage2D(x.TEXTURE_2D,K,0,0,Ue,ze,H,Ee),j.unbindTexture()};const fm=x.createFramebuffer(),dm=x.createFramebuffer();this.copyTextureToTexture=function(b,k,K=null,ee=null,H=0,Ee=null){Ee===null&&(H!==0?($r("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Ee=H,H=0):Ee=0);let Ue,ze,ke,Ke,Ze,Ge,st,gt,wt;const yt=b.isCompressedTexture?b.mipmaps[Ee]:b.image;if(K!==null)Ue=K.max.x-K.min.x,ze=K.max.y-K.min.y,ke=K.isBox3?K.max.z-K.min.z:1,Ke=K.min.x,Ze=K.min.y,Ge=K.isBox3?K.min.z:0;else{const Sn=Math.pow(2,-H);Ue=Math.floor(yt.width*Sn),ze=Math.floor(yt.height*Sn),b.isDataArrayTexture?ke=yt.depth:b.isData3DTexture?ke=Math.floor(yt.depth*Sn):ke=1,Ke=0,Ze=0,Ge=0}ee!==null?(st=ee.x,gt=ee.y,wt=ee.z):(st=0,gt=0,wt=0);const vt=we.convert(k.format),Xe=we.convert(k.type);let Tt;k.isData3DTexture?(X.setTexture3D(k,0),Tt=x.TEXTURE_3D):k.isDataArrayTexture||k.isCompressedArrayTexture?(X.setTexture2DArray(k,0),Tt=x.TEXTURE_2D_ARRAY):(X.setTexture2D(k,0),Tt=x.TEXTURE_2D),x.pixelStorei(x.UNPACK_FLIP_Y_WEBGL,k.flipY),x.pixelStorei(x.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),x.pixelStorei(x.UNPACK_ALIGNMENT,k.unpackAlignment);const lt=x.getParameter(x.UNPACK_ROW_LENGTH),fn=x.getParameter(x.UNPACK_IMAGE_HEIGHT),yr=x.getParameter(x.UNPACK_SKIP_PIXELS),dn=x.getParameter(x.UNPACK_SKIP_ROWS),os=x.getParameter(x.UNPACK_SKIP_IMAGES);x.pixelStorei(x.UNPACK_ROW_LENGTH,yt.width),x.pixelStorei(x.UNPACK_IMAGE_HEIGHT,yt.height),x.pixelStorei(x.UNPACK_SKIP_PIXELS,Ke),x.pixelStorei(x.UNPACK_SKIP_ROWS,Ze),x.pixelStorei(x.UNPACK_SKIP_IMAGES,Ge);const bt=b.isDataArrayTexture||b.isData3DTexture,xn=k.isDataArrayTexture||k.isData3DTexture;if(b.isDepthTexture){const Sn=V.get(b),Yt=V.get(k),en=V.get(Sn.__renderTarget),Oa=V.get(Yt.__renderTarget);j.bindFramebuffer(x.READ_FRAMEBUFFER,en.__webglFramebuffer),j.bindFramebuffer(x.DRAW_FRAMEBUFFER,Oa.__webglFramebuffer);for(let $i=0;$i<ke;$i++)bt&&(x.framebufferTextureLayer(x.READ_FRAMEBUFFER,x.COLOR_ATTACHMENT0,V.get(b).__webglTexture,H,Ge+$i),x.framebufferTextureLayer(x.DRAW_FRAMEBUFFER,x.COLOR_ATTACHMENT0,V.get(k).__webglTexture,Ee,wt+$i)),x.blitFramebuffer(Ke,Ze,Ue,ze,st,gt,Ue,ze,x.DEPTH_BUFFER_BIT,x.NEAREST);j.bindFramebuffer(x.READ_FRAMEBUFFER,null),j.bindFramebuffer(x.DRAW_FRAMEBUFFER,null)}else if(H!==0||b.isRenderTargetTexture||V.has(b)){const Sn=V.get(b),Yt=V.get(k);j.bindFramebuffer(x.READ_FRAMEBUFFER,fm),j.bindFramebuffer(x.DRAW_FRAMEBUFFER,dm);for(let en=0;en<ke;en++)bt?x.framebufferTextureLayer(x.READ_FRAMEBUFFER,x.COLOR_ATTACHMENT0,Sn.__webglTexture,H,Ge+en):x.framebufferTexture2D(x.READ_FRAMEBUFFER,x.COLOR_ATTACHMENT0,x.TEXTURE_2D,Sn.__webglTexture,H),xn?x.framebufferTextureLayer(x.DRAW_FRAMEBUFFER,x.COLOR_ATTACHMENT0,Yt.__webglTexture,Ee,wt+en):x.framebufferTexture2D(x.DRAW_FRAMEBUFFER,x.COLOR_ATTACHMENT0,x.TEXTURE_2D,Yt.__webglTexture,Ee),H!==0?x.blitFramebuffer(Ke,Ze,Ue,ze,st,gt,Ue,ze,x.COLOR_BUFFER_BIT,x.NEAREST):xn?x.copyTexSubImage3D(Tt,Ee,st,gt,wt+en,Ke,Ze,Ue,ze):x.copyTexSubImage2D(Tt,Ee,st,gt,Ke,Ze,Ue,ze);j.bindFramebuffer(x.READ_FRAMEBUFFER,null),j.bindFramebuffer(x.DRAW_FRAMEBUFFER,null)}else xn?b.isDataTexture||b.isData3DTexture?x.texSubImage3D(Tt,Ee,st,gt,wt,Ue,ze,ke,vt,Xe,yt.data):k.isCompressedArrayTexture?x.compressedTexSubImage3D(Tt,Ee,st,gt,wt,Ue,ze,ke,vt,yt.data):x.texSubImage3D(Tt,Ee,st,gt,wt,Ue,ze,ke,vt,Xe,yt):b.isDataTexture?x.texSubImage2D(x.TEXTURE_2D,Ee,st,gt,Ue,ze,vt,Xe,yt.data):b.isCompressedTexture?x.compressedTexSubImage2D(x.TEXTURE_2D,Ee,st,gt,yt.width,yt.height,vt,yt.data):x.texSubImage2D(x.TEXTURE_2D,Ee,st,gt,Ue,ze,vt,Xe,yt);x.pixelStorei(x.UNPACK_ROW_LENGTH,lt),x.pixelStorei(x.UNPACK_IMAGE_HEIGHT,fn),x.pixelStorei(x.UNPACK_SKIP_PIXELS,yr),x.pixelStorei(x.UNPACK_SKIP_ROWS,dn),x.pixelStorei(x.UNPACK_SKIP_IMAGES,os),Ee===0&&k.generateMipmaps&&x.generateMipmap(Tt),j.unbindTexture()},this.copyTextureToTexture3D=function(b,k,K=null,ee=null,H=0){return $r('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(b,k,K,ee,H)},this.initRenderTarget=function(b){V.get(b).__webglFramebuffer===void 0&&X.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?X.setTextureCube(b,0):b.isData3DTexture?X.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?X.setTexture2DArray(b,0):X.setTexture2D(b,0),j.unbindTexture()},this.resetState=function(){C=0,P=0,F=null,j.reset(),qe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return hi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=ct._getDrawingBufferColorSpace(e),n.unpackColorSpace=ct._getUnpackColorSpace()}}const m1={key:0,class:"fallback-background"},g1={__name:"FireAshBackground",setup(t){const e=Object.freeze({PARTICLE_COUNT:300,WIND_RADIUS:80,WIND_RADIUS_SQUARED:6400,WIND_STRENGTH:1200,HORIZONTAL_DRIFT:.3,HORIZONTAL_DRIFT_HALF:.15,MIN_UPWARD_SPEED:.25,MAX_UPWARD_SPEED:.6,MIN_SIZE:4,MAX_SIZE:10,VELOCITY_DAMPING:.98,VELOCITY_RESTORATION:.02,MOUSE_VELOCITY_DAMPING:.95,MOUSE_DRAG_FACTOR:.05,WIND_FORCE_FACTOR:.1,MAX_VELOCITY_X:2,MIN_VELOCITY_X:-2,MAX_VELOCITY_Y:3,MIN_VELOCITY_Y:-1,LIFETIME_INCREMENT:8e-4,LIFETIME_INCREMENT_FAST:.004,MAX_PIXEL_RATIO:1.5,WIND_FORCE:120,UPWARD_SPEED_RANGE:.35,SIZE_RANGE:6,AVERAGE_UPWARD_SPEED:.425,AVERAGE_UPWARD_SPEED_RESTORATION:.0085}),n=Ut(null),i=Ut(!0);let r,s,o,a,l;e.PARTICLE_COUNT;let c=e.PARTICLE_COUNT,u=new dt(-1e4,-1e4),f=new dt(0,0),d=new dt(-1e4,-1e4),h,g,v,m,p,y,w,E,L,C,P=!0,F=0,T=!1,S=0,D=0,B=2,G=5,Y=0,he=0,J=0,fe=!1,q=3,Me=[],Ae=null,Re={left:0,top:0,width:0,height:0},He={x:0,y:0},We={position:!1,velocity:!1,lifetime:!1},ue=null,ye=null;const Ne=()=>{try{const z=document.createElement("canvas");return!!(z.getContext("webgl")||z.getContext("experimental-webgl"))}catch{return!1}},O=()=>{P=!document.hidden},le=z=>{z.preventDefault(),l&&(cancelAnimationFrame(l),l=null)},me=()=>{x()},pe=()=>{const z=Math.random();return He.x=(z-.5)*e.HORIZONTAL_DRIFT,He.y=e.MIN_UPWARD_SPEED+z*e.UPWARD_SPEED_RANGE,He},Ve=z=>{const j=.5*z;let se=new Float32Array(1);se[0]=z;let V=new Uint32Array(se.buffer);V[0]=1597463007-(V[0]>>1);let X=new Float32Array(V.buffer)[0];return X=X*(1.5-j*X*X),X},A=()=>{const j=Math.PI*2/60;Ae=new Float32Array(60*2);for(let V=0;V<60;V++){const X=V*j;Ae[V*2]=Math.cos(X),Ae[V*2+1]=Math.sin(X)}const se=e.WIND_RADIUS+1;ue=new Float32Array(se*2);for(let V=0;V<se;V++){const X=V,be=X<e.WIND_RADIUS?(1-X/e.WIND_RADIUS)*e.WIND_STRENGTH*e.WIND_FORCE_FACTOR:0;ue[V*2]=X>0?be/X:0,ue[V*2+1]=X}ye=new Float32Array(150*3);for(let V=0;V<150;V++){const X=-3+V*.02;let be=1,M=1,_=0;X<-2?be=M=.98:X<-.5?(be=M=.97,_=-.25):(be=M=.88,_=.1),ye[V*3]=be,ye[V*3+1]=M,ye[V*3+2]=_}Me=[]},R=(z,j)=>{Me.length=0;for(let se=j-1;se>=0;se--)z[se]>1&&Me.push(se)},x=()=>{if(!n.value)return;if(!Ne()){i.value=!1,console.warn("WebGL not supported, using fallback background");return}const z=n.value.clientWidth,j=n.value.clientHeight;A();const se=n.value.getBoundingClientRect();Re.left=se.left,Re.top=se.top,Re.width=z,Re.height=j,r=new MS,s=new Cp(z/-2,z/2,j/2,j/-2,.1,1e3),s.position.z=1;try{o=new p1({alpha:!0,antialias:!1,powerPreference:"high-performance",stencil:!1,depth:!1})}catch(ae){console.error("Failed to create WebGL renderer:",ae),i.value=!1;return}o.setSize(z,j),o.setPixelRatio(Math.min(window.devicePixelRatio,e.MAX_PIXEL_RATIO)),n.value.appendChild(o.domElement),o.domElement.addEventListener("webglcontextlost",le,!1),o.domElement.addEventListener("webglcontextrestored",me,!1);const V=new Ei,X=new Float32Array(e.PARTICLE_COUNT*3),be=new Float32Array(e.PARTICLE_COUNT*3),M=new Float32Array(e.PARTICLE_COUNT),_=new Float32Array(e.PARTICLE_COUNT),I=new Float32Array(e.PARTICLE_COUNT);for(let ae=0;ae<e.PARTICLE_COUNT;ae++){const ge=ae*3;X[ge]=(Math.random()-.5)*z,X[ge+1]=(Math.random()-.5)*j,X[ge+2]=0;const xe=pe();be[ge]=xe.x,be[ge+1]=xe.y,be[ge+2]=0,M[ae]=e.MIN_SIZE+Math.random()*e.SIZE_RANGE,_[ae]=Math.random()*Math.PI*2,I[ae]=Math.random()}V.setAttribute("position",new It(X,3)),V.setAttribute("velocity",new It(be,3)),V.setAttribute("size",new It(M,1)),V.setAttribute("phase",new It(_,1)),V.setAttribute("lifetime",new It(I,1));const $=new Si({uniforms:{time:{value:0},isRainbowMode:{value:0}},vertexShader:`
    ...
    `,transparent:!0,blending:$l,depthWrite:!1});a=new RS(V,$),r.add(a);const te=(ae,ge)=>{if(!n.value)return;if(ae<0||ae>window.innerWidth||ge<0||ge>window.innerHeight){W();return}const xe=n.value.getBoundingClientRect();u.x=ae-xe.left-z/2,u.y=-(ge-xe.top-j/2),f.x=u.x-d.x,f.y=u.y-d.y,d.copy(u)};h=ae=>{te(ae.clientX,ae.clientY)},g=ae=>{ae.touches.length>0&&te(ae.touches[0].clientX,ae.touches[0].clientY)};const W=()=>{u.set(-1e4,-1e4),d.set(-1e4,-1e4),f.set(0,0)};v=W,m=ae=>{(!ae.relatedTarget||ae.relatedTarget.nodeName==="HTML")&&W()},p=W,y=()=>{fe=!1,Y=Math.min(Y+300,3e3),re(5e3)},w=()=>{fe=!1,Y=Math.max(0,Y-300)},E=()=>{fe=!0,D=0,T=!1,he=0},L=ae=>{T=ae.detail.active,D=T?1:0,T?(he=Y,re(5e3)):Y=0},C=ae=>{if(!a||Me.length<60)return;const ge=a.geometry.attributes,xe=ge.position.array,ie=ge.velocity.array,Te=ge.size.array,Oe=ge.phase.array,Fe=ge.lifetime.array,we=ae.detail.x-Re.left-Re.width*.5,qe=-(ae.detail.y-Re.top-Re.height*.5),U=6.283185307179586,De=3.75,_e=7.5,Be=e.MIN_SIZE,Se=e.SIZE_RANGE,de=new Float32Array(60*4);for(let ve=0;ve<240;ve++)de[ve]=Math.random();for(let ve=0;ve<60;ve++){const Ce=Me.pop(),nt=Ce*3,Ye=ve*4,Dt=de[Ye]*U,Nt=de[Ye]*3,Zn=Math.cos(Dt),Ot=Math.sin(Dt);xe[nt]=we+Zn*Nt,xe[nt+1]=qe+Ot*Nt,xe[nt+2]=0;const Ft=ve*2,Vn=(de[Ye]-.5)*.5,Jn=Math.cos(Vn),un=Math.sin(Vn),An=Ae[Ft]*Jn-Ae[Ft+1]*un,Xi=Ae[Ft]*un+Ae[Ft+1]*Jn,vn=De+de[Ye+1]*_e;ie[nt]=An*vn,ie[nt+1]=Xi*vn,ie[nt+2]=0,Te[Ce]=Be+de[Ye+2]*Se,Oe[Ce]=de[Ye+3]*U,Fe[Ce]=-3}ge.position.needsUpdate=!0,ge.velocity.needsUpdate=!0,ge.lifetime.needsUpdate=!0,ge.size.needsUpdate=!0,ge.phase.needsUpdate=!0},window.addEventListener("mousemove",h,{passive:!0}),window.addEventListener("touchmove",g,{passive:!0}),window.addEventListener("touchend",p,{passive:!0}),document.addEventListener("mouseleave",v,{passive:!0}),document.addEventListener("mouseout",m,{passive:!0}),window.addEventListener("increase-particles",y),window.addEventListener("decrease-particles",w),window.addEventListener("reset-particles",E),window.addEventListener("rainbow-mode",L),window.addEventListener("firework",C);const Pe=()=>{if(l=requestAnimationFrame(Pe),!P)return;const ae=performance.now()*.001,ge=J===0?1/60:Math.min(ae-J,.1);if(J=ae,We.position=!1,We.velocity=!1,We.lifetime=!1,S!==D){const ve=S<D,nt=ge/(ve?B:G);Math.abs(S-D)<nt?(S=D,S===0&&he>0&&(Y=he,he=0)):S+=ve?nt:-nt}if(fe&&Y>0){const ve=(e.PARTICLE_COUNT+3e3)*(ge/q);Y=Math.max(0,Y-ve),Y===0&&(fe=!1)}$.uniforms.time.value=ae,$.uniforms.isRainbowMode.value=S;const xe=a.geometry.attributes.position.array,ie=a.geometry.attributes.velocity.array,Te=a.geometry.attributes.lifetime.array,Oe=xe.length/3,Fe=n.value.clientHeight,we=n.value.clientWidth,qe=Fe/2,U=S>0&&he>0?he:Y,De=e.PARTICLE_COUNT+U,_e=1+2*S,Be=Math.floor(De*_e);if(c=Math.min(Be,5e3),F%2===0){let ve=0;const Ce=80,nt=Math.min(Oe,5e3);for(let Ye=e.PARTICLE_COUNT;Ye<nt;Ye++){const Dt=Te[Ye];if(Ye<c&&Dt>1){if(ve>=Ce)break;Te[Ye]=Math.random();const Nt=Ye*3,Zn=Math.random();xe[Nt]=(Zn-.5)*we,xe[Nt+1]=(Math.random()-.5)*Fe;const Ot=pe();ie[Nt]=Ot.x,ie[Nt+1]=Ot.y,ve++,We.position=!0,We.velocity=!0,We.lifetime=!0}else Ye>=c&&Dt<=1&&Dt>=0&&(Te[Ye]=.95,We.lifetime=!0)}}f.x*=e.MOUSE_VELOCITY_DAMPING,f.y*=e.MOUSE_VELOCITY_DAMPING,F++;const Se=F%2===0;if(F%10===0&&n.value){const ve=n.value.getBoundingClientRect();Re.left=ve.left,Re.top=ve.top,Re.width=we,Re.height=Fe}if(F%30===0&&(R(Te,Oe),Me.length<100)){const ve=100-Me.length;re(Math.min(Oe+ve,5e3))}const de=Math.min(Oe,5e3);for(let ve=0;ve<de;ve++){const Ce=ve*3;if(Te[ve]>1)continue;const nt=xe[Ce],Ye=xe[Ce+1];if(Te[ve]<0){const Ot=Math.floor((Te[ve]+3)*50)*3,Ft=ye[Ot],Vn=ye[Ot+1],Jn=ye[Ot+2];let un=ie[Ce]*Ft,An=ie[Ce+1]*Vn+Jn;if(xe[Ce]+=un,xe[Ce+1]+=An,ie[Ce]=un,ie[Ce+1]=An,Te[ve]+=.02,Te[ve]>=0){Te[ve]=0;const vn=pe();ie[Ce]=vn.x,ie[Ce+1]=vn.y}We.position=!0,We.velocity=!0,We.lifetime=!0;continue}if(Se){const Ot=nt-u.x,Ft=Ye-u.y,Vn=Math.abs(Ot),Jn=Math.abs(Ft);if(Vn<=e.WIND_RADIUS&&Jn<=e.WIND_RADIUS){const un=Ot*Ot+Ft*Ft;if(un<e.WIND_RADIUS_SQUARED&&un>.01){const An=Ve(un),Xi=un*An,vn=Math.floor(Xi),eo=Math.min(vn,e.WIND_RADIUS)*2,ss=ue[eo];ie[Ce]+=Ot*ss+f.x*e.MOUSE_DRAG_FACTOR,ie[Ce+1]+=Ft*ss+f.y*e.MOUSE_DRAG_FACTOR,ie[Ce]=Math.max(e.MIN_VELOCITY_X,Math.min(e.MAX_VELOCITY_X,ie[Ce])),ie[Ce+1]=Math.max(e.MIN_VELOCITY_Y,Math.min(e.MAX_VELOCITY_Y,ie[Ce+1])),We.velocity=!0}}}const Dt=1+(S+S),Nt=e.AVERAGE_UPWARD_SPEED_RESTORATION*Dt;ie[Ce]*=e.VELOCITY_DAMPING,ie[Ce+1]=ie[Ce+1]*e.VELOCITY_DAMPING+Nt,xe[Ce]+=ie[Ce],xe[Ce+1]+=ie[Ce+1];const Zn=Te[ve]+e.LIFETIME_INCREMENT;if(Te[ve]=Zn,We.position=!0,We.velocity=!0,We.lifetime=!0,xe[Ce+1]>qe+50||Zn>1)if(ve<c){xe[Ce]=(Math.random()-.5)*we,xe[Ce+1]=(Math.random()-.5)*Fe,Te[ve]=0;const Ot=pe();ie[Ce]=Ot.x,ie[Ce+1]=Ot.y}else Te[ve]=1.5}We.position&&(a.geometry.attributes.position.needsUpdate=!0),We.velocity&&(a.geometry.attributes.velocity.needsUpdate=!0),We.lifetime&&(a.geometry.attributes.lifetime.needsUpdate=!0),o.render(r,s)};Pe()},re=z=>{if(!a||!n.value||a.geometry.attributes.position.array.length>=z*3)return;const j=n.value.clientWidth,se=n.value.clientHeight,V=a.geometry.attributes.position.array,X=a.geometry.attributes.velocity.array,be=a.geometry.attributes.size.array,M=a.geometry.attributes.phase.array,_=a.geometry.attributes.lifetime.array,I=V.length/3,$=new Float32Array(z*3),te=new Float32Array(z*3),W=new Float32Array(z),Pe=new Float32Array(z),ae=new Float32Array(z);$.set(V),te.set(X),W.set(be),Pe.set(M),ae.set(_);for(let ge=I;ge<z;ge++){const xe=ge*3;$[xe]=(Math.random()-.5)*j,$[xe+1]=(Math.random()-.5)*se,$[xe+2]=0;const ie=pe();te[xe]=ie.x,te[xe+1]=ie.y,te[xe+2]=0,W[ge]=e.MIN_SIZE+Math.random()*e.SIZE_RANGE,Pe[ge]=Math.random()*Math.PI*2,ae[ge]=1.5}a.geometry.setAttribute("position",new It($,3)),a.geometry.setAttribute("velocity",new It(te,3)),a.geometry.setAttribute("size",new It(W,1)),a.geometry.setAttribute("phase",new It(Pe,1)),a.geometry.setAttribute("lifetime",new It(ae,1))},Q=()=>{if(!n.value||!o||!s)return;const z=n.value.clientWidth,j=n.value.clientHeight;s.left=z/-2,s.right=z/2,s.top=j/2,s.bottom=j/-2,s.updateProjectionMatrix(),o.setSize(z,j);const se=n.value.getBoundingClientRect();Re.left=se.left,Re.top=se.top,Re.width=z,Re.height=j};return kn(()=>{x(),window.addEventListener("resize",Q,{passive:!0}),document.addEventListener("visibilitychange",O)}),Sr(()=>{l&&cancelAnimationFrame(l),window.removeEventListener("resize",Q),document.removeEventListener("visibilitychange",O),h&&window.removeEventListener("mousemove",h),g&&window.removeEventListener("touchmove",g),p&&window.removeEventListener("touchend",p),v&&document.removeEventListener("mouseleave",v),m&&document.removeEventListener("mouseout",m),y&&window.removeEventListener("increase-particles",y),w&&window.removeEventListener("decrease-particles",w),E&&window.removeEventListener("reset-particles",E),L&&window.removeEventListener("rainbow-mode",L),C&&window.removeEventListener("firework",C),o&&(o.domElement&&(o.domElement.removeEventListener("webglcontextlost",le),o.domElement.removeEventListener("webglcontextrestored",me)),o.dispose(),n.value&&o.domElement&&n.value.contains(o.domElement)&&n.value.removeChild(o.domElement)),a&&(a.geometry&&a.geometry.dispose(),a.material&&a.material.dispose())}),(z,j)=>(oe(),ce("div",{ref_key:"container",ref:n,class:"ash-container"},[i.value?Je("",!0):(oe(),ce("div",m1))],512))}},_1=Wi(g1,[["__scopeId","data-v-19c14107"]]),v1={class:"font-sans flex flex-col min-h-screen bg-black relative app-container"},x1={class:"pt-0 flex flex-col space-y-16 md:space-y-64 relative z-10"},S1={__name:"App",setup(t){return(e,n)=>{const i=eu("router-view");return oe(),ce("div",v1,[n[0]||(n[0]=N("div",{class:"gradient-bg"},null,-1)),Ie(_1),Ie(rv,{class:"fixed top-0 left-0 w-full h-14 md:h-20"}),N("div",x1,[Ie(i),Ie(sx)])])}}},y1=Wi(S1,[["__scopeId","data-v-6db8d45d"]]),E1="modulepreload",M1=function(t){return"/2025/"+t},_d={},b1=function(e,n,i){let r=Promise.resolve();if(n&&n.length>0){let o=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));r=o(n.map(c=>{if(c=M1(c),c in _d)return;_d[c]=!0;const u=c.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${f}`))return;const d=document.createElement("link");if(d.rel=u?"stylesheet":E1,u||(d.as="script"),d.crossOrigin="",d.href=c,l&&d.setAttribute("nonce",l),document.head.appendChild(d),u)return new Promise((h,g)=>{d.addEventListener("load",h),d.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return r.then(o=>{for(const a of o||[])a.status==="rejected"&&s(a.reason);return e().catch(s)})},T1="/2025/assets/2025-Dbj42giJ.png",w1={__name:"FlameText",props:{text:{type:String,default:"Ember to Stars"},fontSize:{type:[Number,String],default:60}},setup(t){const e=Ut(null),n=Ut(!0);let i=null;return kn(()=>{i=new IntersectionObserver(r=>{r.forEach(s=>{n.value=s.isIntersecting})},{threshold:.1}),e.value&&i.observe(e.value)}),Sr(()=>{i&&e.value&&i.unobserve(e.value)}),(r,s)=>(oe(),ce("div",{ref_key:"fireTextRef",ref:e,class:On(["fire-text",{paused:!n.value}]),style:Fi({fontSize:typeof t.fontSize=="number"?t.fontSize+"px":t.fontSize})},rt(t.text),7))}},Nc=Wi(w1,[["__scopeId","data-v-30b61211"]]),A1={class:"min-h-screen flex items-center justify-center text-white relative"},R1={class:"flex flex-col items-center gap-y-4 relative z-10"},C1={class:"text-center"},P1={class:"text-center px-4 py-4 md:py-8"},D1={class:"flow flow-col space-y-4 md:space-y-8 select-none"},L1={__name:"Teaser2025",setup(t){const e=Ut(typeof window<"u"?window.innerWidth:1024),n=Ut(!1),i=at(()=>e.value<640?"50vw":"320px"),r=()=>{window.dispatchEvent(new CustomEvent("increase-particles")),n.value=!0,setTimeout(()=>{n.value=!1},600)},s=()=>{e.value=window.innerWidth};kn(()=>{window.addEventListener("resize",s)}),Sr(()=>{window.removeEventListener("resize",s)});const o=()=>{const c={title:"Let'Swift 2025",description:"Let'Swift 2025 Conference - iOS Swift Developer Conference",location:"세종대학교 컨벤션센터, 서울특별시 광진구",startDate:"20251124T100000",endDate:"20251124T180000",timestamp:new Date().toISOString().replace(/[-:]/g,"").split(".")[0]+"Z"};return`BEGIN:VCALENDAR
VERSION:2.0
...
`+s):i.stack=s}catch{}}throw i}}_request(e,n){typeof e=="string"?(n=n||{},n.url=e):n=e||{},n=vr(this.defaults,n);const{transitional:i,paramsSerializer:r,headers:s}=n;i!==void 0&&Wo.assertOptions(i,{silentJSONParsing:Wn.transitional(Wn.boolean),forcedJSONParsing:Wn.transitional(Wn.boolean),clarifyTimeoutError:Wn.transitional(Wn.boolean)},!1),r!=null&&(ne.isFunction(r)?n.paramsSerializer={serialize:r}:Wo.assertOptions(r,{encode:Wn.function,serialize:Wn.function},!0)),n.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?n.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:n.allowAbsoluteUrls=!0),Wo.assertOptions(n,{baseUrl:Wn.spelling("baseURL"),withXsrfToken:Wn.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let o=s&&ne.merge(s.common,s[n.method]);s&&ne.forEach(["delete","get","head","post","put","patch","common"],g=>{delete s[g]}),n.headers=cn.concat(o,s);const a=[];let l=!0;this.interceptors.request.forEach(function(v){typeof v.runWhen=="function"&&v.runWhen(n)===!1||(l=l&&v.synchronous,a.unshift(v.fulfilled,v.rejected))});const c=[];this.interceptors.response.forEach(function(v){c.push(v.fulfilled,v.rejected)});let u,f=0,d;if(!l){const g=[Cd.bind(this),void 0];for(g.unshift.apply(g,a),g.push.apply(g,c),d=g.length,u=Promise.resolve(n);f<d;)u=u.then(g[f++],g[f++]);return u}d=a.length;let h=n;for(f=0;f<d;){const g=a[f++],v=a[f++];try{h=g(h)}catch(m){v.call(this,m);break}}try{u=Cd.call(this,h)}catch(g){return Promise.reject(g)}for(f=0,d=c.length;f<d;)u=u.then(c[f++],c[f++]);return u}getUri(e){e=vr(this.defaults,e);const n=Jp(e.baseURL,e.url,e.allowAbsoluteUrls);return qp(n,e.params,e.paramsSerializer)}};ne.forEach(["delete","get","head","options"],function(e){pr.prototype[e]=function(n,i){return this.request(vr(i||{},{method:e,url:n,data:(i||{}).data}))}});ne.forEach(["post","put","patch"],function(e){function n(i){return function(s,o,a){return this.request(vr(a||{},{method:e,headers:i?{"Content-Type":"multipart/form-data"}:{},url:s,data:o}))}}pr.prototype[e]=n(),pr.prototype[e+"Form"]=n(!0)});let Ew=class rm{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(s){n=s});const i=this;this.promise.then(r=>{if(!i._listeners)return;let s=i._listeners.length;for(;s-- >0;)i._listeners[s](r);i._listeners=null}),this.promise.then=r=>{let s;const o=new Promise(a=>{i.subscribe(a),s=a}).then(r);return o.cancel=function(){i.unsubscribe(s)},o},e(function(s,o,a){i.reason||(i.reason=new rs(s,o,a),n(i.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const n=this._listeners.indexOf(e);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const e=new AbortController,n=i=>{e.abort(i)};return this.subscribe(n),e.signal.unsubscribe=()=>this.unsubscribe(n),e.signal}static source(){let e;return{token:new rm(function(r){e=r}),cancel:e}}};function Mw(t){return function(n){return t.apply(null,n)}}function bw(t){return ne.isObject(t)&&t.isAxiosError===!0}const Hc={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(Hc).forEach(([t,e])=>{Hc[e]=t});function sm(t){const e=new pr(t),n=Np(pr.prototype.request,e);return ne.extend(n,pr.prototype,e,{allOwnKeys:!0}),ne.extend(n,e,null,{allOwnKeys:!0}),n.create=function(r){return sm(vr(t,r))},n}const Mt=sm(Qs);Mt.Axios=pr;Mt.CanceledError=rs;Mt.CancelToken=Ew;Mt.isCancel=Kp;Mt.VERSION=im;Mt.toFormData=Ia;Mt.AxiosError=et;Mt.Cancel=Mt.CanceledError;Mt.all=function(e){return Promise.all(e)};Mt.spread=Mw;Mt.isAxiosError=bw;Mt.mergeConfig=vr;Mt.AxiosHeaders=cn;Mt.formToJSON=t=>Yp(ne.isHTMLForm(t)?new FormData(t):t);Mt.getAdapter=nm.getAdapter;Mt.HttpStatusCode=Hc;Mt.default=Mt;const{Axios:cR,AxiosError:uR,CanceledError:fR,isCancel:dR,CancelToken:hR,VERSION:pR,all:mR,Cancel:gR,isAxiosError:_R,spread:vR,toFormData:xR,AxiosHeaders:SR,HttpStatusCode:yR,formToJSON:ER,getAdapter:MR,mergeConfig:bR}=Mt,Tw={class:"flex justify-center"},ww={class:"px-8 xl:px-0 max-w-[1280px] space-y-48"},Aw={class:"space-y-32"},Rw={key:0,class:"flex flex-col gap-y-12"},Cw=["href"],Pw=["src"],Dw={key:1,class:"flex flex-col gap-y-12"},Lw=["href"],Iw=["src"],Uw={key:2,class:"flex flex-col gap-y-12"},Nw=["href"],Ow=["src"],Fw={key:0,class:"flex flex-col gap-y-12"},Bw={class:"grid sm:grid-cols-3 md:grid-cols-3 gap-x-12 gap-y-12 sm:gap-y-16"},kw={class:"flex flex-col gap-x-3 gap-y-6 items-center"},zw=["src"],Hw={class:"flex flex-col gap-y-2"},Vw={key:0,class:"text-zinc-400 text-sm font-semibold"},Gw={class:"flex gap-x-4 gap-y-4 justify-end pointer-cursor"},Ww=["href"],Xw=["href"],$w=["href"],qw=["href"],jw=["href"],Yw=["href"],Kw=["href"],Zw=["href"],Jw=["href"],Qw=["href"],eA=["href"],tA={key:1,class:"flex flex-col gap-y-12"},nA={class:"flex flex-row justify-center items-center space-x-16"},iA=["href"],rA=["src"],sA={__name:"Sponsors",setup(t){const e=Ut([]),n=Ut(null),i=Ut(!1);let r=null;const s=at(()=>e.value.filter(m=>m.tier==="Platinum"&&m.should_display===!0)),o=at(()=>e.value.filter(m=>m.tier==="Gold"&&m.should_display===!0)),a=at(()=>e.value.filter(m=>m.tier==="Silver"&&m.should_display===!0)),l=at(()=>e.value.filter(m=>m.tier==="dev_growth"&&m.should_display===!0)),c=at(()=>{const m=e.value.filter(p=>p.tier==="Individual"&&p.should_display===!0);return u(m)});kn(()=>{f(),r=new IntersectionObserver(m=>{m.forEach(p=>{i.value=p.isIntersecting,p.isIntersecting?window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!0}})):window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!1}}))})},{threshold:.3}),n.value&&r.observe(n.value)}),Sr(()=>{r&&n.value&&r.unobserve(n.value)});const u=m=>{const p=[...m];for(let y=p.length-1;y>0;y--){const w=Math.floor(Math.random()*(y+1));[p[y],p[w]]=[p[w],p[y]]}return p},f=async()=>{try{const p=await Mt.get("/2025/assets/json/sponsors.json");e.value=p.data}catch(m){console.error(m)}},d=m=>`/2025/assets/sponsors/${m}`,h=m=>{const p=["from-zinc-200 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400","from-zinc-100 to-zinc-400"];return p[m%p.length]},g=m=>{if(!i.value)return;const p=m.target;p.tagName==="BUTTON"||p.tagName==="A"||p.closest("button")||p.closest("a")||window.dispatchEvent(new CustomEvent("firework",{detail:{x:m.clientX,y:m.clientY}}))},v=()=>{window.location.href="mailto:letswift.official@gmail.com?subject=Let%27Swift%202025%20%ED%9B%84%EC%9B%90%20%EB%AC%B8%EC%9D%98%20%2F%20Sponsorship%20Inquiry"};return(m,p)=>(oe(),ce("div",{ref_key:"sponsorsSection",ref:n,class:"space-y-16 py-36 md:scroll-mt-28",onClick:g},[Ie(Zs,{title:"행사 후원"}),N("div",Tw,[N("div",ww,[N("div",Aw,[s.value.length!==0?(oe(),ce("div",Rw,[p[0]||(p[0]=N("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-slate-100 to-slate-400"},"플래티넘",-1)),(oe(!0),ce(ut,null,Rt(s.value,y=>(oe(),ce("div",{key:y.id,class:"flex flex-col items-center space-y-4 text-white"},[N("a",{href:y.social.web,target:"_blank",class:"pointer-cursor"},[N("img",{src:d(y.image_name),loading:"lazy",class:"w-full md:h-24 object-contain"},null,8,Pw)],8,Cw)]))),128))])):Je("",!0),o.value.length!==0?(oe(),ce("div",Dw,[p[1]||(p[1]=N("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-amber-100 to-amber-400"},"골드",-1)),(oe(!0),ce(ut,null,Rt(o.value,y=>(oe(),ce("div",{key:y.id,class:"flex flex-col items-center space-y-4 text-white"},[N("a",{href:y.social.web,target:"_blank",class:"pointer-cursor w-3/4"},[N("img",{src:d(y.image_name),loading:"lazy",class:"w-full h-20 object-contain"},null,8,Iw)],8,Lw)]))),128))])):Je("",!0),a.value.length!==0?(oe(),ce("div",Uw,[p[2]||(p[2]=N("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-zinc-300 to-zinc-600"},"실버",-1)),(oe(!0),ce(ut,null,Rt(a.value,y=>(oe(),ce("div",{key:y.id,class:"flex flex-col items-center space-y-4 text-white"},[N("a",{href:y.social.web,target:"_blank",class:"pointer-cursor w-2/3"},[N("img",{src:d(y.image_name),loading:"lazy",class:"w-full sm:h-24 object-contain"},null,8,Ow)],8,Nw)]))),128))])):Je("",!0)]),c.value.length!==0?(oe(),ce("div",Fw,[p[3]||(p[3]=N("div",{class:"font-bold text-lg md:text-xl text-rainbow"},"개인 후원",-1)),N("div",Bw,[(oe(!0),ce(ut,null,Rt(c.value,(y,w)=>(oe(),ce("div",{key:y.id,class:"items-center text-white"},[N("div",kw,[N("div",null,[N("img",{src:d(y.image_name),loading:"lazy",class:"bg-zinc-500 rounded-full w-24 h-24 object-cover"},null,8,zw)]),N("div",Hw,[N("div",{class:On(["font-bold text-lg bg-linear-to-br bg-clip-text text-transparent",h(w)])},rt(y.name),3),y.description?(oe(),ce("div",Vw,rt(y.description),1)):Je("",!0)]),N("div",Gw,[y.social.email?(oe(),ce("a",{key:0,href:`mailto:${y.social.email}`,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,Ww)):Je("",!0),y.social.web?(oe(),ce("a",{key:1,href:y.social.web,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,Xw)):Je("",!0),y.social.linkedin?(oe(),ce("a",{key:2,href:y.social.linkedin,target:"_blank"},[Ie($e(Ea),{fill:"gray",width:"16",height:"16"})],8,$w)):Je("",!0),y.social.instagram?(oe(),ce("a",{key:3,href:y.social.instagram,target:"_blank"},[Ie($e(ya),{fill:"gray",width:"16",height:"16"})],8,qw)):Je("",!0),y.social.facebook?(oe(),ce("a",{key:4,href:y.social.facebook,target:"_blank"},[Ie($e(ou),{fill:"gray",width:"16",height:"16"})],8,jw)):Je("",!0),y.social.github?(oe(),ce("a",{key:5,href:y.social.github,target:"_blank"},[Ie($e(Sa),{fill:"gray",width:"16",height:"16"})],8,Yw)):Je("",!0),y.social.youtube?(oe(),ce("a",{key:6,href:y.social.youtube,target:"_blank"},[Ie($e(ba),{fill:"gray",width:"16",height:"16"})],8,Kw)):Je("",!0),y.social.x?(oe(),ce("a",{key:7,href:y.social.x,target:"_blank"},[Ie($e(Ma),{fill:"gray",width:"16",height:"16"})],8,Zw)):Je("",!0),y.social.mastodon?(oe(),ce("a",{key:8,href:y.social.mastodon,target:"_blank"},[Ie($e(au),{fill:"gray",width:"16",height:"16"})],8,Jw)):Je("",!0),y.social.medium?(oe(),ce("a",{key:9,href:y.social.medium,target:"_blank"},[Ie($e(lu),{fill:"gray",width:"16",height:"16"})],8,Qw)):Je("",!0),y.social.thread?(oe(),ce("a",{key:10,href:y.social.thread,target:"_blank"},[Ie($e(cu),{fill:"gray",width:"16",height:"16"})],8,eA)):Je("",!0)])])]))),128))])])):Je("",!0),l.value.length!==0?(oe(),ce("div",tA,[p[4]||(p[4]=N("div",{class:"font-bold text-lg md:text-xl bg-linear-to-br bg-clip-text text-transparent from-green-300 to-green-600"},"개발자 성장",-1)),N("div",nA,[(oe(!0),ce(ut,null,Rt(l.value,y=>(oe(),ce("div",{key:y.id,class:"text-white w-1/3"},[N("a",{href:y.social.web,target:"_blank",class:"pointer-cursor"},[N("img",{src:d(y.image_name),loading:"lazy",class:"w-full sm:h-14 object-contain"},null,8,rA)],8,iA)]))),128))])])):Je("",!0),N("button",{onClick:v,class:"px-6 py-3 rounded-full cursor-pointer bg-themeMain/40 border border-themeMain/60 text-white text-lg font-bold hover:bg-themeMain/50 hover:border-themeMain/80 transition-all duration-200 active:bg-themeMain/60 select-none","aria-label":"Let'Swift 2025 후원 문의하기"}," 후원 문의 ")])])],512))}},oA={class:"flex justify-center"},aA={class:"px-8 xl:px-0 max-w-[1280px] flex flex-col gap-y-16 md:gap-y-32 w-full"},lA={class:"grid grid-cols-1 lg:grid-cols-1 gap-x-8 md:gap-x-16 gap-y-16 justify-center"},cA=["href"],uA=["src"],fA={class:"grid grid-cols-3 md:grid-cols-3 gap-x-8 md:gap-x-16 gap-y-16 justify-center"},dA=["src"],hA={class:"grid grid-cols-2 lg:grid-cols-2 gap-x-8 md:gap-x-16 gap-y-16 justify-center"},pA=["href"],mA=["src"],gA={__name:"SponsorsMini",setup(t){const e=Ut([]),n=Ut(null),i=Ut(!1);let r=null;const s=at(()=>e.value.filter(h=>h.tier!=="Individual"&&h.tier!=="dev_growth"&&h.should_display===!0)),o=at(()=>e.value.filter(h=>h.tier==="dev_growth"&&h.should_display===!0)),a=at(()=>{const h=e.value.filter(g=>g.tier==="Individual"&&g.should_display===!0);return l(h)});kn(()=>{c(),r=new IntersectionObserver(h=>{h.forEach(g=>{i.value=g.isIntersecting,g.isIntersecting?window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!0}})):window.dispatchEvent(new CustomEvent("rainbow-mode",{detail:{active:!1}}))})},{threshold:.3}),n.value&&r.observe(n.value)}),Sr(()=>{r&&n.value&&r.unobserve(n.value)});const l=h=>{const g=[...h];for(let v=g.length-1;v>0;v--){const m=Math.floor(Math.random()*(v+1));[g[v],g[m]]=[g[m],g[v]]}return g},c=async()=>{try{const g=await Mt.get("/2025/assets/json/sponsors.json");e.value=g.data}catch(h){console.error(h)}},u=h=>`/2025/assets/sponsors/${h}`,f=h=>{const g=["from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400","from-zinc-200 to-zinc-400"];return g[h%g.length]},d=h=>{if(!i.value)return;const g=h.target;g.tagName==="BUTTON"||g.tagName==="A"||g.closest("button")||g.closest("a")||window.dispatchEvent(new CustomEvent("firework",{detail:{x:h.clientX,y:h.clientY}}))};return(h,g)=>(oe(),ce("div",{ref_key:"sponsorsMiniSection",ref:n,class:"space-y-24 py-16",onClick:d},[g[0]||(g[0]=N("h3",{class:"font-medium text-4xl md:text-6xl text-rainbow text-cherishline leading-tight pb-2 pt-4"},"Special Thanks to",-1)),N("div",oA,[N("div",aA,[N("div",lA,[(oe(!0),ce(ut,null,Rt(s.value,v=>(oe(),ce("div",{key:v.id,class:"flex flex-col items-center text-white"},[N("a",{href:v.social.web,target:"_blank",class:"pointer-cursor"},[N("img",{src:u(v.image_name),loading:"lazy",class:"h-10 lg:h-16 object-contain"},null,8,uA)],8,cA)]))),128))]),N("div",fA,[(oe(!0),ce(ut,null,Rt(a.value,(v,m)=>(oe(),ce("div",{key:v.id,class:"flex flex-col gap-y-4 items-center text-white"},[N("img",{src:u(v.image_name),loading:"lazy",class:"bg-zinc-500 rounded-full w-16 h-16 object-cover"},null,8,dA),N("span",{class:On(["font-black font-mono text-xs md:text-sm bg-linear-to-br bg-clip-text text-transparent",f(m)])},rt(v.name),3)]))),128))]),N("div",hA,[(oe(!0),ce(ut,null,Rt(o.value,v=>(oe(),ce("div",{key:v.id,class:"flex flex-col items-center text-white"},[N("a",{href:v.social.web,target:"_blank",class:"pointer-cursor"},[N("img",{src:u(v.image_name),loading:"lazy",class:"h-8 lg:h-12 object-contain"},null,8,mA)],8,pA)]))),128))])])])],512))}},_A={class:"relative space-y-12 py-0 md:scroll-mt-28"},vA={class:"w-full space-y-8"},xA={class:"flex justify-center"},SA={class:"w-full px-8 xl:px-0 max-w-[1280px] space-y-4"},yA={key:0,class:"bg-white/30 w-full h-[480px] md:h-[720px] rounded-3xl overflow-hidden",style:{filter:"invert(90%) hue-rotate(180deg)"}},EA={__name:"Venue",setup(t){const e=Ut(2),n=()=>{typeof daum<"u"&&daum.roughmap&&daum.roughmap.Lander?new daum.roughmap.Lander({timestamp:"1728435092684",key:"2kudi",mapWidth:"1280",mapHeight:"720"}).render():console.error("Daum map library not loaded properly.")};kn(()=>{n()});const i=()=>{try{const o=r();s(o,"letswift-2025.ics")}catch(o){console.error("Failed to generate calendar file:",o),window.open("https://calendar.google.com/calendar/render?action=TEMPLATE&text=Let%27Swift%202025&dates=20251124T010000Z/20251124T090000Z&details=Let%27Swift%202025%20Conference&location=%EC%84%B8%EC%A2%85%EB%8C%80%ED%95%99%EA%B5%90%20%EA%B4%91%EA%B0%9C%ED%86%A0%EA%B4%80","_blank")}},r=()=>{const o={title:"Let'Swift 2025",description:"Let'Swift 2025 Conference - iOS Swift Developer Conference",location:"세종대학교 컨벤션센터, 서울특별시 광진구",startDate:"20251124T100000",endDate:"20251124T180000",timestamp:new Date().toISOString().replace(/[-:]/g,"").split(".")[0]+"Z"};return`BEGIN:VCALENDAR
VERSION:2.0
PRODID:-//Let'Swift//Let'Swift 2025//EN
CALSCALE:GREGORIAN
METHOD:PUBLISH
...
TRANSP:OPAQUE
END:VEVENT
END:VCALENDAR`},s=(o,a)=>{const l=new Blob([o],{type:"text/calendar;charset=utf-8"}),c=document.createElement("a");c.href=window.URL.createObjectURL(l),c.download=a,document.body.appendChild(c),c.click(),document.body.removeChild(c),window.URL.revokeObjectURL(c.href)};return(o,a)=>(oe(),ce("div",_A,[N("div",vA,[Ie(Zs,{title:"행사장"})]),N("div",xA,[N("div",SA,[e.value===2?(oe(),ce("div",yA,a[0]||(a[0]=[N("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3163.2102424479963!2d127.06830008511824!3d37.55011015299899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca4daa73c863f%3A0xd6bd626e0463b230!2z7IS47KKF64yA7ZWZ6rWQIOq0keqwnO2GoOq0gA!5e0!3m2!1sko!2skr!4v1728434846925!5m2!1sko!2skr",width:"1280",height:"720",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade",class:"hidden md:block h-[720px]"},null,-1),N("iframe",{src:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3163.2102424479963!2d127.06830008511824!3d37.55011015299899!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca4daa73c863f%3A0xd6bd626e0463b230!2z7IS47KKF64yA7ZWZ6rWQIOq0keqwnO2GoOq0gA!5e0!3m2!1sko!2skr!4v1728434846925!5m2!1sko!2skr",width:"720",height:"480",style:{border:"0"},allowfullscreen:"",loading:"lazy",referrerpolicy:"no-referrer-when-downgrade",class:"block md:hidden h-[480px]"},null,-1)]))):Je("",!0)])]),N("div",{class:"flex justify-center"},[N("div",{class:"w-full px-8 xl:px-0 max-w-[1280px] space-y-16"},[a[1]||(a[1]=Is('<div class="flex-col md:flex md:flex-row md:justify-between px-4 space-y-4"><div class="flex flex-col space-y-2 text-white font-bold text-justify"><div class="text-zinc-300 text-xl">세종대학교 컨벤션홀</div><div class="text-zinc-400 text-base font-bold">서울 광진구 능동로 209</div></div><div class="text-xl text-zinc-300 font-bold flex md:block"><span class="text-zinc-200">2025년 </span><span>11월 24일</span><span class="text-zinc-200"> 월요일</span></div></div>',1)),N("button",{onClick:i,class:"px-6 py-3 rounded-full cursor-pointer bg-red-500/40 border border-red-400/60 text-white text-lg font-bold hover:bg-red-500/50 hover:border-red-400/80 transition-all duration-200 active:bg-red-500/60 select-none","aria-label":"Let'Swift 2025 행사를 캘린더에 추가"}," 캘린더에 추가 ")])])]))}},MA={class:"flex flex-col text-base h-full justify-center overflow-hidden text-left text-ellipsis"},bA={key:0,class:"flex flex-col space-y-0 items-baseline px-2 sm:px-4 py-1 md:py-2"},TA={class:"font-bold text-sm text-zinc-300"},wA={key:0},AA={key:1,class:"flex gap-x-4 text-justify px-2 sm:px-4 py-2 md:py-1 drop-shadow-[0_23px_23px_rgba(0,0,0,0.75)] h-full"},RA={class:"flex flex-col items-baseline text-justify py-1 gap-y-0.5"},CA={class:"font-black text-xs sm:text-lg md:text-lg text-zinc-300 line-clamp-3 break-normal w-full text-left"},PA={class:"flex gap-x-2 items-baseline"},DA={class:"font-bold font-mono text-xs sm:text-sm md:text-sm text-zinc-200/80 text-left"},LA={class:"font-bold font-mono text-xs sm:text-xs text-zinc-300/60 text-left"},IA={key:0,class:"flex space-x-2"},UA={class:"font-black text-sm sm:text-sm md:text-base text-zinc-300/70"},NA={key:0,class:"font-semibold mr-2"},OA={key:1},FA={class:"text-xs sm:text-xs opacity-60"},BA={key:2},kA={key:0},zA={key:1},Dd={__name:"TimelineItem",props:["session"],setup(t){const e=t,n=at(()=>{const s=e.session;return s.type==="recess"||s.type==="lunch"}),i=s=>`${Math.floor(s/60)}분`,r=s=>{const o=new Date(s),a=o.getHours(),l=o.getMinutes(),c=a.toString().padStart(2,"0"),u=l.toString().padStart(2,"0");return`${c}:${u}`};return(s,o)=>(oe(),ce("div",MA,[n.value===!0?(oe(),ce("div",bA,[N("div",TA,rt(t.session.name),1),t.session.type==="lunch"?(oe(),ce("div",wA,o[0]||(o[0]=[N("div",{class:"flex flex-col text-xs text-zinc-500 py-4"},[N("div",null,"식사시 주의 사항"),N("div",null,"내부 음식물 섭취 안내: 컨퍼런스 내부에서 물 이외의 음식은 취식 불가입니다.")],-1)]))):Je("",!0)])):(oe(),ce("div",AA,[o[1]||(o[1]=N("div",{class:"bg-themeMain h-full w-1 rounded-full"},null,-1)),N("div",RA,[N("div",CA,rt(t.session.name),1),N("div",PA,[N("div",DA,rt(r(t.session.start_time))+" ~ "+rt(r(t.session.end_time)),1),N("div",LA,rt(i(t.session.duration)),1)]),t.session.speakers?(oe(),ce("div",IA,[(oe(!0),ce(ut,null,Rt(t.session.speakers,(a,l)=>(oe(),ce("div",UA,[l>0?(oe(),ce("span",NA,"&")):Je("",!0),a.nickname!==""&&a.name!==""?(oe(),ce("span",OA,[gn(rt(a.nickname)+" ",1),N("span",FA,rt(a.name),1)])):(oe(),ce("span",BA,[a.nickname!==""?(oe(),ce("span",kA,rt(a.nickname),1)):(oe(),ce("span",zA,rt(a.name),1))]))]))),256))])):Je("",!0)])]))]))}},HA={class:"flex flex-col gap-y-8 md:scroll-mt-28"},VA={class:"space-y-12"},GA={class:"flex justify-center"},WA={class:"w-full px-2 sm:px-8 py-2 xl:px-0 max-w-[1280px] space-y-12 xl:rounded-3xl"},XA={class:"text-white"},$A={class:"min-h-[250vh] sm:min-h-[300vh] md:min-h-[200vh] grid grid-rows-[repeat(56,1fr)] grid-cols-13 gap-1"},qA={class:"md:hidden"},jA={class:"hidden md:inline"},YA={__name:"Schedule",setup(t){const e=["09:00","10:00","11:00","12:00","13:00","14:00","15:00","16:00","17:00"],n=Ut([]),i=at(()=>n.value.filter(c=>c.track_en==="")),r=at(()=>n.value.filter(c=>c.track_en==="Track A").concat(i.value)),s=at(()=>n.value.filter(c=>c.track_en==="Track B").concat(i.value));kn(()=>{o()});const o=async()=>{try{const u=await Mt.get("/2025/assets/json/schedule.json");n.value=u.data}catch(c){console.error(c)}},a=(c,u)=>{let f=" ";return u===0?f+=" col-start-2 col-span-6":f+=" col-start-8 col-span-6",c.type==="entry"?f+=" bg-white/5 rounded-md":c.type==="recess"||c.type==="lunch"?f+=" ":(c.type==="opening"||c.type==="closing"||c.type==="networking"||c.track_en==="Track A"||c.track_en==="Track B")&&(f+=" bg-white/10 rounded-md"),f},l=c=>{let u="";const f=new Date(c.start_time),d=f.getHours(),h=f.getMinutes(),g=(d-9)*6+Math.ceil(h/10)+1+1,v=Math.ceil(c.duration/600),m=g+v;return u+=` grid-row-start: ${g}; grid-row-end: ${m};`,u};return(c,u)=>(oe(),ce("div",HA,[N("div",VA,[Ie(Zs,{title:"시간표"})]),u[1]||(u[1]=N("div",{class:"text-zinc-500 text-xs"},"상황에 따라 일정 및 세션 내용은 변경될 수 있습니다.",-1)),N("div",GA,[N("div",WA,[N("div",XA,[N("div",$A,[u[0]||(u[0]=Is('<div class="contents text-center font-bold text-lg md:text-xl"><div class="relative flex flex-col space-y-0 items-center justify-center col-start-2 col-span-6 row-start-0 row-span-1 bg-zinc-700/50 rounded-2xl"><div class="flex flex-col md:flex-row place-items-center md:place-items-baseline gap-x-2"><div class="text-sm md:text-xl">Track A</div><div class="text-xl md:text-3xl text-rainbow">EMBER</div></div><div class="text-xs text-zinc-500">홀 B</div></div><div class="flex flex-col space-y-0 items-center justify-center col-start-8 col-span-6 row-start-0 row-span-1 bg-zinc-700/50 rounded-2xl"><div class="flex flex-col md:flex-row place-items-center md:place-items-baseline gap-x-2"><div class="text-sm md:text-xl">Track B</div><div class="text-xl md:text-3xl text-rainbow">STAR</div></div><div class="text-xs text-zinc-500">홀 C</div></div></div>',1)),(oe(),ce(ut,null,Rt(e,(f,d)=>N("div",{class:"px-1 flex items-center justify-center bg-zinc-700/50 rounded-2xl col-start-1 col-span-1 row-span-6 font-mono font-semibold text-xs sm:text-sm md:text-lg",style:Fi(`grid-row-start: ${d*0}`)},[N("span",qA,rt(f.split(":")[0].replace(/^0/,"")),1),N("span",jA,rt(f),1)],4)),64)),(oe(!0),ce(ut,null,Rt(r.value,f=>(oe(),ce("div",{key:f.id,class:On(a(f,0)),style:Fi(l(f))},[Ie(Dd,{session:f},null,8,["session"])],6))),128)),(oe(!0),ce(ut,null,Rt(s.value,f=>(oe(),ce("div",{key:f.id,class:On(a(f,1)),style:Fi(l(f))},[Ie(Dd,{session:f},null,8,["session"])],6))),128))])])])])]))}},KA={class:"flex flex-col gap-y-8 items-end text-white"},ZA={class:"flex flex-col gap-y-8 items-end"},JA=["src"],QA={class:"flex flex-col gap-y-4 items-end text-end"},e2={key:0},t2={class:"font-bold text-lg md:text-xl"},n2={class:"font-bold text-sm md:text-base opacity-60"},i2={key:1},r2={key:0,class:"font-bold text-lg md:text-xl"},s2={key:1,class:"font-bold text-lg md:text-xl"},o2={class:"font-bold text-xs md:text-sm"},a2={class:"korean-text text-xs md:text-sm text-right text-pretty font-semibold text-zinc-300 opacity-90 max-w-80"},l2={class:"flex pt-2 gap-x-4 gap-y-4 justify-end pointer-cursor"},c2=["href"],u2=["href"],f2=["href"],d2=["href"],h2=["href"],p2=["href"],m2=["href"],g2=["href"],_2=["href"],v2=["href"],x2=["href"],S2={__name:"Speaker",props:["person"],setup(t){const e=n=>`/2025/assets/speakers/${n}`;return(n,i)=>(oe(),ce("div",KA,[N("div",ZA,[N("img",{src:e(t.person.image_name),loading:"lazy",class:"w-36 md:w-44 h-36 md:h-44 bg-white rounded-tl-full object-cover z-10"},null,8,JA),N("div",QA,[t.person.nickname!==""&&t.person.name!==""?(oe(),ce("div",e2,[N("div",t2,rt(t.person.nickname),1),N("div",n2,rt(t.person.name),1)])):(oe(),ce("div",i2,[t.person.nickname!==""?(oe(),ce("div",r2,rt(t.person.nickname),1)):(oe(),ce("div",s2,rt(t.person.name),1))])),N("div",o2,rt(t.person.affiliation),1),N("div",a2,rt(t.person.description),1),N("div",l2,[t.person.social.email?(oe(),ce("a",{key:0,href:`mailto:${t.person.social.email}`,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,c2)):Je("",!0),t.person.social.web?(oe(),ce("a",{key:1,href:t.person.social.web,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,u2)):Je("",!0),t.person.social.linkedin?(oe(),ce("a",{key:2,href:t.person.social.linkedin,target:"_blank"},[Ie($e(Ea),{fill:"gray",width:"16",height:"16"})],8,f2)):Je("",!0),t.person.social.instagram?(oe(),ce("a",{key:3,href:t.person.social.instagram,target:"_blank"},[Ie($e(ya),{fill:"gray",width:"16",height:"16"})],8,d2)):Je("",!0),t.person.social.facebook?(oe(),ce("a",{key:4,href:t.person.social.facebook,target:"_blank"},[Ie($e(ou),{fill:"gray",width:"16",height:"16"})],8,h2)):Je("",!0),t.person.social.github?(oe(),ce("a",{key:5,href:t.person.social.github,target:"_blank"},[Ie($e(Sa),{fill:"gray",width:"16",height:"16"})],8,p2)):Je("",!0),t.person.social.youtube?(oe(),ce("a",{key:6,href:t.person.social.youtube,target:"_blank"},[Ie($e(ba),{fill:"gray",width:"16",height:"16"})],8,m2)):Je("",!0),t.person.social.x?(oe(),ce("a",{key:7,href:t.person.social.x,target:"_blank"},[Ie($e(Ma),{fill:"gray",width:"16",height:"16"})],8,g2)):Je("",!0),t.person.social.mastodon?(oe(),ce("a",{key:8,href:t.person.social.mastodon,target:"_blank"},[Ie($e(au),{fill:"gray",width:"16",height:"16"})],8,_2)):Je("",!0),t.person.social.medium?(oe(),ce("a",{key:9,href:t.person.social.medium,target:"_blank"},[Ie($e(lu),{fill:"gray",width:"16",height:"16"})],8,v2)):Je("",!0),t.person.social.thread?(oe(),ce("a",{key:10,href:t.person.social.thread,target:"_blank"},[Ie($e(cu),{fill:"gray",width:"16",height:"16"})],8,x2)):Je("",!0)])])])]))}},y2=Wi(S2,[["__scopeId","data-v-875a9e5f"]]),E2={class:"flex flex-col space-y-12 md:space-y-36 md:scroll-mt-28"},M2={class:"flex justify-center"},b2={class:"px-8 xl:px-0 max-w-[1280px]"},T2={class:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-x-12 md:gap-x-24 gap-y-28"},w2={__name:"Speakers",setup(t){const e=Ut([]);kn(()=>{n()});const n=async()=>{try{const r=await Mt.get("/2025/assets/json/speakers.json");e.value=r.data}catch(i){console.error(i)}};return(i,r)=>(oe(),ce("div",E2,[Ie(Zs,{title:"연사 소개"}),N("div",M2,[N("div",b2,[N("div",T2,[(oe(!0),ce(ut,null,Rt(e.value,s=>(oe(),ce("div",{key:s.id},[Ie(y2,{person:s},null,8,["person"])]))),128))])])])]))}},A2={class:"flex flex-col gap-y-8 items-center"},R2={class:"relative w-36 md:w-44 h-36 md:h-44"},C2=["src"],P2={key:1,class:"absolute top-0 left-0 w-36 md:w-44 h-36 md:h-44 bg-zinc-200/50 rounded-full object-cover z-10"},D2={class:"flex flex-col gap-y-4 items-center text-center"},L2={key:0},I2={class:"font-bold text-lg md:text-xl"},U2={class:"font-bold text-sm md:text-base opacity-60"},N2={key:1},O2={key:0,class:"font-bold text-lg md:text-xl"},F2={key:1,class:"font-bold text-lg md:text-xl"},B2={class:"korean-text text-xs md:text-sm text-right text-pretty font-semibold text-zinc-300 opacity-90 max-w-80"},k2={class:"flex pt-2 gap-x-4 gap-y-4 justify-center pointer-cursor"},z2=["href"],H2=["href"],V2=["href"],G2=["href"],W2=["href"],X2=["href"],$2=["href"],q2=["href"],j2=["href"],Y2=["href"],K2=["href"],Z2={__name:"Organizer",props:["person"],setup(t){const e=t,n=Ut(!1),i=o=>`/2025/assets/organizers/${o}`,r="/2025/assets/organizers/muyaho.jpg",s=()=>{(e.person.nickname==="윌"||e.person.name==="윌")&&(console.log("그만큼 신나시는 거지~"),n.value=!0,setTimeout(()=>{n.value=!1},3e3))};return(o,a)=>(oe(),ce("div",{class:"flex flex-col gap-y-8 items-center text-white",onClick:s},[N("div",A2,[N("div",R2,[t.person.image_name?(oe(),ce("img",{key:0,src:i(t.person.image_name),loading:"lazy",class:"absolute top-0 left-0 w-36 md:w-44 h-36 md:h-44 bg-gradient-to-b from-zinc-300/10 to-zinc-300/20 rounded-full object-cover z-10"},null,8,C2)):(oe(),ce("img",P2)),n.value?(oe(),ce("img",{key:2,src:r,class:"absolute top-0 left-0 w-36 md:w-44 h-36 md:h-44 rounded-full object-cover z-20 overlay-animation"})):Je("",!0)]),N("div",D2,[t.person.nickname!==""&&t.person.name!==""?(oe(),ce("div",L2,[N("div",I2,rt(t.person.nickname),1),N("div",U2,rt(t.person.name),1)])):(oe(),ce("div",N2,[t.person.nickname!==""?(oe(),ce("div",O2,rt(t.person.nickname),1)):(oe(),ce("div",F2,rt(t.person.name),1))])),N("div",B2,rt(t.person.description),1),N("div",k2,[t.person.social.email?(oe(),ce("a",{key:0,href:`mailto:${t.person.social.email}`,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,z2)):Je("",!0),t.person.social.web?(oe(),ce("a",{key:1,href:t.person.social.web,target:"_blank"},[Ie($e(mr),{fill:"gray",width:"16",height:"16"})],8,H2)):Je("",!0),t.person.social.linkedin?(oe(),ce("a",{key:2,href:t.person.social.linkedin,target:"_blank"},[Ie($e(Ea),{fill:"gray",width:"16",height:"16"})],8,V2)):Je("",!0),t.person.social.instagram?(oe(),ce("a",{key:3,href:t.person.social.instagram,target:"_blank"},[Ie($e(ya),{fill:"gray",width:"16",height:"16"})],8,G2)):Je("",!0),t.person.social.facebook?(oe(),ce("a",{key:4,href:t.person.social.facebook,target:"_blank"},[Ie($e(ou),{fill:"gray",width:"16",height:"16"})],8,W2)):Je("",!0),t.person.social.github?(oe(),ce("a",{key:5,href:t.person.social.github,target:"_blank"},[Ie($e(Sa),{fill:"gray",width:"16",height:"16"})],8,X2)):Je("",!0),t.person.social.youtube?(oe(),ce("a",{key:6,href:t.person.social.youtube,target:"_blank"},[Ie($e(ba),{fill:"gray",width:"16",height:"16"})],8,$2)):Je("",!0),t.person.social.x?(oe(),ce("a",{key:7,href:t.person.social.x,target:"_blank"},[Ie($e(Ma),{fill:"gray",width:"16",height:"16"})],8,q2)):Je("",!0),t.person.social.mastodon?(oe(),ce("a",{key:8,href:t.person.social.mastodon,target:"_blank"},[Ie($e(au),{fill:"gray",width:"16",height:"16"})],8,j2)):Je("",!0),t.person.social.medium?(oe(),ce("a",{key:9,href:t.person.social.medium,target:"_blank"},[Ie($e(lu),{fill:"gray",width:"16",height:"16"})],8,Y2)):Je("",!0),t.person.social.thread?(oe(),ce("a",{key:10,href:t.person.social.thread,target:"_blank"},[Ie($e(cu),{fill:"gray",width:"16",height:"16"})],8,K2)):Je("",!0)])])])]))}},J2=Wi(Z2,[["__scopeId","data-v-63ffb987"]]),Q2={class:"flex flex-col space-y-12 md:space-y-36 md:scroll-mt-28"},eR={class:"flex justify-center"},tR={class:"px-8 xl:px-0 max-w-[1280px]"},nR={class:"grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-x-12 md:gap-x-24 gap-y-28"},iR={__name:"Organizers",setup(t){const e=Ut([]);kn(()=>{i()});const n=r=>{const s=[...r];for(let o=s.length-1;o>0;o--){const a=Math.floor(Math.random()*(o+1));[s[o],s[a]]=[s[a],s[o]]}return s},i=async()=>{try{const s=await Mt.get("/2025/assets/json/organizers.json");e.value=n(s.data)}catch(r){console.error(r)}};return(r,s)=>(oe(),ce("div",Q2,[Ie(Zs,{title:"준비위원회"}),N("div",eR,[N("div",tR,[N("div",nR,[(oe(!0),ce(ut,null,Rt(e.value,o=>(oe(),ce("div",{key:o.id},[Ie(J2,{person:o},null,8,["person"])]))),128))])])])]))}},rR={__name:"Home",setup(t){return(e,n)=>(oe(),ce(ut,null,[Ie(I1,{id:"hero"}),Ie(H1,{id:"intro"}),Ie(sA,{id:"sponsors"}),Ie(YA,{id:"schedule"}),Ie(w2,{id:"speakers"}),Ie(iR,{id:"organizers"}),Ie(EA,{id:"venue"}),Ie(gA,{id:"sponsorsMini"})],64))}},sR=[{path:"/",component:rR},{path:"/CodeOfConduct",component:()=>b1(()=>import("./CodeOfConduct-D66HLKkU.js"),[])}],oR=H0({history:m0("/2025/"),routes:sR}),om=O_(y1);om.use(oR);om.mount("#app");export{ut as F,Zs as _,Ie as a,N as b,ce as c,oe as o,Rt as r,rt as t};
