...
`)+`
`+p);const T=w+m+o,S=w+p+a,D=nd(r,r.VERTEX_SHADER,T),C=nd(r,r.FRAGMENT_SHADER,S);r.attachShader(_,D),r.attachShader(_,C),n.index0AttributeName!==void 0?r.bindAttribLocation(_,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function P(L){if(t.debug.checkShaderErrors){const F=r.getProgramInfoLog(_).trim(),H=r.getShaderInfoLog(D).trim(),Q=r.getShaderInfoLog(C).trim();let ce=!0,ee=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(ce=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,_,D,C);else{const ae=rd(r,D,"vertex"),V=rd(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
}`;function tb(t,e,n){let i=new wp;const r=new ct,s=new ct,o=new Rt,a=new RS({depthPacking:Fx}),l=new CS,c={},u=n.maxTextureSize,f={[Ii]:Qt,[Qt]:Ii,[ti]:ti},d=new ui({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ct},radius:{value:4}},vertexShader:Q1,fragmentShader:eb}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const g=new hi;g.setAttribute("position",new Lt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new ri(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ip;let p=this.type;this.render=function(C,P,O){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const b=t.getRenderTarget(),y=t.getActiveCubeFace(),L=t.getActiveMipmapLevel(),F=t.state;F.setBlending(Ci),F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const H=p!==Zn&&this.type===Zn,Q=p===Zn&&this.type!==Zn;for(let ce=0,ee=C.length;ce<ee;ce++){const ae=C[ce],V=ae.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",ae,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const Ee=V.getFrameExtents();if(r.multiply(Ee),s.copy(V.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Ee.x),r.x=s.x*Ee.x,V.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Ee.y),r.y=s.y*Ee.y,V.mapSize.y=s.y)),V.map===null||H===!0||Q===!0){const Ue=this.type!==Zn?{minFilter:Rn,magFilter:Rn}:{};V.map!==null&&V.map.dispose(),V.map=new or(r.x,r.y,Ue),V.map.texture.name=ae.name+".shadowMap",V.camera.updateProjectionMatrix()}t.setRenderTarget(V.map),t.clear();const Te=V.getViewportCount();for(let Ue=0;Ue<Te;Ue++){const ze=V.getViewport(Ue);o.set(s.x*ze.x,s.y*ze.y,s.x*ze.z,s.y*ze.w),F.viewport(o),V.updateMatrices(ae,Ue),i=V.getFrustum(),S(P,O,V.camera,ae,this.type)}V.isPointLightShadow!==!0&&this.type===Zn&&w(V,O),V.needsUpdate=!1}p=this.type,m.needsUpdate=!1,t.setRenderTarget(b,y,L)};function w(C,P){const O=e.update(_);d.defines.VSM_SAMPLES!==C.blurSamples&&(d.defines.VSM_SAMPLES=C.blurSamples,h.defines.VSM_SAMPLES=C.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new or(r.x,r.y)),d.uniforms.shadow_pass.value=C.map.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,t.setRenderTarget(C.mapPass),t.clear(),t.renderBufferDirect(P,null,O,d,_,null),h.uniforms.shadow_pass.value=C.mapPass.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,t.setRenderTarget(C.map),t.clear(),t.renderBufferDirect(P,null,O,h,_,null)}function T(C,P,O,b){let y=null;const L=O.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(L!==void 0)y=L;else if(y=O.isPointLight===!0?l:a,t.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const F=y.uuid,H=P.uuid;let Q=c[F];Q===void 0&&(Q={},c[F]=Q);let ce=Q[H];ce===void 0&&(ce=y.clone(),Q[H]=ce,P.addEventListener("dispose",D)),y=ce}if(y.visible=P.visible,y.wireframe=P.wireframe,b===Zn?y.side=P.shadowSide!==null?P.shadowSide:P.side:y.side=P.shadowSide!==null?P.shadowSide:f[P.side],y.alphaMap=P.alphaMap,y.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,y.map=P.map,y.clipShadows=P.clipShadows,y.clippingPlanes=P.clippingPlanes,y.clipIntersection=P.clipIntersection,y.displacementMap=P.displacementMap,y.displacementScale=P.displacementScale,y.displacementBias=P.displacementBias,y.wireframeLinewidth=P.wireframeLinewidth,y.linewidth=P.linewidth,O.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const F=t.properties.get(y);F.light=O}return y}function S(C,P,O,b,y){if(C.visible===!1)return;if(C.layers.test(P.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&y===Zn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,C.matrixWorld);const H=e.update(C),Q=C.material;if(Array.isArray(Q)){const ce=H.groups;for(let ee=0,ae=ce.length;ee<ae;ee++){const V=ce[ee],Ee=Q[V.materialIndex];if(Ee&&Ee.visible){const Te=T(C,Ee,b,y);C.onBeforeShadow(t,C,P,O,H,Te,V),t.renderBufferDirect(O,null,H,Te,C,V),C.onAfterShadow(t,C,P,O,H,Te,V)}}}else if(Q.visible){const ce=T(C,Q,b,y);C.onBeforeShadow(t,C,P,O,H,ce,null),t.renderBufferDirect(O,null,H,ce,C,null),C.onAfterShadow(t,C,P,O,H,ce,null)}}const F=C.children;for(let H=0,Q=F.length;H<Q;H++)S(F[H],P,O,b,y)}function D(C){C.target.removeEventListener("dispose",D);for(const O in c){const b=c[O],y=C.target.uuid;y in b&&(b[y].dispose(),delete b[y])}}}const nb={[Ol]:Fl,[Bl]:Hl,[kl]:Vl,[Br]:zl,[Fl]:Ol,[Hl]:Bl,[Vl]:kl,[zl]:Br};function ib(t,e){function n(){let U=!1;const Re=new Rt;let pe=null;const Oe=new Rt(0,0,0,0);return{setMask:function(ge){pe!==ge&&!U&&(t.colorMask(ge,ge,ge,ge),pe=ge)},setLocked:function(ge){U=ge},setClear:function(ge,de,Fe,Ye,St){St===!0&&(ge*=Ye,de*=Ye,Fe*=Ye),Re.set(ge,de,Fe,Ye),Oe.equals(Re)===!1&&(t.clearColor(ge,de,Fe,Ye),Oe.copy(Re))},reset:function(){U=!1,pe=null,Oe.set(-1,0,0,0)}}}function i(){let U=!1,Re=!1,pe=null,Oe=null,ge=null;return{setReversed:function(de){if(Re!==de){const Fe=e.get("EXT_clip_control");de?Fe.clipControlEXT(Fe.LOWER_LEFT_EXT,Fe.ZERO_TO_ONE_EXT):Fe.clipControlEXT(Fe.LOWER_LEFT_EXT,Fe.NEGATIVE_ONE_TO_ONE_EXT),Re=de;const Ye=ge;ge=null,this.setClear(Ye)}},getReversed:function(){return Re},setTest:function(de){de?N(t.DEPTH_TEST):oe(t.DEPTH_TEST)},setMask:function(de){pe!==de&&!U&&(t.depthMask(de),pe=de)},setFunc:function(de){if(Re&&(de=nb[de]),Oe!==de){switch(de){case Ol:t.depthFunc(t.NEVER);break;case Fl:t.depthFunc(t.ALWAYS);break;case Bl:t.depthFunc(t.LESS);break;case Br:t.depthFunc(t.LEQUAL);break;case kl:t.depthFunc(t.EQUAL);break;case zl:t.depthFunc(t.GEQUAL);break;case Hl:t.depthFunc(t.GREATER);break;case Vl:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}Oe=de}},setLocked:function(de){U=de},setClear:function(de){ge!==de&&(Re&&(de=1-de),t.clearDepth(de),ge=de)},reset:function(){U=!1,pe=null,Oe=null,ge=null,Re=!1}}}function r(){let U=!1,Re=null,pe=null,Oe=null,ge=null,de=null,Fe=null,Ye=null,St=null;return{setTest:function(ft){U||(ft?N(t.STENCIL_TEST):oe(t.STENCIL_TEST))},setMask:function(ft){Re!==ft&&!U&&(t.stencilMask(ft),Re=ft)},setFunc:function(ft,Sn,Vn){(pe!==ft||Oe!==Sn||ge!==Vn)&&(t.stencilFunc(ft,Sn,Vn),pe=ft,Oe=Sn,ge=Vn)},setOp:function(ft,Sn,Vn){(de!==ft||Fe!==Sn||Ye!==Vn)&&(t.stencilOp(ft,Sn,Vn),de=ft,Fe=Sn,Ye=Vn)},setLocked:function(ft){U=ft},setClear:function(ft){St!==ft&&(t.clearStencil(ft),St=ft)},reset:function(){U=!1,Re=null,pe=null,Oe=null,ge=null,de=null,Fe=null,Ye=null,St=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},f={},d=new WeakMap,h=[],g=null,_=!1,m=null,p=null,w=null,T=null,S=null,D=null,C=null,P=new pt(0,0,0),O=0,b=!1,y=null,L=null,F=null,H=null,Q=null;const ce=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ee=!1,ae=0;const V=t.getParameter(t.VERSION);V.indexOf("WebGL")!==-1?(ae=parseFloat(/^WebGL (\d)/.exec(V)[1]),ee=ae>=1):V.indexOf("OpenGL ES")!==-1&&(ae=parseFloat(/^OpenGL ES (\d)/.exec(V)[1]),ee=ae>=2);let Ee=null,Te={};const Ue=t.getParameter(t.SCISSOR_BOX),ze=t.getParameter(t.VIEWPORT),et=new Rt().fromArray(Ue),j=new Rt().fromArray(ze);function he(U,Re,pe,Oe){const ge=new Uint8Array(4),de=t.createTexture();t.bindTexture(U,de),t.texParameteri(U,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(U,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Fe=0;Fe<pe;Fe++)U===t.TEXTURE_3D||U===t.TEXTURE_2D_ARRAY?t.texImage3D(Re,0,t.RGBA,1,1,Oe,0,t.RGBA,t.UNSIGNED_BYTE,ge):t.texImage2D(Re+Fe,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ge);return de}const we={};we[t.TEXTURE_2D]=he(t.TEXTURE_2D,t.TEXTURE_2D,1),we[t.TEXTURE_CUBE_MAP]=he(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),we[t.TEXTURE_2D_ARRAY]=he(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),we[t.TEXTURE_3D]=he(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),N(t.DEPTH_TEST),o.setFunc(Br),k(!1),W(gf),N(t.CULL_FACE),x(Ci);function N(U){u[U]!==!0&&(t.enable(U),u[U]=!0)}function oe(U){u[U]!==!1&&(t.disable(U),u[U]=!1)}function fe(U,Re){return f[U]!==Re?(t.bindFramebuffer(U,Re),f[U]=Re,U===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=Re),U===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=Re),!0):!1}function ue(U,Re){let pe=h,Oe=!1;if(U){pe=d.get(Re),pe===void 0&&(pe=[],d.set(Re,pe));const ge=U.textures;if(pe.length!==ge.length||pe[0]!==t.COLOR_ATTACHMENT0){for(let de=0,Fe=ge.length;de<Fe;de++)pe[de]=t.COLOR_ATTACHMENT0+de;pe.length=ge.length,Oe=!0}}else pe[0]!==t.BACK&&(pe[0]=t.BACK,Oe=!0);Oe&&t.drawBuffers(pe)}function ke(U){return g!==U?(t.useProgram(U),g=U,!0):!1}const A={[Zi]:t.FUNC_ADD,[cx]:t.FUNC_SUBTRACT,[ux]:t.FUNC_REVERSE_SUBTRACT};A[fx]=t.MIN,A[dx]=t.MAX;const R={[hx]:t.ZERO,[px]:t.ONE,[mx]:t.SRC_COLOR,[Ul]:t.SRC_ALPHA,[yx]:t.SRC_ALPHA_SATURATE,[xx]:t.DST_COLOR,[_x]:t.DST_ALPHA,[gx]:t.ONE_MINUS_SRC_COLOR,[Nl]:t.ONE_MINUS_SRC_ALPHA,[Sx]:t.ONE_MINUS_DST_COLOR,[vx]:t.ONE_MINUS_DST_ALPHA,[Ex]:t.CONSTANT_COLOR,[Mx]:t.ONE_MINUS_CONSTANT_COLOR,[bx]:t.CONSTANT_ALPHA,[Tx]:t.ONE_MINUS_CONSTANT_ALPHA};function x(U,Re,pe,Oe,ge,de,Fe,Ye,St,ft){if(U===Ci){_===!0&&(oe(t.BLEND),_=!1);return}if(_===!1&&(N(t.BLEND),_=!0),U!==lx){if(U!==m||ft!==b){if((p!==Zi||S!==Zi)&&(t.blendEquation(t.FUNC_ADD),p=Zi,S=Zi),ft)switch(U){case Ir:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Il:t.blendFunc(t.ONE,t.ONE);break;case _f:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case vf:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Ir:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Il:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case _f:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case vf:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}w=null,T=null,D=null,C=null,P.set(0,0,0),O=0,m=U,b=ft}return}ge=ge||Re,de=de||pe,Fe=Fe||Oe,(Re!==p||ge!==S)&&(t.blendEquationSeparate(A[Re],A[ge]),p=Re,S=ge),(pe!==w||Oe!==T||de!==D||Fe!==C)&&(t.blendFuncSeparate(R[pe],R[Oe],R[de],R[Fe]),w=pe,T=Oe,D=de,C=Fe),(Ye.equals(P)===!1||St!==O)&&(t.blendColor(Ye.r,Ye.g,Ye.b,St),P.copy(Ye),O=St),m=U,b=!1}function ie(U,Re){U.side===ti?oe(t.CULL_FACE):N(t.CULL_FACE);let pe=U.side===Qt;Re&&(pe=!pe),k(pe),U.blending===Ir&&U.transparent===!1?x(Ci):x(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const Oe=U.stencilWrite;a.setTest(Oe),Oe&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),re(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?N(t.SAMPLE_ALPHA_TO_COVERAGE):oe(t.SAMPLE_ALPHA_TO_COVERAGE)}function k(U){y!==U&&(U?t.frontFace(t.CW):t.frontFace(t.CCW),y=U)}function W(U){U!==sx?(N(t.CULL_FACE),U!==L&&(U===gf?t.cullFace(t.BACK):U===ox?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):oe(t.CULL_FACE),L=U}function G(U){U!==F&&(ee&&t.lineWidth(U),F=U)}function re(U,Re,pe){U?(N(t.POLYGON_OFFSET_FILL),(H!==Re||Q!==pe)&&(t.polygonOffset(Re,pe),H=Re,Q=pe)):oe(t.POLYGON_OFFSET_FILL)}function Y(U){U?N(t.SCISSOR_TEST):oe(t.SCISSOR_TEST)}function te(U){U===void 0&&(U=t.TEXTURE0+ce-1),Ee!==U&&(t.activeTexture(U),Ee=U)}function Ae(U,Re,pe){pe===void 0&&(Ee===null?pe=t.TEXTURE0+ce-1:pe=Ee);let Oe=Te[pe];Oe===void 0&&(Oe={type:void 0,texture:void 0},Te[pe]=Oe),(Oe.type!==U||Oe.texture!==Re)&&(Ee!==pe&&(t.activeTexture(pe),Ee=pe),t.bindTexture(U,Re||we[U]),Oe.type=U,Oe.texture=Re)}function E(){const U=Te[Ee];U!==void 0&&U.type!==void 0&&(t.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function v(){try{t.compressedTexImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function I(){try{t.compressedTexImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function q(){try{t.texSubImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function se(){try{t.texSubImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function X(){try{t.compressedTexSubImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Pe(){try{t.compressedTexSubImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ve(){try{t.texStorage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ye(){try{t.texStorage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function xe(){try{t.texImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function le(){try{t.texImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function be(U){et.equals(U)===!1&&(t.scissor(U.x,U.y,U.z,U.w),et.copy(U))}function Ie(U){j.equals(U)===!1&&(t.viewport(U.x,U.y,U.z,U.w),j.copy(U))}function Le(U,Re){let pe=c.get(Re);pe===void 0&&(pe=new WeakMap,c.set(Re,pe));let Oe=pe.get(U);Oe===void 0&&(Oe=t.getUniformBlockIndex(Re,U.name),pe.set(U,Oe))}function Me(U,Re){const Oe=c.get(Re).get(U);l.get(Re)!==Oe&&(t.uniformBlockBinding(Re,Oe,U.__bindingPointIndex),l.set(Re,Oe))}function Xe(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),u={},Ee=null,Te={},f={},d=new WeakMap,h=[],g=null,_=!1,m=null,p=null,w=null,T=null,S=null,D=null,C=null,P=new pt(0,0,0),O=0,b=!1,y=null,L=null,F=null,H=null,Q=null,et.set(0,0,t.canvas.width,t.canvas.height),j.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:N,disable:oe,bindFramebuffer:fe,drawBuffers:ue,useProgram:ke,setBlending:x,setMaterial:ie,setFlipSided:k,setCullFace:W,setLineWidth:G,setPolygonOffset:re,setScissorTest:Y,activeTexture:te,bindTexture:Ae,unbindTexture:E,compressedTexImage2D:v,compressedTexImage3D:I,texImage2D:xe,texImage3D:le,updateUBOMapping:Le,uniformBlockBinding:Me,texStorage2D:ve,texStorage3D:ye,texSubImage2D:q,texSubImage3D:se,compressedTexSubImage2D:X,compressedTexSubImage3D:Pe,scissor:be,viewport:Ie,reset:Xe}}function rb(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ct,u=new WeakMap;let f;const d=new WeakMap;let h=!1;try{h=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,v){return h?new OffscreenCanvas(E,v):$o("canvas")}function _(E,v,I){let q=1;const se=Ae(E);if((se.width>I||se.height>I)&&(q=I/Math.max(se.width,se.height)),q<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const X=Math.floor(q*se.width),Pe=Math.floor(q*se.height);f===void 0&&(f=g(X,Pe));const ve=v?g(X,Pe):f;return ve.width=X,ve.height=Pe,ve.getContext("2d").drawImage(E,0,0,X,Pe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+se.width+"x"+se.height+") to ("+X+"x"+Pe+")."),ve}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+se.width+"x"+se.height+")."),E;return E}function m(E){return E.generateMipmaps}function p(E){t.generateMipmap(E)}function w(E){return E.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?t.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function T(E,v,I,q,se=!1){if(E!==null){if(t[E]!==void 0)return t[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let X=v;if(v===t.RED&&(I===t.FLOAT&&(X=t.R32F),I===t.HALF_FLOAT&&(X=t.R16F),I===t.UNSIGNED_BYTE&&(X=t.R8)),v===t.RED_INTEGER&&(I===t.UNSIGNED_BYTE&&(X=t.R8UI),I===t.UNSIGNED_SHORT&&(X=t.R16UI),I===t.UNSIGNED_INT&&(X=t.R32UI),I===t.BYTE&&(X=t.R8I),I===t.SHORT&&(X=t.R16I),I===t.INT&&(X=t.R32I)),v===t.RG&&(I===t.FLOAT&&(X=t.RG32F),I===t.HALF_FLOAT&&(X=t.RG16F),I===t.UNSIGNED_BYTE&&(X=t.RG8)),v===t.RG_INTEGER&&(I===t.UNSIGNED_BYTE&&(X=t.RG8UI),I===t.UNSIGNED_SHORT&&(X=t.RG16UI),I===t.UNSIGNED_INT&&(X=t.RG32UI),I===t.BYTE&&(X=t.RG8I),I===t.SHORT&&(X=t.RG16I),I===t.INT&&(X=t.RG32I)),v===t.RGB_INTEGER&&(I===t.UNSIGNED_BYTE&&(X=t.RGB8UI),I===t.UNSIGNED_SHORT&&(X=t.RGB16UI),I===t.UNSIGNED_INT&&(X=t.RGB32UI),I===t.BYTE&&(X=t.RGB8I),I===t.SHORT&&(X=t.RGB16I),I===t.INT&&(X=t.RGB32I)),v===t.RGBA_INTEGER&&(I===t.UNSIGNED_BYTE&&(X=t.RGBA8UI),I===t.UNSIGNED_SHORT&&(X=t.RGBA16UI),I===t.UNSIGNED_INT&&(X=t.RGBA32UI),I===t.BYTE&&(X=t.RGBA8I),I===t.SHORT&&(X=t.RGBA16I),I===t.INT&&(X=t.RGBA32I)),v===t.RGB&&I===t.UNSIGNED_INT_5_9_9_9_REV&&(X=t.RGB9_E5),v===t.RGBA){const Pe=se?Wo:rt.getTransfer(q);I===t.FLOAT&&(X=t.RGBA32F),I===t.HALF_FLOAT&&(X=t.RGBA16F),I===t.UNSIGNED_BYTE&&(X=Pe===gt?t.SRGB8_ALPHA8:t.RGBA8),I===t.UNSIGNED_SHORT_4_4_4_4&&(X=t.RGBA4),I===t.UNSIGNED_SHORT_5_5_5_1&&(X=t.RGB5_A1)}return(X===t.R16F||X===t.R32F||X===t.RG16F||X===t.RG32F||X===t.RGBA16F||X===t.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function S(E,v){let I;return E?v===null||v===sr||v===Rs?I=t.DEPTH24_STENCIL8:v===ni?I=t.DEPTH32F_STENCIL8:v===As&&(I=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===sr||v===Rs?I=t.DEPTH_COMPONENT24:v===ni?I=t.DEPTH_COMPONENT32F:v===As&&(I=t.DEPTH_COMPONENT16),I}function D(E,v){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==Rn&&E.minFilter!==kn?Math.log2(Math.max(v.width,v.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?v.mipmaps.length:1}function C(E){const v=E.target;v.removeEventListener("dispose",C),O(v),v.isVideoTexture&&u.delete(v)}function P(E){const v=E.target;v.removeEventListener("dispose",P),y(v)}function O(E){const v=i.get(E);if(v.__webglInit===void 0)return;const I=E.source,q=d.get(I);if(q){const se=q[v.__cacheKey];se.usedTimes--,se.usedTimes===0&&b(E),Object.keys(q).length===0&&d.delete(I)}i.remove(E)}function b(E){const v=i.get(E);t.deleteTexture(v.__webglTexture);const I=E.source,q=d.get(I);delete q[v.__cacheKey],o.memory.textures--}function y(E){const v=i.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),i.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(v.__webglFramebuffer[q]))for(let se=0;se<v.__webglFramebuffer[q].length;se++)t.deleteFramebuffer(v.__webglFramebuffer[q][se]);else t.deleteFramebuffer(v.__webglFramebuffer[q]);v.__webglDepthbuffer&&t.deleteRenderbuffer(v.__webglDepthbuffer[q])}else{if(Array.isArray(v.__webglFramebuffer))for(let q=0;q<v.__webglFramebuffer.length;q++)t.deleteFramebuffer(v.__webglFramebuffer[q]);else t.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&t.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&t.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let q=0;q<v.__webglColorRenderbuffer.length;q++)v.__webglColorRenderbuffer[q]&&t.deleteRenderbuffer(v.__webglColorRenderbuffer[q]);v.__webglDepthRenderbuffer&&t.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const I=E.textures;for(let q=0,se=I.length;q<se;q++){const X=i.get(I[q]);X.__webglTexture&&(t.deleteTexture(X.__webglTexture),o.memory.textures--),i.remove(I[q])}i.remove(E)}let L=0;function F(){L=0}function H(){const E=L;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),L+=1,E}function Q(E){const v=[];return v.push(E.wrapS),v.push(E.wrapT),v.push(E.wrapR||0),v.push(E.magFilter),v.push(E.minFilter),v.push(E.anisotropy),v.push(E.internalFormat),v.push(E.format),v.push(E.type),v.push(E.generateMipmaps),v.push(E.premultiplyAlpha),v.push(E.flipY),v.push(E.unpackAlignment),v.push(E.colorSpace),v.join()}function ce(E,v){const I=i.get(E);if(E.isVideoTexture&&Y(E),E.isRenderTargetTexture===!1&&E.version>0&&I.__version!==E.version){const q=E.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{we(I,E,v);return}}n.bindTexture(t.TEXTURE_2D,I.__webglTexture,t.TEXTURE0+v)}function ee(E,v){const I=i.get(E);if(E.version>0&&I.__version!==E.version){we(I,E,v);return}n.bindTexture(t.TEXTURE_2D_ARRAY,I.__webglTexture,t.TEXTURE0+v)}function ae(E,v){const I=i.get(E);if(E.version>0&&I.__version!==E.version){we(I,E,v);return}n.bindTexture(t.TEXTURE_3D,I.__webglTexture,t.TEXTURE0+v)}function V(E,v){const I=i.get(E);if(E.version>0&&I.__version!==E.version){N(I,E,v);return}n.bindTexture(t.TEXTURE_CUBE_MAP,I.__webglTexture,t.TEXTURE0+v)}const Ee={[Xl]:t.REPEAT,[Qi]:t.CLAMP_TO_EDGE,[$l]:t.MIRRORED_REPEAT},Te={[Rn]:t.NEAREST,[Nx]:t.NEAREST_MIPMAP_NEAREST,[js]:t.NEAREST_MIPMAP_LINEAR,[kn]:t.LINEAR,[Ba]:t.LINEAR_MIPMAP_NEAREST,[er]:t.LINEAR_MIPMAP_LINEAR},Ue={[zx]:t.NEVER,[$x]:t.ALWAYS,[Hx]:t.LESS,[pp]:t.LEQUAL,[Vx]:t.EQUAL,[Xx]:t.GEQUAL,[Gx]:t.GREATER,[Wx]:t.NOTEQUAL};function ze(E,v){if(v.type===ni&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===kn||v.magFilter===Ba||v.magFilter===js||v.magFilter===er||v.minFilter===kn||v.minFilter===Ba||v.minFilter===js||v.minFilter===er)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(E,t.TEXTURE_WRAP_S,Ee[v.wrapS]),t.texParameteri(E,t.TEXTURE_WRAP_T,Ee[v.wrapT]),(E===t.TEXTURE_3D||E===t.TEXTURE_2D_ARRAY)&&t.texParameteri(E,t.TEXTURE_WRAP_R,Ee[v.wrapR]),t.texParameteri(E,t.TEXTURE_MAG_FILTER,Te[v.magFilter]),t.texParameteri(E,t.TEXTURE_MIN_FILTER,Te[v.minFilter]),v.compareFunction&&(t.texParameteri(E,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(E,t.TEXTURE_COMPARE_FUNC,Ue[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Rn||v.minFilter!==js&&v.minFilter!==er||v.type===ni&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");t.texParameterf(E,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function et(E,v){let I=!1;E.__webglInit===void 0&&(E.__webglInit=!0,v.addEventListener("dispose",C));const q=v.source;let se=d.get(q);se===void 0&&(se={},d.set(q,se));const X=Q(v);if(X!==E.__cacheKey){se[X]===void 0&&(se[X]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,I=!0),se[X].usedTimes++;const Pe=se[E.__cacheKey];Pe!==void 0&&(se[E.__cacheKey].usedTimes--,Pe.usedTimes===0&&b(v)),E.__cacheKey=X,E.__webglTexture=se[X].texture}return I}function j(E,v,I){return Math.floor(Math.floor(E/I)/v)}function he(E,v,I,q){const X=E.updateRanges;if(X.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,v.width,v.height,I,q,v.data);else{X.sort((le,be)=>le.start-be.start);let Pe=0;for(let le=1;le<X.length;le++){const be=X[Pe],Ie=X[le],Le=be.start+be.count,Me=j(Ie.start,v.width,4),Xe=j(be.start,v.width,4);Ie.start<=Le+1&&Me===Xe&&j(Ie.start+Ie.count-1,v.width,4)===Me?be.count=Math.max(be.count,Ie.start+Ie.count-be.start):(++Pe,X[Pe]=Ie)}X.length=Pe+1;const ve=t.getParameter(t.UNPACK_ROW_LENGTH),ye=t.getParameter(t.UNPACK_SKIP_PIXELS),xe=t.getParameter(t.UNPACK_SKIP_ROWS);t.pixelStorei(t.UNPACK_ROW_LENGTH,v.width);for(let le=0,be=X.length;le<be;le++){const Ie=X[le],Le=Math.floor(Ie.start/4),Me=Math.ceil(Ie.count/4),Xe=Le%v.width,U=Math.floor(Le/v.width),Re=Me,pe=1;t.pixelStorei(t.UNPACK_SKIP_PIXELS,Xe),t.pixelStorei(t.UNPACK_SKIP_ROWS,U),n.texSubImage2D(t.TEXTURE_2D,0,Xe,U,Re,pe,I,q,v.data)}E.clearUpdateRanges(),t.pixelStorei(t.UNPACK_ROW_LENGTH,ve),t.pixelStorei(t.UNPACK_SKIP_PIXELS,ye),t.pixelStorei(t.UNPACK_SKIP_ROWS,xe)}}function we(E,v,I){let q=t.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(q=t.TEXTURE_2D_ARRAY),v.isData3DTexture&&(q=t.TEXTURE_3D);const se=et(E,v),X=v.source;n.bindTexture(q,E.__webglTexture,t.TEXTURE0+I);const Pe=i.get(X);if(X.version!==Pe.__version||se===!0){n.activeTexture(t.TEXTURE0+I);const ve=rt.getPrimaries(rt.workingColorSpace),ye=v.colorSpace===wi?null:rt.getPrimaries(v.colorSpace),xe=v.colorSpace===wi||ve===ye?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,v.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,v.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);let le=_(v.image,!1,r.maxTextureSize);le=te(v,le);const be=s.convert(v.format,v.colorSpace),Ie=s.convert(v.type);let Le=T(v.internalFormat,be,Ie,v.colorSpace,v.isVideoTexture);ze(q,v);let Me;const Xe=v.mipmaps,U=v.isVideoTexture!==!0,Re=Pe.__version===void 0||se===!0,pe=X.dataReady,Oe=D(v,le);if(v.isDepthTexture)Le=S(v.format===Ps,v.type),Re&&(U?n.texStorage2D(t.TEXTURE_2D,1,Le,le.width,le.height):n.texImage2D(t.TEXTURE_2D,0,Le,le.width,le.height,0,be,Ie,null));else if(v.isDataTexture)if(Xe.length>0){U&&Re&&n.texStorage2D(t.TEXTURE_2D,Oe,Le,Xe[0].width,Xe[0].height);for(let ge=0,de=Xe.length;ge<de;ge++)Me=Xe[ge],U?pe&&n.texSubImage2D(t.TEXTURE_2D,ge,0,0,Me.width,Me.height,be,Ie,Me.data):n.texImage2D(t.TEXTURE_2D,ge,Le,Me.width,Me.height,0,be,Ie,Me.data);v.generateMipmaps=!1}else U?(Re&&n.texStorage2D(t.TEXTURE_2D,Oe,Le,le.width,le.height),pe&&he(v,le,be,Ie)):n.texImage2D(t.TEXTURE_2D,0,Le,le.width,le.height,0,be,Ie,le.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){U&&Re&&n.texStorage3D(t.TEXTURE_2D_ARRAY,Oe,Le,Xe[0].width,Xe[0].height,le.depth);for(let ge=0,de=Xe.length;ge<de;ge++)if(Me=Xe[ge],v.format!==wn)if(be!==null)if(U){if(pe)if(v.layerUpdates.size>0){const Fe=Hf(Me.width,Me.height,v.format,v.type);for(const Ye of v.layerUpdates){const St=Me.data.subarray(Ye*Fe/Me.data.BYTES_PER_ELEMENT,(Ye+1)*Fe/Me.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ge,0,0,Ye,Me.width,Me.height,1,be,St)}v.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ge,0,0,0,Me.width,Me.height,le.depth,be,Me.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ge,Le,Me.width,Me.height,le.depth,0,Me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?pe&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ge,0,0,0,Me.width,Me.height,le.depth,be,Ie,Me.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ge,Le,Me.width,Me.height,le.depth,0,be,Ie,Me.data)}else{U&&Re&&n.texStorage2D(t.TEXTURE_2D,Oe,Le,Xe[0].width,Xe[0].height);for(let ge=0,de=Xe.length;ge<de;ge++)Me=Xe[ge],v.format!==wn?be!==null?U?pe&&n.compressedTexSubImage2D(t.TEXTURE_2D,ge,0,0,Me.width,Me.height,be,Me.data):n.compressedTexImage2D(t.TEXTURE_2D,ge,Le,Me.width,Me.height,0,Me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?pe&&n.texSubImage2D(t.TEXTURE_2D,ge,0,0,Me.width,Me.height,be,Ie,Me.data):n.texImage2D(t.TEXTURE_2D,ge,Le,Me.width,Me.height,0,be,Ie,Me.data)}else if(v.isDataArrayTexture)if(U){if(Re&&n.texStorage3D(t.TEXTURE_2D_ARRAY,Oe,Le,le.width,le.height,le.depth),pe)if(v.layerUpdates.size>0){const ge=Hf(le.width,le.height,v.format,v.type);for(const de of v.layerUpdates){const Fe=le.data.subarray(de*ge/le.data.BYTES_PER_ELEMENT,(de+1)*ge/le.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,de,le.width,le.height,1,be,Ie,Fe)}v.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,le.width,le.height,le.depth,be,Ie,le.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Le,le.width,le.height,le.depth,0,be,Ie,le.data);else if(v.isData3DTexture)U?(Re&&n.texStorage3D(t.TEXTURE_3D,Oe,Le,le.width,le.height,le.depth),pe&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,le.width,le.height,le.depth,be,Ie,le.data)):n.texImage3D(t.TEXTURE_3D,0,Le,le.width,le.height,le.depth,0,be,Ie,le.data);else if(v.isFramebufferTexture){if(Re)if(U)n.texStorage2D(t.TEXTURE_2D,Oe,Le,le.width,le.height);else{let ge=le.width,de=le.height;for(let Fe=0;Fe<Oe;Fe++)n.texImage2D(t.TEXTURE_2D,Fe,Le,ge,de,0,be,Ie,null),ge>>=1,de>>=1}}else if(Xe.length>0){if(U&&Re){const ge=Ae(Xe[0]);n.texStorage2D(t.TEXTURE_2D,Oe,Le,ge.width,ge.height)}for(let ge=0,de=Xe.length;ge<de;ge++)Me=Xe[ge],U?pe&&n.texSubImage2D(t.TEXTURE_2D,ge,0,0,be,Ie,Me):n.texImage2D(t.TEXTURE_2D,ge,Le,be,Ie,Me);v.generateMipmaps=!1}else if(U){if(Re){const ge=Ae(le);n.texStorage2D(t.TEXTURE_2D,Oe,Le,ge.width,ge.height)}pe&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,be,Ie,le)}else n.texImage2D(t.TEXTURE_2D,0,Le,be,Ie,le);m(v)&&p(q),Pe.__version=X.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function N(E,v,I){if(v.image.length!==6)return;const q=et(E,v),se=v.source;n.bindTexture(t.TEXTURE_CUBE_MAP,E.__webglTexture,t.TEXTURE0+I);const X=i.get(se);if(se.version!==X.__version||q===!0){n.activeTexture(t.TEXTURE0+I);const Pe=rt.getPrimaries(rt.workingColorSpace),ve=v.colorSpace===wi?null:rt.getPrimaries(v.colorSpace),ye=v.colorSpace===wi||Pe===ve?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,v.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,v.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);const xe=v.isCompressedTexture||v.image[0].isCompressedTexture,le=v.image[0]&&v.image[0].isDataTexture,be=[];for(let de=0;de<6;de++)!xe&&!le?be[de]=_(v.image[de],!0,r.maxCubemapSize):be[de]=le?v.image[de].image:v.image[de],be[de]=te(v,be[de]);const Ie=be[0],Le=s.convert(v.format,v.colorSpace),Me=s.convert(v.type),Xe=T(v.internalFormat,Le,Me,v.colorSpace),U=v.isVideoTexture!==!0,Re=X.__version===void 0||q===!0,pe=se.dataReady;let Oe=D(v,Ie);ze(t.TEXTURE_CUBE_MAP,v);let ge;if(xe){U&&Re&&n.texStorage2D(t.TEXTURE_CUBE_MAP,Oe,Xe,Ie.width,Ie.height);for(let de=0;de<6;de++){ge=be[de].mipmaps;for(let Fe=0;Fe<ge.length;Fe++){const Ye=ge[Fe];v.format!==wn?Le!==null?U?pe&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe,0,0,Ye.width,Ye.height,Le,Ye.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe,Xe,Ye.width,Ye.height,0,Ye.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?pe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe,0,0,Ye.width,Ye.height,Le,Me,Ye.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe,Xe,Ye.width,Ye.height,0,Le,Me,Ye.data)}}}else{if(ge=v.mipmaps,U&&Re){ge.length>0&&Oe++;const de=Ae(be[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,Oe,Xe,de.width,de.height)}for(let de=0;de<6;de++)if(le){U?pe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,be[de].width,be[de].height,Le,Me,be[de].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,Xe,be[de].width,be[de].height,0,Le,Me,be[de].data);for(let Fe=0;Fe<ge.length;Fe++){const St=ge[Fe].image[de].image;U?pe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe+1,0,0,St.width,St.height,Le,Me,St.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe+1,Xe,St.width,St.height,0,Le,Me,St.data)}}else{U?pe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,0,0,Le,Me,be[de]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,0,Xe,Le,Me,be[de]);for(let Fe=0;Fe<ge.length;Fe++){const Ye=ge[Fe];U?pe&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe+1,0,0,Le,Me,Ye.image[de]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+de,Fe+1,Xe,Le,Me,Ye.image[de])}}}m(v)&&p(t.TEXTURE_CUBE_MAP),X.__version=se.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function oe(E,v,I,q,se,X){const Pe=s.convert(I.format,I.colorSpace),ve=s.convert(I.type),ye=T(I.internalFormat,Pe,ve,I.colorSpace),xe=i.get(v),le=i.get(I);if(le.__renderTarget=v,!xe.__hasExternalTextures){const be=Math.max(1,v.width>>X),Ie=Math.max(1,v.height>>X);se===t.TEXTURE_3D||se===t.TEXTURE_2D_ARRAY?n.texImage3D(se,X,ye,be,Ie,v.depth,0,Pe,ve,null):n.texImage2D(se,X,ye,be,Ie,0,Pe,ve,null)}n.bindFramebuffer(t.FRAMEBUFFER,E),re(v)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,q,se,le.__webglTexture,0,G(v)):(se===t.TEXTURE_2D||se>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&se<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,q,se,le.__webglTexture,X),n.bindFramebuffer(t.FRAMEBUFFER,null)}function fe(E,v,I){if(t.bindRenderbuffer(t.RENDERBUFFER,E),v.depthBuffer){const q=v.depthTexture,se=q&&q.isDepthTexture?q.type:null,X=S(v.stencilBuffer,se),Pe=v.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ve=G(v);re(v)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ve,X,v.width,v.height):I?t.renderbufferStorageMultisample(t.RENDERBUFFER,ve,X,v.width,v.height):t.renderbufferStorage(t.RENDERBUFFER,X,v.width,v.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Pe,t.RENDERBUFFER,E)}else{const q=v.textures;for(let se=0;se<q.length;se++){const X=q[se],Pe=s.convert(X.format,X.colorSpace),ve=s.convert(X.type),ye=T(X.internalFormat,Pe,ve,X.colorSpace),xe=G(v);I&&re(v)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,xe,ye,v.width,v.height):re(v)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,xe,ye,v.width,v.height):t.renderbufferStorage(t.RENDERBUFFER,ye,v.width,v.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function ue(E,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,E),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=i.get(v.depthTexture);q.__renderTarget=v,(!q.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),ce(v.depthTexture,0);const se=q.__webglTexture,X=G(v);if(v.depthTexture.format===Cs)re(v)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,se,0,X):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,se,0);else if(v.depthTexture.format===Ps)re(v)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,se,0,X):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,se,0);else throw new Error("Unknown depthTexture format")}function ke(E){const v=i.get(E),I=E.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==E.depthTexture){const q=E.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),q){const se=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,q.removeEventListener("dispose",se)};q.addEventListener("dispose",se),v.__depthDisposeCallback=se}v.__boundDepthTexture=q}if(E.depthTexture&&!v.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");const q=E.texture.mipmaps;q&&q.length>0?ue(v.__webglFramebuffer[0],E):ue(v.__webglFramebuffer,E)}else if(I){v.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer[q]),v.__webglDepthbuffer[q]===void 0)v.__webglDepthbuffer[q]=t.createRenderbuffer(),fe(v.__webglDepthbuffer[q],E,!1);else{const se=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer[q];t.bindRenderbuffer(t.RENDERBUFFER,X),t.framebufferRenderbuffer(t.FRAMEBUFFER,se,t.RENDERBUFFER,X)}}else{const q=E.texture.mipmaps;if(q&&q.length>0?n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=t.createRenderbuffer(),fe(v.__webglDepthbuffer,E,!1);else{const se=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,X),t.framebufferRenderbuffer(t.FRAMEBUFFER,se,t.RENDERBUFFER,X)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function A(E,v,I){const q=i.get(E);v!==void 0&&oe(q.__webglFramebuffer,E,E.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),I!==void 0&&ke(E)}function R(E){const v=E.texture,I=i.get(E),q=i.get(v);E.addEventListener("dispose",P);const se=E.textures,X=E.isWebGLCubeRenderTarget===!0,Pe=se.length>1;if(Pe||(q.__webglTexture===void 0&&(q.__webglTexture=t.createTexture()),q.__version=v.version,o.memory.textures++),X){I.__webglFramebuffer=[];for(let ve=0;ve<6;ve++)if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer[ve]=[];for(let ye=0;ye<v.mipmaps.length;ye++)I.__webglFramebuffer[ve][ye]=t.createFramebuffer()}else I.__webglFramebuffer[ve]=t.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){I.__webglFramebuffer=[];for(let ve=0;ve<v.mipmaps.length;ve++)I.__webglFramebuffer[ve]=t.createFramebuffer()}else I.__webglFramebuffer=t.createFramebuffer();if(Pe)for(let ve=0,ye=se.length;ve<ye;ve++){const xe=i.get(se[ve]);xe.__webglTexture===void 0&&(xe.__webglTexture=t.createTexture(),o.memory.textures++)}if(E.samples>0&&re(E)===!1){I.__webglMultisampledFramebuffer=t.createFramebuffer(),I.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ve=0;ve<se.length;ve++){const ye=se[ve];I.__webglColorRenderbuffer[ve]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,I.__webglColorRenderbuffer[ve]);const xe=s.convert(ye.format,ye.colorSpace),le=s.convert(ye.type),be=T(ye.internalFormat,xe,le,ye.colorSpace,E.isXRRenderTarget===!0),Ie=G(E);t.renderbufferStorageMultisample(t.RENDERBUFFER,Ie,be,E.width,E.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ve,t.RENDERBUFFER,I.__webglColorRenderbuffer[ve])}t.bindRenderbuffer(t.RENDERBUFFER,null),E.depthBuffer&&(I.__webglDepthRenderbuffer=t.createRenderbuffer(),fe(I.__webglDepthRenderbuffer,E,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(X){n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture),ze(t.TEXTURE_CUBE_MAP,v);for(let ve=0;ve<6;ve++)if(v.mipmaps&&v.mipmaps.length>0)for(let ye=0;ye<v.mipmaps.length;ye++)oe(I.__webglFramebuffer[ve][ye],E,v,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ve,ye);else oe(I.__webglFramebuffer[ve],E,v,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ve,0);m(v)&&p(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Pe){for(let ve=0,ye=se.length;ve<ye;ve++){const xe=se[ve],le=i.get(xe);n.bindTexture(t.TEXTURE_2D,le.__webglTexture),ze(t.TEXTURE_2D,xe),oe(I.__webglFramebuffer,E,xe,t.COLOR_ATTACHMENT0+ve,t.TEXTURE_2D,0),m(xe)&&p(t.TEXTURE_2D)}n.unbindTexture()}else{let ve=t.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(ve=E.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ve,q.__webglTexture),ze(ve,v),v.mipmaps&&v.mipmaps.length>0)for(let ye=0;ye<v.mipmaps.length;ye++)oe(I.__webglFramebuffer[ye],E,v,t.COLOR_ATTACHMENT0,ve,ye);else oe(I.__webglFramebuffer,E,v,t.COLOR_ATTACHMENT0,ve,0);m(v)&&p(ve),n.unbindTexture()}E.depthBuffer&&ke(E)}function x(E){const v=E.textures;for(let I=0,q=v.length;I<q;I++){const se=v[I];if(m(se)){const X=w(E),Pe=i.get(se).__webglTexture;n.bindTexture(X,Pe),p(X),n.unbindTexture()}}}const ie=[],k=[];function W(E){if(E.samples>0){if(re(E)===!1){const v=E.textures,I=E.width,q=E.height;let se=t.COLOR_BUFFER_BIT;const X=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Pe=i.get(E),ve=v.length>1;if(ve)for(let xe=0;xe<v.length;xe++)n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer);const ye=E.texture.mipmaps;ye&&ye.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let xe=0;xe<v.length;xe++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(se|=t.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(se|=t.STENCIL_BUFFER_BIT)),ve){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[xe]);const le=i.get(v[xe]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,le,0)}t.blitFramebuffer(0,0,I,q,0,0,I,q,se,t.NEAREST),l===!0&&(ie.length=0,k.length=0,ie.push(t.COLOR_ATTACHMENT0+xe),E.depthBuffer&&E.resolveDepthBuffer===!1&&(ie.push(X),k.push(X),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,k)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,ie))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ve)for(let xe=0;xe<v.length;xe++){n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.RENDERBUFFER,Pe.__webglColorRenderbuffer[xe]);const le=i.get(v[xe]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Pe.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+xe,t.TEXTURE_2D,le,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const v=E.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[v])}}}function G(E){return Math.min(r.maxSamples,E.samples)}function re(E){const v=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Y(E){const v=o.render.frame;u.get(E)!==v&&(u.set(E,v),E.update())}function te(E,v){const I=E.colorSpace,q=E.format,se=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||I!==Hr&&I!==wi&&(rt.getTransfer(I)===gt?(q!==wn||se!==li)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),v}function Ae(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=F,this.setTexture2D=ce,this.setTexture2DArray=ee,this.setTexture3D=ae,this.setTextureCube=V,this.rebindTextures=A,this.setupRenderTarget=R,this.updateRenderTargetMipmap=x,this.updateMultisampleRenderTarget=W,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=oe,this.useMultisampledRTT=re}function sb(t,e){function n(i,r=wi){let s;const o=rt.getTransfer(r);if(i===li)return t.UNSIGNED_BYTE;if(i===Qc)return t.UNSIGNED_SHORT_4_4_4_4;if(i===eu)return t.UNSIGNED_SHORT_5_5_5_1;if(i===lp)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===op)return t.BYTE;if(i===ap)return t.SHORT;if(i===As)return t.UNSIGNED_SHORT;if(i===Jc)return t.INT;if(i===sr)return t.UNSIGNED_INT;if(i===ni)return t.FLOAT;if(i===Us)return t.HALF_FLOAT;if(i===cp)return t.ALPHA;if(i===up)return t.RGB;if(i===wn)return t.RGBA;if(i===Cs)return t.DEPTH_COMPONENT;if(i===Ps)return t.DEPTH_STENCIL;if(i===fp)return t.RED;if(i===tu)return t.RED_INTEGER;if(i===dp)return t.RG;if(i===nu)return t.RG_INTEGER;if(i===iu)return t.RGBA_INTEGER;if(i===To||i===wo||i===Ao||i===Ro)if(o===gt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===To)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===wo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ao)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ro)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===To)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===wo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ao)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ro)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===ql||i===jl||i===Yl||i===Kl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===ql)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===jl)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Yl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Kl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Zl||i===Jl||i===Ql)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Zl||i===Jl)return o===gt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Ql)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===ec||i===tc||i===nc||i===ic||i===rc||i===sc||i===oc||i===ac||i===lc||i===cc||i===uc||i===fc||i===dc||i===hc)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===ec)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===tc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===nc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ic)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===rc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===sc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===oc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ac)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===lc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===cc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===uc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===fc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===dc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===hc)return o===gt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Co||i===pc||i===mc)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Co)return o===gt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===pc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===mc)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===hp||i===gc||i===_c||i===vc)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Co)return s.COMPRESSED_RED_RGTC1_EXT;if(i===gc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===_c)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===vc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Rs?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const ob=`
void main() {
